...
TR-03135 Part 2 – Table of Contents 
...
|3.3.1<br>3.3.2<br>3.3.3<br>3.3.4<br>3.3.5|Basic logging profle..........................................................................................................................................................14<br>Standard logging profle..................................................................................................................................................14<br>Standard logging profle with optical evaluation extensions........................................................................14<br>Standard logging profle with electronic evaluation extensions.................................................................14<br>Full logging profle............................................................................................................................................................. 14|
...
Table 3.1: Requirements for Stationary application scenarios...................................................................................................8 Table 3.2: Requirements for Self Service application scenarios.................................................................................................9 Table 3.3: Requirements for Partially Mobile application scenarios.....................................................................................11 Table 3.4: Requirements for Fully Mobile application scenarios............................................................................................12 Table 3.5: Requirements for kiosk application scenarios...........................................................................................................13 Table 3.6: Set of extended data nodes for different check types.............................................................................................14 

Federal Office for Information Security 

3 

TR-03135 Part 2 – Introduction 1 
...
2 Operational scenarios – TR-03135 Part 2 
...
TR-03135 Part 2 – Requirements from TR-03135-1 3 
...
The requirements for Stationary application scenarios are given in tables 3.1, 3.2 and 3.3 for the Optical Checks, Electronic Checks and Combined Checks, respectively. 
...
|4.5.3|m|Identifcation of the document model SHALL<br>be performed.|
...
3 Requirements from TR-03135-1 – TR-03135 Part 2 

|**Ref. [TR-03135-1]**|**Obligation (m/o/e)**|**Notes**|
|---|---|---|
|||document model. At least the check (UV, BR,<br>FU) SHALL be performed.<br>Option: If chip authenticity is guaranteed by<br>the electronic check, the mode of spectrally<br>selective checks can be changed to evaluatory.<br>Additional note**:**The system SHALL support a<br>blacklist, where this option can be disabled for<br>specifc countries.|



Table 3.1: Requirements for Stationary application scenarios – Optical Checks 
...
Table 3.2: Requirements for Stationary application scenarios – Electronic Checks 
...
Table 3.3: Requirements for Stationary application scenarios – Combined Checks 
...
The requirements for Self Service application scenarios are given in tables 3.4, 3.5 and 3.6 for the Optical Checks, Electronic Checks and Combined Checks, respectively. 
...
|4.5.3|m|Identifcation of the document model SHALL<br>be performed.|
|4.5.4.1|m|The MRZ SHALL be checked for ICAO<br>compliance.|
|4.5.4.2|m/e|Spectrally selective checks SHOULD be<br>performed if applicable for the given<br>document model. At least the checks (UV, BR,<br>FU) SHALL, and one check each (IR, TR,_ZZ_)<br>and (UV, LU,_ZZ_) SHOULD be performed.<br>Option: If chip authenticity is guaranteed by<br>the electronic check, the mode of spectrally<br>selective checks can be changed to evaluatory.<br>Additional note**:**The system SHALL support a<br>blacklist, where this option can be disabled for<br>specifc countries.|



Table 3.4: Requirements for Self Service application scenarios – Optical Checks 
...
|4.6.3|m|Chip access protocols SHALL be supported.|
|4.6.4|m|Checking chip contents SHALL be performed.|
|Table<br>3.5<br>: Requirements for Self Service<br>application scenarios  - Electronic Checks|||
|**Ref. [TR-03135-1]**|**Obligation (m/o/e)**|**Notes**|
...
Table 3.6: Requirements for Self Service application scenarios – Combined Checks 

## 3.2.4 Requirements for Partially Mobile application scenarios 

The requirements for Partially Mobile application scenarios are given in tables 3.7, 3.8 and 3.9 for the Optical Checks, Electronic Checks and Combined Checks, respectively. 
...
|4.5.3|o|Depending on the optical reader, the<br>document model SHOULD not be identifed<br>(e. g., swipe reader).|
|4.5.4.1|m|If a MRZ was read, the MRZ SHALL be<br>checked for ICAO compliance.|
|4.5.4.2|o/e|Depending on the optical reader, spectrally<br>selective checks SHOULD be performed if<br>applicable for the given document model. At<br>least the check~~s~~<br> (UV, BR, FU) SHALL be<br>performed.<br>Option: If chip authenticity is guaranteed by<br>the electronic check, the mode of spectrally<br>selective checks can be changed to evaluatory.<br>Additional note**:**The system SHALL support a<br>blacklist, where this option can be disabled for<br>specifc countries.|



Table 3.7: Requirements for Partially Mobile application scenarios – Optical Checks 
...
Table 3.8: Requirements for Partially Mobile application scenarios – Electronic Checks 
...
Table 3.9: Requirements for Partially Mobile application scenarios – Combined Checks 

## 3.2.5 Requirements for Fully Mobile application scenarios 

The requirements for Fully Mobile application scenarios are given in tables 3.10, 3.11 and 3.12 for the Optical Checks, Electronic Checks and Combined Checks, respectively. 
...
|4.5.3|o|Depending on the optical reader, the<br>document model SHOULD not be identifed|
...
|4.5.4.2|o/e|Depending on capabilities the optical reader,<br>spectrally selective checks SHOULD be<br>performed if applicable for the given<br>document model. At least the checks (UV, BR,<br>FU) SHOULD be performed.<br>Option: If chip authenticity is guaranteed by<br>the electronic check, the mode of spectrally<br>selective checks can be changed to evaluatory.<br>Additional note**:**The system SHALL support a<br>blacklist, where this option can be disabled for<br>specifc countries.|



Table 3.10: Requirements for Fully Mobile application scenarios – Optical Checks 
...
Table 3.11: Requirements for Fully Mobile application scenarios – Electronic Checks 
...
Table 3.12: Requirements for Fully Mobile application scenarios – Combined Checks 
...
The requirements for Kiosk application scenarios are given in 3.13, 3.14 and 3.15 for the Optical Checks, Electronic Checks and Combined Checks, respectively. 

|**Ref. [TR-03135-1]**|**Obligation (m/o/e)**|**Notes**|
|---|---|---|
|4.5.2|m|For all further checking steps the model<br>SHALL be identifed.|
...
Table 3.13: Requirements for Kiosk application scenarios – Optical Checks 
...
Table 3.14: Requirements for Kiosk application scenarios – Electronic Checks 
...
Table 3.15: Requirements for Kiosk application scenarios – Combined Checks 
...
The set of extended data nodes is defined for the corresponding checks in table 3.16. 
...
## Table 3.16: Set of extended data nodes for different check types 
...
The document check system SHALL implement the transmission and log specification according to [TR03135-1], chapter 6. This requirement is REQUIRED for Stationary, Self Service, and Kiosk application scenarios and RECOMMENDED for Partially Mobile and Fully Mobile application scenarios. Logging data SHOULD be temporarily kept local, if transmission fails and retransmitted if the connection is available, possibility to manually transfer logs is RECOMMENDED. 

Federal Office for Information Security 

15 

4 Conformity – TR-03135 Part 2 
...
TR-03135 Part 2 – Reference Documentation 

## Reference Documentation 

[TR-03135-1] 

Bundesamt für Sicherheit in der Informationstechnik (BSI): Technische Richtlinie TR-03135, Machine Authentication of MRTDs for Public Sector Applications Part 1: Overview and Functional Requirements, 2016, Version 2.1.0. 

Federal Office for Information Security 

17 

Keywords and Abbreviations – TR-03135 Part 2 
