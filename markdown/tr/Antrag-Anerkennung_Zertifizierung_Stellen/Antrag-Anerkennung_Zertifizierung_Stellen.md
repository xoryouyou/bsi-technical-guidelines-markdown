...
![](markdown/tr/Antrag-Anerkennung_Zertifizierung_Stellen/Antrag-Anerkennung_Zertifizierung_Stellen.pdf-0001-00.png)



![](markdown/tr/Antrag-Anerkennung_Zertifizierung_Stellen/Antrag-Anerkennung_Zertifizierung_Stellen.pdf-0001-01.png)


## Antrag auf Anerkennung als Prüfstelle[1] / Zertifizierung als IT- Sicherheitsdienstleister[2] 

**Angaben zur beantragten Anerkennung / Zertifizierung Erstanerkennung / Erstzertifizierung Art der Anerkennung / Zertifizierung Reanerkennung / Rezertifizierung Erweiterungsantrag Beantragte(r) Geltungsbereich(e): Hiermit wird zugestimmt, dass die Kontaktdaten der Mitarbeiter innerhalb des BSI an die Produktzertifizierungsstelle weitergegeben werden. Hiermit wird zugestimmt, dass die Stelle mit Name, Geltungsbereich und Gültigkeitsdauer auf der Website des BSI veröffentlicht wird, sofern die Anerkennung bzw. Zertifizierung erfolgreich war.** 

**Angaben zu vorhandenen Akkreditierungen / Anerkennungen  / Zertifizierungen Anerkennungs-, Zertifizierungsoder Akkreditierungsstelle Registrierungsnummer(n): Geltungsbereich(e): Dauer:** 

1 Die Anerkennung erfolgt auf Grundlage des §§ 9 Abs. 6, 10 Abs. 2 BSI-Gesetz (BSIG) i.V.m. §§ 21f. BSI-Zertifizierungsverordnung (BSIZertV). 2 Die Zertifizierung erfolgt auf Grundlage des §§ 9 Abs. 5, Abs. 4, 10 Abs. 2 BSI-Gesetz (BSIG) i.V.m. §§ 18, 22 BSI-Zertifizierungsverordnung (BSIZertV). 

Godesberger Allee 87, 53175 Bonn 

1 

**Antragstellende Organisation Organisation inkl. Rechtsform: Handelsregisternummer: Straße, Postleitzahl, Ort, Land: Telefon: E-Mail:** 
...
**Angaben zur Prüfstelle / zum IT-Sicherheitsdienstleister** _(Angaben zur kleinsten Organisationseinheit, die vom BSI anerkannt / zertifiziert werden soll)_ **Eingliederung in die Organisation Bezeichnung der kleinsten Organisationseinheit Straße,  Postleitzahl, Ort, Land: Telefon: E-Mail: URL:** 

**Angaben zur Abrechnung** _(ausfüllen, wenn bei der Kostenabrechnung durch das BSI eine bestimmte Rechnungsadresse und Bestellnummer angegeben werden muss)_ **Rechnungsadresse Bestell-/Auftragsnummer** 
...
- - https://www.bsi.bund.de/DE/Themen/Oeffentliche Verwaltung/Sicherheitsberatung/Datenschutz/hin weise_node.html 

Hiermit wird die Anerkennung / Zertifizierung im angegebenen Geltungsbereich(en) beantragt. 

Ort, Datum Name und Position Unterschrift (oberste Leitung; Prüfstellenleiter) 
