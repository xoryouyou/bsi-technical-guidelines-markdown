...
|2.2.2|TSM Service............................................................................................................................................................................. 7|
|2.2.3|TSM-API.................................................................................................................................................................................... 7|
|2.3|Services gegenüber Mobilgeräteherstellern....................................................................................................................8|
|2.4|Services gegenüber Diensteanbietern................................................................................................................................8|
|2.4.1|Unterstützung bei TSM-konformer Applet-Entwicklung................................................................................8|
...
|3|Beschreibung der Personalisierung - Notwendige Komponenten..........................................................................10|
|3.1|eID-Applet.................................................................................................................................................................................... 10|
|3.1.1|Zustände................................................................................................................................................................................. 10|
|3.1.2|Übergänge.............................................................................................................................................................................. 11|
|3.1.3|Echtheitsnachweis und Authentifzierung des Personalisierungsdienstes............................................11|
|3.1.4|Personalisierung................................................................................................................................................................. 12|
|3.2|eID-Client..................................................................................................................................................................................... 12|
|3.3|Personalisierungsdienst......................................................................................................................................................... 12|
|4|Beschreibung der Personalisierung Prozessbeschreibung...........................................................................................14|
...
Im Folgenden wird eine Beschreibung der Aufgaben eines TSM sowie von Aufbau und Abläufen der TSMInfrastruktur gegeben. 

## 2.1 Kurzbeschreibung 

Zum Überblick sind in Abbildung 1 die wichtigsten Komponenten eines TSMS schematisch dargestellt. Die Kurzbeschreibung der Abläufe lautet wie folgt: 
...
![](markdown/tr/TR-03159-2_Amendment-A/TR-03159-2_Amendment-A.pdf-0005-09.png)


_Abbildung 1: Schematische Darstellung der wichtigsten Komponenten eines TSMS._ 

Bundesamt für Sicherheit in der Informationstechnik 

6 

Beschreibung der Provisionierung 2 
...
1. Zugang zu den in 2.2.1 genannten Sicherheitsbausteinen schaffen und die Installation von Applets ermöglichen. 
...
Als zentrale Aufgabe führt der TSM die Installation, Aktualisierung und Löschung von DiensteanbieterApplets über die die TSM-Infrastruktur durch. 
...
Des weiteren muss das Applet Funktionen bereitstellen, um Identitätsdaten von einem PersonalisierungsDienst entgegennehmen zu können und zu speichern. Außerdem muss es einen Attestierungmechanismus bereitstellen, um seine Echtheit nachzuweisen. 
...
Beschreibung der Personalisierung - Notwendige Komponenten 3 
...
Das eID-Applet muss die notwendigen Funktionen zur Personalisierung gemäß der Beschreibung in Abschnitt 4.1 implementieren. 
...
Zusätzlich muss er in der Lage sein mit dem eID-Applet auf der SIM-Karte / dem SE zu kommunizieren und er muss die notwendigen Funktionen zur Personalisierung gemäß der Beschreibung in Abschnitt  4.1 implementieren. 
...
Der Personalisierungsdienst muss die notwendigen Funktionen zur Personalisierung gemäß der Beschreibung in Abschnitt 4.1 implementieren. Dieser muss mit einem CSCA-Vertrauensanker konfiguriert werden, welcher eine Prüfung der DocumentSigner-Signatur des Standard Chip Authentication Key des eID-Applet ermöglicht. 
...
3. Der Personalisierungsdienst bindet zum Auslesen der Identitätsdaten aus einer Ausweiskarte einen weiteren eID-Dienst ein, welchen er über die TR-03130 SOAP-Schnittstelle ansteuert (Verbindung TR03130). Der Personalisierungsdienst nimmt in der Folge die Rolle eines eID-Diensteanbieters an. 
...
9. Der eID-Client stellt eine Verbindung zwischen eID-Applet und Personalisierungsdienst her (SM-SERemote). Über diese Verbindung authentifizieren sich eID-Applet und Personalisierungsdienst gegenseitig unter Verwendung des EACv2-Protokolls: 
   ...
   2. eID-Client und Personalisierungsdienst erzeugen aus dem Hash-Wert aus Schritt 5 ein AuxiliaryData-Object zur Transaktions-Autorisierung und Verwenden dieses im Rahmen der Terminal Authentication v2. 

Bundesamt für Sicherheit in der Informationstechnik 

14 

Beschreibung der Personalisierung Prozessbeschreibung 4 
...
![](markdown/tr/TR-03159-2_Amendment-A/TR-03159-2_Amendment-A.pdf-0015-02.png)


**----- Start of picture text -----**<br>
me.ID load & personalize<br>IVID AusweisApp2 eID-Server<br>PA vID veIDC veIDSP veIDS eIDS<br>[001]  start<br>[002] get TCToken<br>[003]  TR-03130 SOAP<br>[004]  PAOS params<br>Load<br>PACE' / SM SE-local<br>[005]  detect, state & PACE'<br>[006] [CVCA root anchor] 00PERSO0000x<br>[007]  StartPAOS<br>PACE / SM PA-local<br>[008]  detect & PACE<br>[009]  CVCA root anchor<br>[010]  StartPAOS-Proxy<br>[011]  TR-03130 SOAP<br>[012]  StartPAOS<br>EAC SM PA-remote<br>[013]  EAC channel, ISO batch transport<br>[014]  EAC channel, ISO batch transport<br>REQESIDTA-style terminal authentication with hash of data<br>hash all encrypted<br>[015] ISO B0 responses<br>in batch order<br>client adds hash to TA signature<br>input in EAC SM SE-remote<br>hash all encrypted<br>[016] ISO B0 responses<br>in batch order<br>[017]  forward EAC messages<br>[018]<br>[019]<br>[020]  UseIDResponse<br>[021] [prepare perso dataset] 30...A1...A2<br>EAC SM SE-remote<br>verify SE genuine<br>[022]  TA-REQESIDTA w/ H(ISO B0 batch, challenge)<br>[023]  EAC channel, ISO batch transport<br>[024] [Intelligent Update, write vID + CAkey + RIkey] (RI = KDF(RID))<br>[025]  update confirm (blacklist PubKey)<br>[026]  confirm<br>PA vID veIDC veIDSP veIDS eIDS<br>figure 1<br>Item Description<br>veIDC veID-Client<br>PACE' "PACE light"<br>vID SE w/ IVID<br>veIDSP perso service provider<br>veIDS perso veID-Server<br>eIDS live eID-Server<br>**----- End of picture text -----**<br>


Page 1 of 1 

_Abbildung 2: Flussdiagramm zur Personalisierung des eID-Applets_ 
...
eIDAS European Parliament, Council of the European Union: Regulation (EU) No 910/2014 of the European Parliament and of the Council of 23 July 2014 on electronic identification and trust services for electronic transactions in the internal market and repealing Directive 1999/93/EC TR-03110-3 BSI: TR-03110-3: Advanced Security Mechanisms for Machine Readable Travel Documents and eIDAS token, Part 3: Common Specifications, Version 2.21 TR-03110-2 BSI: TR-03110-2: Advanced Security Mechanisms for Machine Readable Travel Documents and eIDAS token, Part 2: Protocols for electronic IDentification, Authentication and Trust Services (eIDAS), Version 2.21 TR-03110-4 BSI: TR-03110-4: Advanced Security Mechanisms for Machine Readable Travel Documents and eIDAS token, Part 4: Applications and Document Profiles, Version 2.21 TR-03124-1 BSI: TR-03124-1: eID-Client, Part 1: Specifications, Version 1.3 TR-03130-1 BSI: TR-03130-1: eID-Server, Part 1: Functional Specification 
