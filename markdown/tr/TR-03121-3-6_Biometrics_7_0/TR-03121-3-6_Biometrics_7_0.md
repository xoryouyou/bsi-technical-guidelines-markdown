...
|3|Partial Application Processes .......................................................................................................... 5|
|3.1|PAP ACQ-FI-SV-4: Supervised Facial Image Acquisition ........................................................... 5|
|3.2|PAP ACQ-FP442-SV-1: Supervised Acquisition 4-4-2 for Enrolment ......................................... 6|
|3.3|PAP ACQ-FP4141-SV-1: Supervised Acquisition 4-1-4-1 for Enrolment ................................... 10|
|3.4|PAP ACQ-FPS-SV-1: Supervised Acquisition Single Slap ......................................................... 13|
|4|Function Modules ........................................................................................................................ 17|
|4.1|FM Category Acquisition Hardware ....................................................................................... 17|
|4.2|FM Category Acquisition Software ........................................................................................ 20|
|4.3|FM Category Biometric Image Processing .............................................................................. 21|
|4.4|FM Category Quality Assessment .......................................................................................... 22|
|4.5|FM Category Presentation Attack Detection .......................................................................... 28|
|4.6|FM Category Compression .................................................................................................... 30|
|4.7|FM Category Operation ........................................................................................................ 31|
|4.8|FM Category User Interface .................................................................................................. 32|
|4.9|FM Category Logging ............................................................................................................ 34|
|4.10|FM Category Coding ............................................................................................................. 36|
...
2.1. Data Acquisition and Processing at an Immigration Authority ......................................................... 2 2.2. Data Acquisition and Processing at an Immigration Authority ......................................................... 4 3.1. Partial Application Process "Supervised Facial Image Acquisition" .................................................... 5 3.2. Partial Application Process Task "Capture Live Facial Image" ........................................................... 6 3.3. Partial Application Process "Supervised Acquisition 4-4-2 for Enrolment" ........................................ 7 3.4. Partial Application Process Task "Capture Slap Supervised" ............................................................. 9 3.5. Partial Application Process Task "Capture Plain Fingerprint Supervised" ......................................... 10 3.6. Partial Application Process "Supervised Acquisition 4-1-4-1 for Enrolment" .................................... 10 3.7. Partial Application Process Task "Capture Slap Supervised" ............................................................ 12 3.8. Partial Application Process Task "Capture Plain Fingerprint Supervised" ......................................... 13 3.9. Partial Application Process "Supervised Acquisition Slap" .............................................................. 13 3.10.Partial Application Process Task "Capture Slap Supervised" ............................................................ 15 3.11.Partial Application Process Task "Capture Plain Fingerprint Supervised" ......................................... 16 
...
German Immigration Authorities (IMA) are assigned various tasks, which, among others, include the issuance of resident permits, the renewal of resident permits, or the handling of illegal staying Third-Country Natio nals (TCNs). Using biometrics in these tasks enhances the quality of these tasks and is therefore usually not only legally allowed but even more compulsory. The biometric modalities, which are generally in use, are fin gerprints (flat) and the facial image. Which biometrics are needed in a given use-case heavily depends on the specific use-case and the corresponding legislation. This also applies to usage of the biometrics once they are acquired, which might be an enrolment in identity registers, a 1:1-verification against biometric data in an identity register or in an electronic document, or a 1:n identification in identity registers. 

To achieve a uniform level of quality and security across Germany whenever biometric data is used, a stan dardized approach is needed when it comes to the acquisition of biometric for further usage. On the one hand, varying quality in the acquisition of biometrics would inevitably also result in varying quality in the subse quent processes, which should be avoided. On the other hand, a standardized acquisition (quality, data format, etc.) also facilitates standardization of all subsequent steps in public sector applications. 

This Technical Guideline (TR) therefore defines standards for the acquisition of biometric data to be used in applications of the German immigration authorities. Different processes are modelled with the goal, that for each relevant use-cases, a process can be found herein, which meets the specific technical and legal demands. Nevertheless, the decision, which process is to be called in which use-case at which time, is not in the scope of this document. 

This volume consists out of two Application Profiles (APs), nameley Section 2.1 and Section 2.2 
...
Figure 2.1 depicts the acquisition process at an Immigration Authority. In general, the biometric data of the applicant SHALL be captured sequentially. Depending on the use-case it is required to acquire fingerprints and / or a facial image of the biometric subject. For all acquisitions enrolment quality SHALL be used in order to simplify the over all processes (e.g. a facial image that has been used for a verification is not needed to be recaptured for an enrolment). 

In the case of fingerprint acquisition for a verification within Entry-Exit System (EES) as Central Identity Re gister (CIR) it would be sufficient to acquire the four flat fingerprints of the slap which is stored within the EES. 

In the case of facial image acquisition a digital camera SHALL be used. 

In the end the acquired biometrics are used for enrolment, verifications and / or identifications within one or multiple CIRs. Within this application profile this is mainly EES. 


![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0008-08.png)
...
|**Module Category**|**Required Function Modules**|
|---|---|
|Acquisition Software|FM AS-FI-DC<br>FM AS-FP-MF,<br>FM AS-FP-SLP,<br>FM AS-FP-SF|
...
|Coding|FM COD-ALL-IMA,<br>FM COD-ALL-EES<br>FM COD-FI-GENERIC,<br>FM COD-FI-EES<br>FM COD-FP-EES|
|Compression|FM COM-FI-GENERIC,<br>FM COM-FI-IMA<br>FM COM-FP-IMA,<br>FM COM-FP-WSQE|
...
**Table 2.1** Required Function Modules for Application Profile Multimodal Processing in Immigration Authorities for EES 
...
Figure 2.2 depicts the acquisition process at an Immigration Authority. The acquisition of ten flat finger prints of the biometric subject SHALL be conducted. For all acquisitions enrolment quality SHALL be used in order to simplify the over all processes (e.g. a set of fingerprints that has been used for a verification within Schengen Information System (SIS) is not needed to be recaptured for an enrolment later). 

In the end the acquired biometrics are used for enrolment, verifications and / or identifications within one or multiple CIRs. Within this application profile this is mainly SIS. 
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0010-01.png)


**----- Start of picture text -----**<br>
PAP Supervised Acquisition 4-4-2 for<br>Enrolment / PAP Supervised<br>Acquisition 4-1-4-1 for Enrolment<br>Acquire 10 Flat  Enrolment in  Verication  Identication<br>Fingerprints CIR against CIR within CIR<br>Start End<br>**----- End of picture text -----**<br>
...
In addition to the legal requirements, further basic directives and standards are applicable: [BIB_ISO_19794_FINGER] 
...
**Table 2.3** Required Function Modules for Application Profile Multimodal Processing in Immigration Authorities for SIS 
...
|**No.**|**Required Partial Application Process**|
|---|---|
|1|PAP ACQ-FP442-SV-1: Supervised Acquisition 4-4-2 for Enrolment /<br>PAP ACQ-FP4141-SV-1: Supervised Acquisi<br>tion 4-1-4-1 for Enrolment|
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0011-11.png)
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0012-03.png)
...
Figure 3.3 depicts the capture process for the 4-4-2 enrolment scenario. Note, that the PAP Task ACQ-FPSSV-1: Capture Slap Supervised is used here. The 4-4-2 sequences are described in detail subsequently: 
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0013-01.png)


**----- Start of picture text -----**<br>
Note: Previous  PAP Task  Note: In single nger aquistion<br>images of ngers  Capture Slap  mode each nger is captured<br>are discarded Supervised sequentially<br>Capture Plain<br>Choose ngers of Finger (chosen<br>Operator decides to  slap to recapture ngers of right<br>PAP Task  recapture ngers ofslap in single  hand slap)<br>Capture Slap  nger acquisition<br>Supervised mode<br>Capture Plain<br>Right hand ngers available? Finger Supervised<br>Select missing  Yes Capture Slap<br>ngers of  Supervised (right<br>right hand hand ngers) Operator accepts<br>Start No quality or slap is of slap of insufcient<br>sufcient quality<br>Capture Single<br>Choose ngers of Finger (chosen<br>Operator decides to  slap to recapture ngers of left<br>PAP Task  recapture ngers of hand slap)<br>Capture Slap  slap in single<br>Supervised nger acquisition<br>mode<br>Left hand ngers  Capture Plain<br>available? Finger<br>Supervised<br>Select missing  Yes Capture Slap<br>ngers of left  Supervised (left<br>hand hand ngers) Operator accepts<br>No slap of insufcient<br>quality or slap is of<br>sufcient quality<br>Choose thumbs  Capture Single<br>Finger (chosen<br>of slap to<br>PAP Task  Operator decides to recapture thumb(s) of slap in single  recapture thumbs of right hand slap)<br>Capture Slap  nger acquisition<br>Supervised mode<br>Capture Plain<br>Thumb(s)  Finger<br>available? Supervised<br>Yes Capture Slap<br>Supervised<br>(thumb(s)) Operator accepts<br>No slap of insufcient  End<br>quality or slap is of<br>sufcient quality<br>**----- End of picture text -----**<br>
...
3. The fingerprints SHALL be segmented and each fingerprint SHALL be quality assessed. 
   ...
   - a. In case the quality of the fingerprints meets the quality requirements defined in the corresponding Quality Assessment (QA) Function Module, the captured slap and the set of segmented fingerprints and parameter data (e.g. quality values) SHALL be temporarily stored. 
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0015-01.png)
...
Figure 3.5 depicts the basic supervised capture process for a plain fingerprint capture. A plain fingerprint capture can be part of more complex acquisition processes, e.g. a ten finger acquisition by the 4-1-4-1 capture process. The plain fingerprint capture is described in detail subsequently. The quality assessment is conducted according to the requirements of the applicable FM Category Quality Assessment. 
...
3. Restart the Figure 3.5 acquisition workflow. 
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0016-02.png)
...
Figure 3.6 depicts the acquisition process for 4-1-4-1 the enrolment scenarios. Note, that the PAP Task ACQ-FPS-SV-1: Capture Slap Supervised is used here. The 4-1-4-1 sequence is described in detail subsequent ly: 
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0016-13.png)


**----- Start of picture text -----**<br>
Note: Previous  Note: In single nger aquistion mode each<br>images of ngers  chosen nger is captured seperatly<br>are discarded accordingly to task "Capture Plain Finger"<br>Choose ngers to Capture Single<br>Operator decides to  recapture Fingers<br>PAP Task  recapture ngers ofslap in single  PAP Task<br>Capture Slap  nger capture mode Capture Slap<br>Supervised Supervised<br>Right hand ngers available? Capture Plain Finger Supervised Right thumb available?<br>Select missing  Yes Capture Slap  Yes Capture Plain<br>ngers of  Supervised (right Finger (right<br>right hand hand ngers) Operator accepts  thumb)<br>Start No slap of insufcient  No<br>quality or slap is of<br>sufcient quality<br>Choose ngers to Capture Single<br>Operator decides to  recapture Fingers<br>PAP Task  recapture ngers ofslap in single  PAP Task<br>Capture Slap  nger capture mode Capture Slap<br>Supervised Supervised<br>Left hand ngers available? Capture Plain Finger Supervised Left thumb available?<br>Select missing  Yes Capture Slap  Yes Capture Plain<br>ngers of left  Supervised (left  Finger (left<br>hand hand ngers) Operator accepts  thumb)<br>No slap of insufcient  No End<br>quality or slap is of<br>sufcient quality<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0018-09.png)
...
Figure 3.8 depicts the basic supervised capture process for a plain fingerprint capture. A plain fingerprint capture can be part of more complex acquisition processes, e.g. a ten finger acquisition by the 4-1-4-1 capture process. The plain fingerprint capture is described in detail subsequently. The quality assessment is conducted according to the requirements of the applicable FM Category Quality Assessment. 
...
3. Restart the Figure 3.8 acquisition workflow. 
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0019-10.png)
...
Figure 3.9 depicts the supervised acquisition process of a slap. 
...
The biometric subject SHALL be guided to place the hand correctly on the scanner and the slap SHALL be captured. Note, that the Section 3.4.2 is used here. 
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0019-19.png)
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0021-09.png)
...
Figure 3.11 depicts the basic supervised capture process for a plain fingerprint capture. A plain fingerprint capture can be part of more complex acquisition processes, e.g. a ten finger acquisition by the 4-1-4-1 capture process. The plain fingerprint capture is described in detail subsequently. The quality assessment is conducted according to the requirements of the applicable FM Category Quality Assessment. 
...
3. Restart the Figure 3.11 acquisition workflow. 
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0022-10.png)
...
- 1 The ISO/IEC 39794 series might be relevant here. 2 The ISO/IEC 39794 series might be relevant here. 
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0024-16.png)


- 1000 ppi scanner, for f = 1.0 to 20.0 cy/mm: 


![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0024-18.png)
...
- The image provided by acquisition software SHALL meet the criteria of fingerprints as descri bed in [BIB_ISO_19794_FINGER][4] . The requirements according to the certification requirements of [BIB_ISO_19794_FINGER] SHALL be met. 
...
- The face SHALL be cropped and de-rotated from the overall scene in the captured image. Post processing of the image orientation in regard to pitch and jaw (see [BIB_ISO_19794_FACE][5] ) SHALL NOT be done. 
...
- The resolution of the fingerprint image has to be 500 ppi or 1000 ppi corresponding to the certification requirements of [BIB_ISO_19794_FINGER][6] and, therefore, MAY differ from the scan resolution. 
...
This Function Module describes requirements and interfaces for software that is used for quality assessment of digital images to ensure compliance with [BIB_ISO_19794_FACE][7] . 
...
When multiple facial images and their corresponding set of quality metrics are present, the best capture of the list SHALL be identified in an automated manner as described in the following[8] : 
...
This Function Module describes requirements and interfaces for software that is used for quality as sessment of digital images within the context of immigration authorities to ensure compliance with [BIB_ISO_19794_FACE]. 

## 4.4.2.1 Requirements 

The threshold requirements of Table 4.3 SHALL be in place within the context of immigration authorities. These thresholds relate to the generic quality components of FM QA-FI-GENERIC. 

> 8 Note that this is a description of the automated selection of the best capture among a list of facial images. Operators may always decide otherwise during the process (veto). 
...
1. For each segmented fingerprint _FA;j_ of a passed capture _A_ , a quality value _QA;j_ is calculated with _j 2_ 1 _; :::;_ 10 (up to 4 fingers in one slap) representing the specific finger code according to [BIB_ISO_19794_FINGER][9] . 
...
When multiple captures _Ai; i 2_ 1 _; :::; n_ and their corresponding set of segmented fingerprints _FAi;j_ with _j 2_ 1 _; :::;_ 10 representing the specific finger code according to [BIB_ISO_19794_FINGER][10] are passed, the best of the captures SHALL be identified as described in the following section: 
...
> 10 The ISO/IEC 39794 series might be relevant here. 
...
> 11 Note that during certification a relaxed false-alarm-rate is tested. The requirement of the rate specified in this Function Module is tested on operational collected data only. 
...
The following compression requirements as indicated in Table 4.7 apply for facial images for immigration authorities. 
...
This Function Module describes requirements and interfaces for the compression of fingerprint images con tained in [BIB_ANSI_NIST_2011:2015] files within the context of immigration authorities. 
...
The German Standard for AFIS Transactions Version 3 (GSAT3) file size after compression SHALL have a ma ximum file size of 3000 kB for SIS purposes. 
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0037-04.png)
...
![](markdown/tr/TR-03121-3-6_Biometrics_7_0/TR-03121-3-6_Biometrics_7_0.pdf-0037-07.png)
...
- 12 For estimation of compression factor it is allowed to crop to the minimum size containing the fingerprint defined if a sensor is used with a larger capturing area than this minimum. 

- 13 The ISO/IEC 39794 series might be relevant here. 
...
If verifications are performed[14] : 
...
> 14 This is only the case if the application profile defines verification processes explicitly. 
...
In order to allocate logs of immigration authorities to their respective application profile the element `Appli cationProfile` SHALL be filled as described in Table 4.8. 
...
- For each capture process of a dedicated fingerprint or slap, all available information SHALL be logged. In case of multiple captures for a finger or slap the number of the capture details for which slap was selected as the best capture SHALL be specified. Within the finger capture the reference to the corresponding record of the probe SHALL be set. Further the details of each during the capture performed attempt SHALL be pro vided, including the reference to the corresponding record if available. In case of an unacceptable capture 
...
attempt the reason for rejection of this capture attempt SHALL be selected. If the rejection reason is `other` an error code detailing the reason of rejection SHALL be set. 
...
SHALL be filled with conformant placeholders. These placeholders SHALL be replaced as soon as possible with the actual values by the calling application. 
...
## 4.10.2 FM COD-ALL-GSAT3 

This Function Module describes requirements and interfaces for the coding of general information according to the German Standard for Automated Fingerprint Identification System (AFIS) transactions in XML format. 

## 4.10.2.1 Requirements 

For data format and encoding, the XML-based standard [BIB_GSAT3] SHALL apply. The current version of the GSAT3 SHALL be used. Some required GSAT3 data fields (e.g. biographic information) may not be available for the acquisition system. In order to keep the schema conformance during the entire process, these fields SHALL be filled with placeholders. These placeholders SHALL be replaced as soon as possible with the actual values by the calling application. 

## 4.10.2.2 Recommendations 

The example-placeholders listed in the Table 4.10 MAY be used. 
...
## 4.10.3 FM COD-ALL-IMA 

This Function Module describes requirements and interfaces for the overall coding of biometric and biogra phic data used within the context of immigration authorities. 
...
- The logging data as defined by the FM of the FM Category Logging SHALL be encoded as XML according to the schema definition as `ima-log` element. The XML encoding is defined by the XML schema definition in the file „ima6v1.xsd“ and referenced schema files. 
...
- The following does only apply for Application Profile Multimodal Processing in Immigration Authorities for SIS: the GSAT3 transaction container SHALL be embedded in the XML log ( `XMLRecord` element) for con formance testing of the encoding. Alternatively, the base64 encoded GSAT3 transaction container SHALL be embedded in the XML log ( `BinaryRecord` element). 

## 4.10.4 FM COD-FI-EES 
...
This Function Module describes requirements for the coding used to send fingerprint images to the Central System EES (CS EES). 
