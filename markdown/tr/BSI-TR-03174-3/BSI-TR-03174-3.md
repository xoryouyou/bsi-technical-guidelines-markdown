...
![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0009-03.png)


wird. Grundsätzlich lassen sich solche Anwendungen in drei Kategorien unterteilen. Die erste Kategorie bilden die nativen Applikationen (Kapitel 2.1.1), welche direkt auf die Plattform, auf der sie ausgeführt werden, zugeschnitten sind, ab. Dem gegenüber stehen die Web-Anwendungen (Kapitel 2.2). Ihre Implementierung ist völlig unabhängig von der Plattform und sie laufen innerhalb des Web-Browsers des Endgeräts. In die dritte Kategorie fallen die hybriden Ansätze (Kapitel 2.1.2). Sie spiegeln alle möglichen Kombinationen aus nativen Applikationen und Web-Anwendungen wider. 
...
Abhängig von der Art des Betriebs und den damit verbundenen unterschiedlichen Angriffsvektoren stehen dem Hersteller unterschiedliche Möglichkeiten zur Verfügung, die Sicherheit der Gesamtlösung und der gespeicherten und verarbeiteten Daten zu gewährleisten. 


![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0011-02.png)
...
## 3 Prüfaspekte für Anwendungen im Finanzwesen 3.1 Prüfaspekte 
...
- O.Arch_1 - und Lebenszyklus für die gesamte Anwendung sein. 
...
- O.Arch_9 Das Hintergrundsystem MUSS so implementiert sein, dass ungewollte Zugriffe über eventuelle Management-Schnittstellen effektiv unterbunden werden. Insbesondere bei externem Hosting (s. Kapitel 2.3.2) und Cloud-Diensten (s. Kapitel 2.3.3) MUSS 
...
- O.Auth_8 Das Hintergrundsystem MUSS Maßnahmen umsetzen, die ein Ausprobieren von LoginParametern (z. B. Passwörter) erschweren. 
...
|O.Auth_10|Das Hintergrundsystem MUSS für die Anwendungssitzung nach einer angemessenen|
|---|---|
...
|O.Auth_12|Bei Änderung der Zugangsparameter SOLL der Nutzer über die zuletzt hinterlegten,|
...
|O.Auth_14|Alle einem Nutzer oder einer Sitzung zugeordneten Identifier MÜSSEN mit einem|
||Zufallszahlengenerator gemäß O.Rand_1 erzeugt werden und eine geeignete Länge|
||aufweisen.|
|O.Auth_15|Das Hintergrundsystem MUSS es dem Nutzer ermöglichen ein oder alle zuvor|
||ausgestellten Authentifizierungstoken bzw. Session-Identifier ungültig zu machen.|
|O.Auth_16|Wird eine Anwendungssitzung beendet, MUSS das Hintergrundsystem den|
...
||durch die Anwendung (vgl. O.Auth_8und O.Auth_9).|
...
|O.Auth_20|Authentisierungstoken MÜSSEN mit einem geeigneten Verfahren signiert werden (vgl.|
...
- 3.1.6.1 Authentifizierung über Passwort O.Pass_1 Bei einer Authentifizierung mittels Benutzername und Passwort MÜSSEN starke Passwortrichtlinien existieren. Diese SOLLEN sich am aktuellen Stand gängiger BestPractices orientieren. 
...
- O.Pass_3 Der Nutzer MUSS die Möglichkeit haben, sein Passwort zu ändern. O.Pass_4 Das Ändern und Zurücksetzen von Passwörtern MUSS protokolliert werden ohne das Passwort selbst zu protokollieren. 
...
![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0024-07.png)
...
Diese TR dient primär der Bewertung von Anwendungen, wie sie in Kapitel 1.3.1 Tabelle 14.definiert sind. Bei solchen Anwendungen ist der Schaden beim Verlust von Finanzdaten oft nicht zu beziffern, unter anderem weil eine einmal stattgefundene Offenbarung nicht mehr rückgängig gemacht werden kann. Anwendungen, die nach dieser TR evaluiert werden, können allerdings auch andere sensible Daten enthalten, die gegen Offenbarung geschützt werden müssen. Das Sicherheitsniveau dieser Daten kann ggf. unter dem der Finanzdaten liegen (vgl. Tabelle 14). Die Klassifizierung der Sicherheitsstufen für die 
...
![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0052-03.png)


Evaluationsmethodologie für deterministische Zufallszahlengen https://www.bsi.bund.de/SharedDocs/Downloads/DE/BSI/Zertifizierung/Interpretationen/AIS_20_pdf.pdf ?__blob=publicationFile&v=1 

[BSI200-3] 


![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0052-06.png)


-Standard 200-3 Risikoanalyse auf der Basis von 


![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0052-08.png)
...
![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0052-12.png)


ISO 27001 Zertifizierung auf Basis von IT- 

Grundschutz https://www.bsi.bund.de/DE/Themen/Unternehmen-und-Organisationen/Standards-undZertifizierung/Zertifizierung-und-Anerkennung/Zertifizierung-von-Managementsystemen/ISO-27001Basis-IT-Grundschutz/iso-27001-basis-it- 
...
![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0052-20.png)



![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0052-21.png)
...
![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0052-24.png)



![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0052-25.png)
...
![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0052-28.png)


Sichere Anbindung von lokalen Netzen an das 


![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0052-30.png)
...
![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0052-34.png)


Absicherung eines Servers https://www.bsi.bund.de/SharedDocs/Downloads/DE/BSI/Internetsicherheit/isiserver_pdf.pdf?__blob=publicationFile&v=1 
...
![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0053-03.png)
...
![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0053-12.png)
...
![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0053-17.png)
...
Bundesamt für Sicherheit in der Informationstechnik, „ Kryptographische Verfahren: Empfehlungen und -01, verfügbar unter https://www.bsi.bund.de/SharedDocs/Downloads/DE/BSI/Publikationen/TechnischeRichtlinien/TR02102 /BSI-TR-02102.pdf?__blob=publicationFile&v=10 

## [TR02102-2] 

Bundesamt für Sicherheit in der Informationstechnik, „Kryptographische Verfahren: Empfehlungen und Schlüssellängen Teil 2 -01, verfügbar unter https://www.bsi.bund.de/SharedDocs/Downloads/DE/BSI/Publikationen/TechnischeRichtlinien/TR02102 /BSI-TR-02102-2.pdf?__blob=publicationFile&v=2 

[TR03107-1] 


![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0053-25.png)



![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0053-26.png)
...
![](markdown/tr/BSI-TR-03174-3/BSI-TR-03174-3.pdf-0053-30.png)


erfügbar unter https://www.bsi.bund.de/SharedDocs/Downloads/DE/BSI/Publikationen/TechnischeRichtlinien/TR03116 /BSI-TR-03116-4.pdf?__blob=publicationFile&v=1 
...
Bundesamt für Sicherheit in der Informationstechnik, „Anforderungen an Anwendungen im Finanzwesen Teil 2: Webverfügbar unter https://www.bsi.bund.de/dok/TR-03161-2 
