...
![](markdown/tr/TR_De_Mail_IT-Binfra_Si/TR_De_Mail_IT-Binfra_Si.pdf-0001-00.png)



![](markdown/tr/TR_De_Mail_IT-Binfra_Si/TR_De_Mail_IT-Binfra_Si.pdf-0001-01.png)


BSI – Technische Richtlinie Bezeichnung: IT-Basisinfrastruktur IT-Sicherheit Anwendungsbereich: De-Mail Kürzel: BSI TR 01201 Teil 1.3 Version: 1.8 
...
Es werden in diesem Abschnitt nur die Bedrohungen für die IT-Basisinfrastruktur betrachtet, die sich zusätzlich zu den Bedrohungen aus dem Modul [TR DM IS M] durch die Funktionalität der ITBasisinfrastruktur ergeben. 

## **3.1 Fehlerhafte Systemzeit** 

Die Basisinfrastruktur stellt die Zeit für die De-Mail-Dienste zur Verfügung. Dabei gilt, dass DeMail die gesetzliche Zeit verwendet. Es ist denkbar, dass durch bewusste Manipulation oder durch technisches Versagen eine falsche Zeit verwendet wird. Dies kann dazu führen, dass fehlerhafte Bestätigungen über den Zustand einer De-Mail-Nachricht ausgestellt werden. 
