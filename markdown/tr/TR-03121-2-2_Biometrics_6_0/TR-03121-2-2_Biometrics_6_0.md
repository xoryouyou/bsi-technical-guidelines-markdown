...
Federal Office for Information Security P.O. Box 20 03 63 53133 Bonn E-Mail: trbiometrics@bsi.bund.de Internet: https://bsi.bund.de 
...
![](markdown/tr/TR-03121-2-2_Biometrics_6_0/TR-03121-2-2_Biometrics_6_0.pdf-0006-08.png)


**----- Start of picture text -----**<br>
No<br>Acquire service-device  Configure  Start service  Fetch one feedback  Update user  Yes Fetch results service-device Release<br>service execution interface<br>combination element combination<br>Start Finished? End<br>Signal user<br>command to<br>server<br>Button pressed<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TR-03121-2-2_Biometrics_6_0/TR-03121-2-2_Biometrics_6_0.pdf-0067-03.png)
...
![](markdown/tr/TR-03121-2-2_Biometrics_6_0/TR-03121-2-2_Biometrics_6_0.pdf-0068-01.png)
...
![](markdown/tr/TR-03121-2-2_Biometrics_6_0/TR-03121-2-2_Biometrics_6_0.pdf-0069-01.png)
...
|`Version`|Version of BSI TR-03121 of<br>the implemented service.|`xsd:`<br>`string`|_e.g. 6.0_|
...
|`FacialImages`|The facial image(s) to be as<br>sessed and delivered.|`hlbs:`<br>`Image`<br>`List`|_Image(s) in a common data_<br>_format (e.g. jpeg or bmp) is_<br>_expected._|
...
|`QAEntire`<br>`FacialImage`|M/C|Returns the entire<br>image that MAY be<br>used for re-cropping<br>the captured facial<br>image. The<br>`hlbs:I`<br>`mageRegion`SHALL<br>mark the image sec<br>tion of the`QACrop`<br>`pedFacialImage`.|`hlbs:`<br>`Image`|_Image in a common data for_<br>_mat (e.g. jpeg or bmp) is expec_<br>_ted._|
|`QACropped`<br>`FacialImage`|M/C|Returns the cropped<br>image that shall be as<br>sessed by the opera<br>tor. It SHALL be up<br>dated in case the ope<br>rator has changed the<br>cropping or rotation<br>manually.|`hlbs:`<br>`Image`|_Image in a common data for_<br>_mat (e.g. jpeg or bmp) is expec_<br>_ted._|
...
|`FingerAcquisition`|Contains the full XML root element`Finge`<br>`rAcquisition`(see TR-03121 XML`bioty`<br>`pes5v1.xsd`), which logs the entire acquisition<br>process, information about quality, PAD and<br>uniqueness as well as the finally accepted fin<br>gerprint(s) as record(s). The data format, com<br>pression and file size of the record SHALL com<br>ply with the configured`ApplicationProfile`.|`xsd:`<br>`string`|See TR-03121 XML<br>Schema|
