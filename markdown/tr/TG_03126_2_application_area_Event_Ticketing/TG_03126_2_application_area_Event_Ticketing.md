...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0001-00.png)
...
Federal Office for Information Security P.O. Box 20 03 63 53133 Bonn, Germany Tel.: +49 (0) 228 99 9582 0 E-mail: rfid@bsi.bund.de Website: https://www.bsi.bund.de 
...
|7.6|Use case “Entering an event”|39|
|---|---|---|
|7.7|Use Case „Leaving an event with the right to return“|40|
|7.8|Use case “Blacklisting”|41|
|7.9|Use cases “Key management”|42|
|7.9.1|Key management for the initialisation of carrier media|43|
|7.9.2|Key management for loading and personalising applications|43|
|7.9.3|Key management for loading entitlements|44|
|7.9.4|Key management for use with the event organiser|45|
|8|Security considerations|46|
|8.1|Definitions relating to security and privacy|46|
|8.2|Definition of the security targets|48|
|8.2.1|Specific security targets for the customer|48|
||8.2.1.1<br>Safety|48|
||8.2.1.2<br>Information security|49|
||8.2.1.3<br>Protection of privacy|50|
|8.2.2|Specific security targets for the product retailer|50|
||8.2.2.1<br>Safety|50|
||8.2.2.2<br>Information security|51|
||8.2.2.3<br>Protection of privacy|51|
|8.2.3|Specific security targets for the service provider|52|
||8.2.3.1<br>Safety|52|
||8.2.3.2<br>Information security|52|
||8.2.3.3<br>Protection of privacy|53|
|8.2.4|Summary of the entities’ security targets|54|
|8.2.5|Formation of protection demand categories|55|
|8.3|Threats|56|
|8.3.1|Threats to the contact-less interface|57|
|8.3.2|Threats to the carrier medium|58|
|8.3.3|Threats to the reader|59|
|8.3.4|Threats to the key management system|60|
|8.3.5|Threats to the sales, inspection and backend systems|61|
|8.4|Safeguards|63|
|8.4.1|Selection of cryptographic processes|63|
|8.4.2|Safeguards for the protection of the system as a whole|64|
|8.4.3|Safeguards relating to the carrier medium|73|
|8.4.4|Safeguards relating to the readers|85|
|8.4.5|Safeguards relating to the key management system|88|
|9|Definition of product-specific application scenarios|96|
...
|9.1<br>Application scenario: “Non-personalised single entitlement”|96|
|---|---|
|9.2<br>Application scenario: “Personalised single entitlement”|98|
|9.3<br>Application scenario: “Personalised season entitlement”|100|
|10<br>Suggestions on implementing the system as a whole|103|
|10.1<br>Suggestions on implementing the eTicketing infrastructure|104|
|10.1.1<br>Determining the protection demand for the eTicketing infrastructure|104|
|10.1.2<br>Interfaces in the system as a whole|107|
...
|10.1.4<br>Sale, inspection and management systems|113|
...
|10.2<br>Suggestions on executing the carrier media|129|
|10.2.1<br>Initialising carrier media and applications|131|
|10.2.2<br>Personalising carrier media and applications|131|
|10.2.3<br>Determining the protection demand for the carrier media|132|
|10.2.4<br>Threats to the carrier medium|132|
|10.2.5<br>Definition of specific safeguards|133|
|11<br>Suggestions on executing the product-specific application scenarios|134|
|11.1<br>The “Non-personalised single entitlement” application scenario|134|
|11.1.1<br>Determining the protection demand category|134|
...
|11.1.2<br>Relevant threats|11.1.2<br>Relevant threats|136|
|---|---|---|
|11.1.3<br>Definition of specific safeguards||138|
|11.1.3.1|Safeguards when utilising the “Smart Ticket” carrier medium|139|
|11.1.3.2|Residual risks when utilising the “Smart Ticket” carrier medium|140|
|11.1.3.3|Safeguards when utilising the “Secure chip card” carrier medium|140|
|11.1.3.4|Residual risks when utilising the “Secure chip card” carrier medium|142|
|11.1.3.5|Safeguards when utilising the “Multi-application card” carrier medium|142|
|11.1.3.6|Residual risks when utilising the “Multi-application card” carrier medium|144|
|11.1.3.7|Safeguards when utilising the “NFC Mobile Device” carrier medium|144|
|11.1.3.8|Residual risks when utilising the “NFC Mobile Device” carrier medium|146|
...
|11.2.3.1|Safeguards when utilising the “Smart Ticket” carrier medium|152|
|11.2.3.2|Residual risks when utilising the “Smart Ticket” carrier medium|154|
|11.2.3.3|Safeguards when utilising the “Secure chip card” carrier medium|154|
|11.2.3.4|Residual risks when utilising the “Secure chip card” carrier medium|156|
|11.2.3.5|Safeguards when utilising the “Multi-application card” carrier medium|156|
|11.2.3.6|Residual risks when utilising the “Multi-application card” carrier medium|159|
|11.2.3.7|Safeguards when utilising the “NFC Mobile Device” carrier medium|159|
|11.2.3.8|Residual risks when utilising the “NFC Mobile Device” carrier medium|161|
...
|11.3.3.1|Safeguards when utilising the “Secure chip card” carrier medium|167|
|11.3.3.2|Residual risks when utilising the “Secure chip card” carrier medium|170|
|11.3.3.3|Safeguards when utilising the “Multi-application card” carrier medium|170|
|11.3.3.4|Residual risks when utilising the “Multi-application card” carrier medium|173|
|11.3.3.5|Safeguards when utilising the “NFC Mobile Device” carrier medium|173|
|11.3.3.6|Residual risks when utilising the “NFC Mobile Device” carrier medium|176|
...
|Table|8–36|Protection of the system as a whole through preventing access by||
|||known violent criminals|72|
|Table|8–37|Protection of the system as a whole through satisfying the data||
|||minimization obligation|73|
...
|Table|8–45|Protection through introduction of proximity technology as defined by||
|||ISO/IEC14443|79|
|Table|8–46|Protection through fallback solution for carrier medium malfunction|80|
|Table|8–47|Protection through securing the authenticity and integrity when||
|||loading applications|82|
|Table|8–48|Protection through securing the confidentiality when loading||
|||applications|83|
|Table|8–49|Protection through securing the authenticity and integrity when||
|||loading entitlements|84|
|Table|8–50|Protection through securing the confidentiality when loading||
|||entitlements|85|
...
|Table|8–61|Protection through securing the authenticity and integrity when||
|||loading keys|95|
...
|Table|11–1|Protection demand for the “Non-personalised single entitlement”||
|||application scenario|136|
|Table|11–2|Threats relevant to the “Non-personalised single entitlement”||
|||application scenario|138|
|Table|11–3|Use cases relevant to the “Non-personalised single entitlement”||
|||application scenario|138|
|Table|11–4|Safeguards when utilising Smart Tickets|140|
|Table|11–5|Safeguards for a “Non-personalised single entitlement” on a “Secure||
|||chip card” carrier medium|142|
...
|Table|11–8|Protection demand for the “Personalised single entitlement”||
|||application scenario|149|
...
|Table|11–9|Threats relevant to the “Personalised single entitlement” application||
|---|---|---|---|
|||scenario|151|
|Table|11–10|Use cases relevant to the “Personalised single entitlement”||
|||application scenario|151|
|Table|11–11|Safeguards when utilising the Smart Ticket|154|
|Table|11–12|Safeguards for a “Personalised single entitlement” on a “Secure chip||
|||card” carrier medium|156|
...
|Table|11–15|Protection demand for the “Personalised season entitlement”||
|||application scenario|165|
|Table|11–16|Threats relevant to the “Personalised season entitlement” application||
|||scenario|166|
|Table|11–17|Use cases relevant to the “Personalised season entitlement”||
|||application scenario|167|
|Table|11–18|Safeguards for a “Personalised season entitlement” on a “Secure chip||
|||card” carrier medium|170|
...
|---|---|---|---|
|||to include customer medium entities)|16|
...
|||eTicketing in public transport|26|
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0016-03.png)


**----- Start of picture text -----**<br>
Product  Product Application<br>Customer owner 2 Productowner 2 Application issuer 2<br>medium issuer owner 1 issuer 1<br>Security<br>manager<br>Customer<br>medium retailer<br>Gathering and<br>Application  passing on<br>retailer information System manager<br>Product retailer<br>Customer<br>service Registrar<br>Customer Service provider<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0018-10.png)


**----- Start of picture text -----**<br>
Customer  Application<br>Customer medium issuer OrganiserProduct owner Application owner 2<br>medium issuer Product owner issuer 1<br>Security<br>manager<br>Customer<br>medium retailer<br>Gathering and<br>Application  passing on<br>retailer information System manager<br>Ticket retailer<br>Product retailer<br>Customer<br>service Registrar<br>Venue operator<br>Customer<br>Service provider<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0021-01.png)


**----- Start of picture text -----**<br>
Entitlements<br>Entitlement 1<br>Local<br>multi-journey<br>entitlement<br>Applications<br>Application<br>Application X<br>Application 1 Local<br>eTicketing<br>Core application multi-journey<br>event<br>entitlement<br>Carrier media<br>Carrier medium<br>Carrier medium<br>Secure multi-application card /<br>Smart ticket<br>NFC mobile device<br>Entitlement 1 Entitlement 2 Entitlement 3 Entitlement 1 UEFA Cup Entitlement 2<br>Fare calculation<br>Electronic season ticket<br>Local multi-journey entitlement National league season ticket<br>Customer data Customer data<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0025-01.png)
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0026-04.png)
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0026-07.png)
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0028-06.png)
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0029-02.png)
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0031-08.png)


**----- Start of picture text -----**<br>
P1.1 P1.2 P1.3 P1.4<br>Sales point Service center Internet Internet with  Entities<br>card reader<br>Order medium /  Application  Fax /<br>application / product and  form telephone Website Website Customer<br>payment agreements<br>Transfer personal data (where necessary) Application form telephoneFax /  Website eID application retailerTicket or<br>Optional checking of  Present ID  Check Check Ticket or<br>identity data (examples) card address address application retailer<br>Ticket or<br>Check creditworthiness Check payment details and creditworthiness (optional)<br>application retailer<br>Receive order data Send customer and product data (type and, for instance, seat category) to  Ticket or<br>internal systems application retailer<br>Ticket or<br>Reservation Reservation of product<br>application retailer<br>Process P2 “Production and delivery”<br>(ordered product  including RF-medium or for loading on existing customer medium)<br>yData trustworth<br>not required<br>g Checkin<br>person yPa<br>ment in<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0032-06.png)
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0034-02.png)


**----- Start of picture text -----**<br>
Figure 6–3  Process P3 “using an entitlement”<br>Whitelist<br>Key management<br>Access control system<br>(only in the case of chip technology)<br>**----- End of picture text -----**<br>



![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0034-03.png)



![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0034-04.png)
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0037-01.png)
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0038-01.png)
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0039-01.png)
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0040-01.png)


**----- Start of picture text -----**<br>
Use Case “Entering an event”<br>Subsequent<br>Criteria Procedure of evaluation by inspection unit Access control system operational   RF-medium<br>processes<br>RF-medium in reading  List of valid RF-media and<br>range of applications to be used<br>Valid medium or valid  IDs of RF-medium<br>application on medium? and applications<br>Criterion: Invalid<br>medium<br>Whitelist comparison for RF-medium and  OK? Deny access Clearing<br>application successful<br>Valid<br>medium Activate suitable application in<br>reader, select suitable key<br>Authenticate medium /<br>Key from SAM<br>application<br>Authentication on<br>application level<br>Evaluate entitlement and  List of valid entitlements<br>compare against whitelist  (whitelist)<br>Entitlement<br>Criterion: No valid<br>entitlement<br>Check and whitelist  OK? Deny access Clearing<br>comparison for  Valid<br>entitlement successful entitlement<br>Read activation note and  Activation note,<br>re-entry permit re-entry permit<br>YES: unauthorised re-entry<br>Criterion: attempt<br>Ticket activated AND no  NO? Deny access Clearing<br>re-entry permit  exists? ok<br>Create activation note and  Activation note,<br>delete re-entry permit re-entry permit<br>Grant access, send entry<br>details to access control  Grant access, update<br>access data<br>system<br>END<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0041-01.png)


**----- Start of picture text -----**<br>
Use Case “Leaving an event with the right to return”<br>Subsequent<br>Criteria Procedure of evaluation by inspection unit Access control system operational   RF-medium<br>processes<br>RF-medium in reading  List of valid RF-media and<br>range of applications to be used<br>Valid medium or valid  IDs of RF-medium<br>application on medium? and applications<br>Criterion: Invalid<br>medium<br>Whitelist comparison for RF-medium and  OK? Deny exit Clearing<br>application successful<br>Valid<br>medium Activate suitable application in<br>reader, select suitable key<br>Authenticate medium /<br>Key from SAM<br>application<br>Authentication on<br>application level<br>Evaluate entitlement and  List of valid entitlements<br>compare against whitelist  (whitelist)<br>Entitlement<br>Criterion: No valid<br>entitlement<br>Check and whitelist  OK? Deny exit Clearing<br>comparison for  Valid<br>entitlement successful entitlement<br>Read activation note and  Activation note,<br>re-entry permit re-entry permit<br>YES: Unauthorised exit<br>Criterion: attempt<br>Ticket not activated OR  NO? Deny exit Clearing<br>re-entry permit exists? Exit OK<br>Write re-entry permit re-entry permit<br>Grant exit, send exit data to  Grant exit, update access<br>access control system data<br>END<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0042-04.png)


**----- Start of picture text -----**<br>
Use Case “Blacklisting”<br>Criteria Blacklist entitlement and, if necessary, the medium RF-medium Medium and application management Key management Ticket sales system<br>Customer applies for<br>blacklisting<br>Identify customer<br>Compare with customer file Stored customer data<br>Criterion: Identity of<br>customer not<br>Identification successful  confirmed<br>AND customer data exists Identity of OK? END<br>customer<br>confirmed<br>RF-medium and application  RF-medium ID and<br>assigned to customer? allocated applications<br>NO<br>? END<br>YES<br>Entitlement exists? Customer-specific entitlement<br>NO<br>? END<br>YES<br>Blacklist entitlement in system Blacklist entitlementDelete whitelist entryInclude in blacklist<br>Criterion:<br>NO<br>Applications must be  ? END<br>blacklisted?<br>YES<br>Backlist application<br>Backlist applications Delete whitelist entry<br>Include in blacklist<br>Criterion:<br>Customer medium must be  NO<br>blacklisted? ? END<br>YES<br>Blacklist medium<br>Blacklist customer medium Delete whitelist entry<br>Include in blacklist<br>END<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0043-05.png)
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0044-01.png)


**----- Start of picture text -----**<br>
Use case “Key management for applications”<br>Procedure of process: key management<br>Key management system /  Medium and application<br>for loading application / system  Initialisation / application retailer Ticketing system<br>system manager management<br>manager<br>Key management, RF-media Request:<br>Key for application X<br>Retailer ID<br>START ID for applicationInitialiser SAM<br>Retailer IDApplication ID application and ID for the retailerAllocate a unique ID for the  Application ID<br>Retailer ID, application<br>Specific master keys for the application Generate specific master keys<br>specifications, diversification List of SAMs, algorithms initialisation of application / Production of n SAMs for loading of products<br>Archive shipment data, recipients Send SAMs to initialiser Initialisation SAM<br>Acknowledge receipt of SAMs Archive  receipt Acknowledge receipt of SAMs<br>Data for personalising<br>Use SAM for personalising  application<br>the application / loading<br>entitlements (SAM RF- Update status of<br>media are also needed) application (in relation to<br>RF-media)<br>Return defective SAMs that are  Allocate RF-medium /<br>Update SAM list Update key management status no longer needed application to customer<br>Report lost SAMs information<br>Acknowledgement Acknowledge returned SAMs<br>END<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0045-01.png)


**----- Start of picture text -----**<br>
Use case “Key management for entitlements/products”<br>Procedure of process: key management<br>Key management system /  Medium and application<br>for loading application / system  Initialisation / product retailer  Ticketing system<br>system manager management<br>manager<br>Key management applications Request:<br>Key for product X<br>Product retailer ID<br>START ID for product Xn entitlement SAMs<br>Retailer IDID for product X Allocate a unique ID for product X and ID for the retailer Product ID<br>Product retailer ID<br>Specific master keys for product Generate specific master keys<br>List of SAMs,<br>specifications,  Production of n SAMs to protect<br>diversification  product X<br>algorithms<br>Archive shipment data, recipients Send SAMs to product retailer Initialisation SAM<br>Acknowledge receipt of SAMs Archive  receipt Acknowledge receipt of SAMs<br>Entitlement<br>Use SAMs to load<br>entitlements (SAM<br>application is also required) Update status of<br>application (in relation to<br>RF-media)<br>Allocate entitlement<br>Return defective SAMs that are  status to customer<br>Update SAM list Update key management status no longer needed information<br>Report lost SAMs<br>Acknowledgement Acknowledge returned SAMs<br>END<br>**----- End of picture text -----**<br>
...
|Security target code<br>and name|Security target code<br>and name|Description of security target|
|---|---|---|
|SCI1|Protection of<br>personal data|The customer data stored in the system and customer medium<br>is used to identify the customer, make payments, deliver enti-<br>tlements, and so on.<br>Misuse, manipulation or passing-on to unauthorised persons<br>could incur commercial damage to the customer along with the<br>loss of safety, and must be prevented.|
...
|SCI4|Reliable in-<br>voicing|When a service has been used, the customer must be able to<br>see the time of activation or check-in / check-out.<br>Calculation data (post-paid) must be clear and reliable.|
...
|Security target code and<br>name|Security target code and<br>name|Description of security target|
|---|---|---|
...
|Security target code<br>and name|Security target code<br>and name|Description of security target|
|---|---|---|
|SPI1|Protection of<br>personal data|The customer data stored in the system and customer medium<br>is used to identify the customer, make payments, deliver<br>entitlements, and so on.<br>Misuse, manipulation or passing-on to unauthorised persons<br>could incur commercial damage to the product retailer and a<br>loss of customer acceptance, and could be punished as a<br>violation of the law. This must be avoided.|
|SPI2|Protection of<br>entitlements|The manipulation of, damage to and in particular the<br>counterfeiting of entitlements could incur considerable<br>commercial damage to the product retailer, product owner and<br>service provider.<br>Securing entitlements against counterfeiting is an important<br>objective for the product owner.|
...
|**Table 8–7**<br>**Product retailer specific security targets for protection of privacy**|||
...
|Security target code<br>and name|Security target code<br>and name|Description of security target|
|---|---|---|
|SSI1|Protection of<br>personal data|The customer data stored in the system and in the customer<br>medium is used to identify the customer, make payments,<br>deliver entitlements, and so on.<br>Misuse,manipulationorpassing-onto unauthorised persons|
...
|SSI2|Protection of<br>entitlements|The manipulation of, damage to and in particular the<br>counterfeiting of entitlements could incur considerable<br>commercial damage to the product retailer, product owner and<br>service provider.<br>Securing entitlements against counterfeiting is an important<br>objective for the service provider. Entitlements are also used in<br>the service provider’s system infrastructure, and they must be<br>safeguarded there as well.|
...
|SSP5|Data<br>minimisation|Only the data required for the specified purpose should be<br>gathered and stored, no more.|
...
|Security target|Security target|Customer<br>targets|Product<br>retailer<br>targets|Service<br>provider<br>targets|
|---|---|---|---|---|
...
|Security target|Security target|Protection<br>demand<br>category|Criteria for allocating to protection demand<br>category|
|---|---|---|---|
...
|||2|Data is lost.|
|||3|Data is misused.|
|SI4|Reliable<br>invoicing<br>(personalised)|1|Data is temporarily unavailable.|
|||2|Data is lost.|
|||3|Data is falsified.|
...
|field number|field number|1|1|2|2|3|
|---|---|---|---|---|---|---|
...
|**Table 8–13**<br>**Coding scheme of threats**<br>**8.3.1**<br>**Threats to the contact-less interface**|||||||
...
|TS5|Lack of<br>compatibility<br>between|SS1, SS4|Lack of compatibility between interfaces<br>causes malfunctions. The result is similar to a<br>DoS attackonthe system. Many customers|
...
|1|Interface test<br>•<br>Apply existing test regulations (especially [BSI_PICC_TestSpec] and<br>[BSI_PCD_TestSpec]) for contact-less interfaces as defined by<br>ISO/IEC14443.<br>•<br>Draw up and apply specific test regulations for the application-specific func-<br>tions of the interfaces between carrier media and readers.<br>•<br>Draw up and apply specific test regulations for the protocols and applica-<br>tion-specific functions of the interfaces between the rest of the system com-<br>ponents.||
...
|**Table 8–20**<br>**Protection of the system as a whole through introduction of interface**<br>**tests and approval procedures**|**Table 8–20**<br>**Protection of the system as a whole through introduction of interface**<br>**tests and approval procedures**|**Table 8–20**<br>**Protection of the system as a whole through introduction of interface**<br>**tests and approval procedures**|
|---|---|---|
...
|1|Transmission security:<br>•<br>If a secure channel compliant with MS2.2 or MS2.3 cannot be established,<br>then the data is encrypted by the terminal and sent to the carrier media.<br>•<br>The carrier media may be simple storage media.||
...
|1|Definition of suitable operating processes, offline capability and backup:<br>•<br>System components must in principle (at least temporarily) be able to func-<br>tion autonomously without a backend system or if system interfaces fail.<br>•<br>Data must be backed up regularly in order to exclude the possibility of a to-<br>tal loss.||
|2|||
...
|1|Static encryption for internal communication:<br>Data is transmitted in encrypted form; static encryption processes are used.<br>•<br>Alternatively, instead of general data encryption, data can be sent via dedi-<br>cated networks (closed solution), in which only authorised users are admin-<br>istered and allowed. This network would need to be protected against<br>physical attacks from the outside by means of appropriate safeguards (e.g.<br>basic protective measures), and then operated in accordance with an ap-<br>propriate security concept.||
|2|||
...
||Code and name of safeguard|Threats addressed|
|---|---|---|
|MS6|Confidential storage of data|TS2, TS3, TS6, TS7, TS8,<br>TS10, TS11, TS13, TS14|
|1|Introduction of multi-tenant access protection:<br>•<br>Only a certain, legitimised group of people can access stored data (per-<br>sonal data, sales data, usage data, calculation data, blacklists, approval<br>lists, etc.).<br>•<br>Data is stored in an environment protected against unauthorised access. If<br>access protection cannot be guaranteed, then the data should be stored on<br>an encrypted data carrier (hard drive encryption tools are used).<br>Alternatively, other equally effective encryption mechanisms can be used. The<br>algorithm strength must be at least that of the T-DES algorithm. The type and<br>strength of the mechanism should be adapted to future developments in<br>accordance with [ALGK_BSI].||
|2|||
...
|**Table 8–25**<br>**Protection of the system as a whole through confidential storage of**<br>**data**|**Table 8–25**<br>**Protection of the system as a whole through confidential storage of**<br>**data**|**Table 8–25**<br>**Protection of the system as a whole through confidential storage of**<br>**data**|
|---|---|---|
||Code and name of safeguard|Threats addressed|
...
|1|Cryptographic integrity safeguards:<br>•<br>The integrity of data transmission is guaranteed using MAC protection. The<br>algorithms must be chosen in accordance with [ALGK_BSI].<br>•<br>The type and strength of the mechanism should be adapted to future devel-<br>opments in accordance with [ALGK_BSI].||
|2|||
...
|1|Data is stored in a secure environment with access protection as defined in<br>MS6.<br>~~Chk~~||
|2|||
||~~ecsums:~~||
...
- MS11 Secure the function of the system to prevent the technical failure of components and TS4, TS5 transmission routes Manufacturer’s declaration: 

- 1 • Guarantee safety in accordance with specifications, by means of manufacturer’s internal quality assurance. 

- Testing in accordance with test specifications: • Draw up test specifications for the various system components. 

- 2 • Technical checking of components in accordance with the relevant test specifications. 

- • Specification and execution of integration tests in test and actual environments. 

- Evaluation of components: See 2, and also: 

- 3 • The relevant system components (at least the readers and carrier media) are tested by independent testing laboratories. 

- • An independent institution certifies the relevant system components. • An approval process is established for the system components. 
...
|---|---|---|
||Support|TS4; TS5|
|1|Manufacturer support<br>•<br>The manufacturer of system components must put measures in place that<br>assist service providers when operating the system (e.g. help desk, 1st,||
...
|2|Entity-wide support<br>•<br>Define a support concept for the system belonging to an entity (e.g. service<br>provider, product retailer).||
...
|**Table 8–33**<br>**Protection of the system as a whole through support**|**Table 8–33**<br>**Protection of the system as a whole through support**|**Table 8–33**<br>**Protection of the system as a whole through support**|
|---|---|---|
...
|**Table 8–34**<br>**Protection of the system as a whole through separation of applications**|**Table 8–34**<br>**Protection of the system as a whole through separation of applications**|**Table 8–34**<br>**Protection of the system as a whole through separation of applications**|
|---|---|---|
...
|2|Application form, customer cards:<br>•<br>The customer declares himself in writing and signs to confirm his identity.<br>The product retailer checks the information using conventional means:<br>•<br>Address check.<br>•<br>Sending the customer medium to the address given.<br>•<br>Identity data is passed into the system (Internet, vending machine) from an<br>existing secure customer medium.||
...
||Code and name of safeguard|Threats addressed|
|---|---|---|
|MS16|Identifying the customer when selling and<br>handing over products|TS9, TS10|
...
|**Table 8–35**<br>**Protection of the system as a whole through identifying the customer**|**Table 8–35**<br>**Protection of the system as a whole through identifying the customer**|**Table 8–35**<br>**Protection of the system as a whole through identifying the customer**|
|---|---|---|
...
|1|Rival groups:<br>•<br>Separation of groups:<br>•<br>Introduce a means of identifying rival groups when selling entitlements.<br>Integrate this identification into the entitlement.<br>•<br>Allocate separate entrances and seating areas.<br>•<br>People in rival groups are only issued non-falsifiable group-related or per-<br>sonal entitlements.<br>•<br>Apply the normal safeguards against the falsification and cloning of entitle-<br>ments.<br>•<br>When people enter at their designated entrances and are inspected, their<br>group identification is monitored electronically. Security personnel also<br>monitor their group affiliation.||
|2|Bar entry to fans known to commit violence:<br>•<br>Only issue non-falsifiable, personal entitlements.<br>•<br>Compare personal details of known violent offenders with customer data.<br>Prevent potential violent offenders from purchasing.<br>•<br>Random personal checks at the venue. Check correlation between person<br>and personal entitlement.||
|3|Prevent known potential offenders from committing violent acts:<br>•<br>Only issue non-falsifiable, personal entitlements.<br>•<br>Compare personal details of known potential violent offenders with cus-<br>tomer data. Prevent potential violent offenders from purchasing.<br>•<br>Check correlation between person and personal entitlement during entry.<br>This can be done by security personnel or using biometric features stored<br>with the entitlement in the carrier medium.||
...
|1|Satisfying legal requirements:<br>When the processes and system within the system as a whole are being<br>defined, the principle of data minimisation is applied in accordance with the legal<br>foundations. This includes, in particular, the definition of deadlines for deleting<br>data that is no longer required.||
|2|||
|3|Special safeguards<br>The following safeguards are applied in addition to those specified in MS18.2:<br>•<br>Precise, purpose-related definition of the data content, the acquisition and<br>storage of data, and access and usage rights using the role model of the<br>system as a whole.<br>•<br>The customer is informed about the purpose-related acquisition, storage<br>and use of personal data.||
...
|1|Write protection<br>•<br>Once imported into the relevant storage areas, the entitlement data and ac-<br>tivation data is protected irreversibly against overwriting. Read protection is<br>not applied.<br>Simple access protection<br>•<br>Alternatively, or additionally, simple access protection is used. The access<br>protection employs password protection or an authentication mechanism.||
|2|Specific access protection<br>•<br>Perform mutual authentication with the reader before every access, using<br>random numbers and secret keys stored in the carrier medium.<br>•<br>Introduce access rights and keys specific to applications and entitlements.<br>•<br>Utilise diversified keys.<br>•<br>Possible authentication methods include T-DES, AES128 or comparable<br>open processes. The type and strength of the mechanism should be<br>adapted to future developments in accordance with [ALGK_BSI].||
...
||Code and name of safeguard|Threats addressed|
|---|---|---|
|MM1|Hardware and software access protection<br>(read and write access)|TM1, TM2, TM3, TM4, TM5,<br>TM6, TM7, TM8, TM10, TS11|
|3|Advanced access protection<br>•<br>Perform mutual authentication with the reader before every access, using<br>random numbers and secret keys stored in the carrier medium.<br>•<br>Introduce hierarchical access rights and keys specific to applications and<br>entitlements.<br>•<br>Utilise diversified keys.<br>•<br>Possible authentication mechanisms include standardised symmetric meth-<br>ods (T-DES, AES128 or similar open processes) and asymmetric methods<br>(RSA, ECC). RSA and ECC are covered by the latest definitions in<br>[ALGK_BSI]. The type and strength of the mechanism should be adapted to<br>future developments in accordance with [ALGK_BSI].<br>•<br>Protection mechanisms against hardware attacks are required.<br>•<br>The chip should be certified according to [HW_PP1] or [HW_PP2].||



**Table 8–38 Protection of the transponder through access protection** 

||Code and name of safeguard<br>Threats addressed|Code and name of safeguard<br>Threats addressed|
|---|---|---|
|MM2|Protection against cloning of carrier medium<br>with entitlement<br>TM3||
||Simple protection against cloning of carrier medium||
||•|Implementation of access protection in accordance with MM1.1 to prevent|
|||the data content from being retrieved.|
||•|Use an UID – a globally unique, unchangeable identifier for the chip, which|
|||prevents the carrier medium and entitlement from being duplicated; the UID|
|1||is integrated into the encryption of the entitlement.|
||•|Optional introduction of authentication based on a non-retrievable, secret|
|||key.|
||•|Use simple visual security features (e.g. holograms).|
||•|Introduce a zero-balance procedure when managing non-personalised,|
|||printed carrier media.|



Protection against cloning of carrier medium and data content 

   - Implementation of access protection in accordance with MM1.2 to prevent the data content from being retrieved. 

- Use an UID – a globally unique, unchangeable identifier for the chip, which prevents the carrier medium, applications and entitlement from being dupli- 

- 2 cated; the UID is integrated into the access protection concept. • Use visual security features when designing the card body. 

   - Introduce authentication based on a non-retrievable, secret key to protect against copying. 

   - Introduce a zero-balance procedure when managing non-personalised, printed carrier media. 
...
|3|Advanced protection against cloning of carrier medium<br>•<br>Implementation of access protection in accordance with MM1.3 to prevent<br>the data content from being retrieved.<br>•<br>Use an UID – a globally unique, unchangeable identifier for the chip, which<br>prevents the carrier medium, applications and entitlement from being dupli-<br>cated; the UID is integrated into the access protection concept.<br>•<br>Use visual security features when designing the card body.<br>•<br>Introduce a zero-balance procedure when managing non-personalised,<br>printed carrier media.||
...
|General|The functions of an carrier medium and an entitlement can theoretically be<br>emulated by programmable devices (e.g. PDAs) that use contact-less<br>interfaces.<br>Emulation requires that the complete data content and the full function of the<br>carrier medium, including UID, can be retrieved.<br>It is impossible to emulate a simple memory chip using commonly available<br>programmable contact-less chips with card operating systems (COS), since the<br>UID cannot be programmed. Emulation is conceivable using specially<br>developed hardware.||
...
|**Table 8–40**<br>**Protection of the transponder against emulation**|**Table 8–40**<br>**Protection of the transponder against emulation**|**Table 8–40**<br>**Protection of the transponder against emulation**|
|---|---|---|
...
||(e.g. using MACs).<br>•<br>Diversification of keys.||
|3|Advanced access protection for personal data, interoperability<br>•<br>Access protection in accordance with MM1.3.<br>•<br>Data is transmitted in secured form in accordance with MS2.3, and stored in<br>the chip specifically for the application. Personal data and entitlements are<br>protected using various keys.<br>•<br>The data may need to be protected against manipulation on the system side<br>(e.g. using MACs, signatures). This applies in particular to calculation data if<br>interoperability is required.<br>•<br>Diversification of keys.||



|**Table 8–41**<br>**Protection of personal data on the transponder**|**Table 8–41**<br>**Protection of personal data on the transponder**|**Table 8–41**<br>**Protection of personal data on the transponder**|
|---|---|---|
...
- MM5 Protection of settlement data against retrieval TM7, TM8 

- and overwriting/manipulation • Diversification of keys. Access and manipulation protection in the case of interoperability • Access protection in accordance with MM1.3 • Data is transmitted in secured form in accordance with MS2.3, and stored in the chip specifically for the application. The various types of calculation data 

- 3 are protected in accordance with a defined role model using defined access rights and specific, varying keys. 

- • If interoperability is required in the system, then calculation data must be protected against manipulation on the system side (e.g. using MACs, signatures). 

- • Diversification of keys. 

- **Table 8–42 Protection of settlement data on the transponder** Code and name of safeguard Threats addressed 

- MM6 Separation of applications TM6, TM9 

- 1 No particular separation of applications is supported. Separation of applications • Applications are loaded in a secure environment. 

- 2 • Implementation of an application-specific access concept in accordance with MM1.2. Keys and rights are allocated in accordance with the role model of entities in the system as a whole. 

- • Diversification of keys. Secure separation of applications • Implementation of an application-specific access concept in accordance with MM1.3. Keys and rights are allocated in accordance with the role 

- 3 model of entities in the system as a whole. • Safeguard MM10a.3 (and possibly MM10b.3) is employed for the secure loading of new applications. 

- • Diversification of keys. 

|**Table 8–43**<br>**Protection through separation of applications on the transponder**|**Table 8–43**<br>**Protection through separation of applications on the transponder**|**Table 8–43**<br>**Protection through separation of applications on the transponder**|
|---|---|---|
|MM7|Code and name of safeguard|Threats addressed|
||Specification of carrier medium characteristics|TM10|
|General|The characteristics of the carrier medium in relation to the applications and<br>operating processes that are to be supported must be specified and guaranteed.<br>This applies in particular to:<br>•<br>Performance<br>•<br>Durability under mechanical wear||
...
|---|---|---|---|---|---|
|MM7||||||
||||Specification of carrier medium characteristics<br>TM10|||
...
||||•<br>Draw up testing regulations.|||
...
|**Table**|||**8–44**<br>**Protection through specification of carrier medium**|||
||||Code and name of safeguard|Threats addressed||
|MM8|||Introduce proximity technology as defined by<br>ISO/IEC14443|TM11||
|1||||||
||||Introduce proximity technology as defined by ISO/IEC14443|||
|2||||||
||||Increased protection|||
|3|||•<br>Utilise random anti-collision code (random UID).|||
||||•<br>Deactivate the RF interface in the presence of NFC Mobile Devices.|||
...
|**Table 8–46**<br>**Protection through fallback solution for carrier medium malfunction**|**Table 8–46**<br>**Protection through fallback solution for carrier medium malfunction**|**Table 8–46**<br>**Protection through fallback solution for carrier medium malfunction**|
|---|---|---|
...
||It should be transferred securely, after checking for version, integrity and au-<br>thenticity.<br>II Loading the new application<br>The process of loading new applications uses command sequences defined in<br>the ISO 7816-13 standard. This standard defines the following commands:<br>•<br>Application management request<br>•<br>Load Application<br>•<br>Remove Application<br>The Application management request and Load application commands are<br>therefore required in order to load a new application.<br>ISO 7816-13 commands must be executed using secure messaging. This en-<br>sures that the new application is authentic when loaded, and can be operated<br>securely. The following section looks more closely at the application of this ISO<br>standard to this use case.<br>Note:<br>New applications can also be loaded without SM. This will not influence the se-<br>curity of the existing applications, but it will not secure the authenticity of the<br>new application.<br>Since the standard ISO7816-13 only provides a general framework in which ap-<br>plications can be loaded onto suitable carrier media, the following specific fac-<br>tors must be taken into account for this use case:<br>•<br>Every application must be given an application ID in order to ensure clear<br>separation between the applications.<br>•<br>Furthermore, all organisations must be given unique organisation IDs to en-<br>able clear allocation of keys and application data.<br>•<br>Applications are only issued by the application owner.<br>•<br>The secure messaging key required for secure messaging must be stored<br>in the carrier medium (for all applications) the first time it is personalised so<br>that it is possible to execute the commands. The application retailer (or ap-<br>plication owner) must also be in possession of this key. carrier media that<br>do not have this key cannot negotiate session keys with the application re-<br>tailer, which means that data will not be able to be sent in response to the<br>Load Application command.<br>III Notes on checking the applications for authenticity and integrity.<br>•<br>Using the secure messaging mechanism requires an online connection to<br>the application retailer (or application owner), or to the source that pos-<br>sesses the SM key for downloading the application. A secure operating en-<br>vironment is not required for this.<br>•<br>As part of the key management system for the use case described in this<br>document, it must be ensured that the authentication process can take||
...
|---|---|---|
|MM10a|Loading new applications – securing the<br>authenticity and integrity of applications|TM9|
||place between the application retailer (i.e. the source of the loaded applica-<br>tion) and the carrier medium. One way of ensuring this is for the application<br>owner to give the application retailer the SM key for loading new applica-<br>tions (unless issuer and retailer are one and the same); another is that a<br>trustworthy third source generates this key, and it is put into the security<br>modules and carrier media beforehand.<br>IV Sample command sequence:<br>1<br>Select <<card manager AID>><br>Select the card manager application using the AID<br>2<br>Get Data <<management service template>><br>Retrieve the card management service template, which contains information<br>about which status of its life-cycle the application is in, and about which<br>other status it may enter.<br>3<br>Select <<AID higher-level application>><br>4<br>Authenticate<br>Mutual authentication can then take place, depending on the security level<br>(of the application).<br>5<br>Application Management Request<br>Possible passing of the AID of the application being managed, together with<br>the certificate and hash value of the application data, provided by the card<br>issuer. Other data such as application owner ID, card issuer ID and so on<br>can also be sent to the card.<br>6<br>Load Application<br>Multi-part command which actually loads the application. The Load Applica-<br>tion command contains commands in its data field for setting up the applica-<br>tion structure. Since the applications that are to be loaded may have differ-<br>ent definitions as well as different security and entitlement requirements and<br>so on, the command may contain a variety of data contents (or chip card<br>commands) depending on the application. The way this command is exe-<br>cuted is heavily dependent on the operating system being used, and on the<br>type of application being loaded.<br>7<br>Application Management Request<br>Sets the status to “operational activated” to enable the application to begin<br>operation, and for the associated specific security states to be set in the<br>carrier medium.<br>The same procedure can be followed when removing applications on cards that<br>have already been issued. To this end the standard defines the command Re-<br>move Application, which is embedded in the aforementioned sequences.||
...
||Code and name of safeguard|Threats addressed|
|---|---|---|
|MM10b|Loading new applications – securing the<br>confidentiality of applications|TM9|
...
|2|Implementation of a reloading mechanism as defined by ISO 7816-13 with SM<br>•<br>See MM10a. In secure messaging, not only is authenticity assured by<br>MACs, but confidentiality is guaranteed by encryption.<br>Note:<br>When new applications are loaded, cryptographic secrets are generally<br>transmitted along with public data. For this reason, safeguards MM10a and<br>MM10b are normally deployed together (secure messaging with negotiation of<br>one session key for authentication security and one for encryption).||
|3|||
...
||Code and name of safeguard|Threats addressed|
|---|---|---|
|MM11a|Loading new entitlements – securing the<br>authenticity and integrity of entitlements|TM2, TM9|
...
- MM11a Loading new entitlements – securing the TM2, TM9 

- authenticity and integrity of entitlements date Binary. 

- • Possible symmetric algorithms: standardised symmetric authentication using session key negotiation as defined in [ALGK_BSI]. MAC processes should also be chosen in accordance with [ALGK_BSI]. 

- • The type and strength of the mechanism used for loading should be adapted to future developments in accordance with [ALGK_BSI]. 

Complex asymmetric authentication concept with session key negotiation, introduction of Public Key Infrastructure (PKI). 

   - Every entity in the public transport system is given its own asymmetric authentication key which has been certified by a certification authority (CA). The system as a whole is subject to a common Root CA. 

- Prior to authentication, the carrier medium and the security module (SAM) in the system of the application retailer must exchange the certificates of their public authentication keys, verify them (e.g. using Verify Certificate), and 

- 3+ import the public key of the other entity involved. Authentication is then done using a standardised asymmetric authentication procedure. 

   - As in level 3, entitlement data is MAC-secured using session keys negotiated between the parties. 

   - Choice of algorithms: authentication using RSA or ECC (key length as defined in [ALGK_BSI]) for authentication keys and CA keys; MAC protection as defined in [ALGK_BSI]. 

   - In level 3+, the type and strength of the mechanism used for loading should also be adapted to future developments in accordance with [ALGK_BSI]. 
...
|1|No reloading mechanism<br>A mechanism for loading new entitlements is not offered. Entitlements are only<br>issued individually. Since the entitlement is already stored on the carrier<br>medium, its confidentiality is automatically assured.||
|2|Loading process secured by proprietary method<br>•<br>See MM11a. As part of secure messaging, not only is authenticity assured<br>by MACs, but confidentiality is also guaranteed by encryption (at least fixed<br>keys).<br>•<br>Possible symmetric algorithms: encryption using T-DES, AES128 or compa-||
...
||Code and name of safeguard|Threats addressed|
|---|---|---|
|MM11b|Loading new entitlements – securing the<br>confidentiality of entitlements|TM2, TM9|
||rable open processes.||
|3|Complex symmetric authentication concept with session key negotiation<br>•<br>•<br>See MM11a; as part of authentication between carrier medium and external<br>component, an encrypting key is negotiated as well as the MAC key, thus<br>setting up a secure channel.<br>Possible symmetric algorithms: standardised symmetric authentication with<br>session key negotiation by means of TDES, AES128 or a comparable open<br>process; encryption using TDES, AES128 or a comparable open process.<br>•<br>The type and strength of the mechanism used for loading should be<br>adapted to future developments in accordance with [ALGK_BSI].||
...
|1|Interface test<br>•<br>Test the PCD’s contact-less interface using [BSI_PCD_TestSpec].<br>•<br>Draw up and apply specific test regulations for the application-specific func-<br>tions of the reader interface||
|2|Component approval<br>•<br>See above, additional component approval (carrier medium, local trans-<br>ponder, readers, key management)||
|3|Certification<br>•<br>See above, and also certification of carrier medium and readers by an inde-<br>pendent institution.||
|**Table 8–51**<br>**Protection of readers through introduction of interface tests**|||
...
|General|Reference information is needed for processes such as communication with the<br>carrier media, for loading and evaluating entitlements, and for generating and<br>storing usage data (CICO data, sales data):<br>•<br>Identifiers (ID)<br>•<br>Keys||
...
|---|---|---|
||Protection of reference information against<br>retrieval, data errors and manipulation|TR1, TR2|
||•<br>Blacklists and whitelists<br>•<br>Algorithms for evaluation<br>Reference information and usage data can differ depending on the applications<br>and entitlements.||
...
|2|Authentication, secure transmission:<br>•<br>Mechanisms for detecting data manipulation in the device, such as MAC-<br>secured saving.<br>•<br>Data should only be transferred from background systems into the reader<br>after mutual authentication, or at least one-sided authentication of the<br>source transmitting to the reader.<br>•<br>Protected data transmission to the carrier medium, where data is to be ac-<br>cepted.<br>•<br>Application-specific separation of algorithms, reference data, usage data<br>and keys.<br>•<br>Save the keys in a SAM or in a protected area of the software.<br>•<br>Introduce application-specific access protection for the reader’s data and<br>administration functions.||
|3|Advanced protection<br>•<br>Mechanisms for detecting data manipulation in the device, such as MAC-<br>secured saving.<br>•<br>Data should only be transferred from backend systems into the reader after<br>mutual authentication between the reader and the source with which it is<br>communicating.<br>•<br>Protected data transmission to the carrier medium.<br>•<br>Application-specific separation of algorithms, reference data, usage data<br>and keys.<br>•<br>Save the keys in an application-specific SAM.<br>•<br>Save and execute cryptographic algorithms in an application-specific SAM.<br>•<br>Introduce multi-tenant, application-specific access protection for the<br>reader’s data and administrative functions in accordance with the role<br>model.||
...
- Design the system characteristics to accord with the specifications defining performance, availability, procedural management and function (this requires sufficiently detailed specifications). 

- • Simple integrity security for system software to detect manipulation of soft- 

- 1 ware modules (e.g. of entitlement test). • Physical protection of devices (e.g. encapsulated casing, mechanical separation of LAN cables). 
...
- Proof of execution: • Integrity security for system software to detect manipulation of software modules (e.g. of entitlement test). 
...
|---|---|---|
|MK2|Introduction of key management for symmetric<br>and asymmetric keys with sufficient key length|All TKs|
|3|Secure, flexible key management concept<br>In level 3 the following may be useful in addition to the points defined in 1 and 2:<br>•<br>A complex asymmetric key management process is used, with a root CA,<br>multiple sub-CAs and certified authentication and encryption keys.<br>•<br>The lengths of the asymmetric keys should generally accord with<br>[ALGK_BSI] (preferential) and [TR_ECARD].<br>The type and strength of the mechanism used for loading should be adapted to<br>future developments in accordance with [ALGK_BSI].||



|**Table 8–55**<br>**Protection through introduction of key management**|**Table 8–55**<br>**Protection through introduction of key management**|**Table 8–55**<br>**Protection through introduction of key management**|
|---|---|---|
...
||EAL5+.||
|**Table 8–56**<br>**Protection through access protection for cryptographic keys**|||
...
|**Table 8–57**<br>**Protection through securing the function of security components**|**Table 8–57**<br>**Protection through securing the function of security components**|**Table 8–57**<br>**Protection through securing the function of security components**|
|---|---|---|
||Code and name of safeguard|Threats addressed|
|MK5|Availability of key management system<br>(fallback solution)|TK4, TK5|
...
|---|---|---|
|MK5|Availability of key management system<br>(fallback solution)|TK4, TK5|
||ments as the original.<br>•<br>The replacement of defective key components must be regulated.||
...
|**Table 8–60**<br>**Protection through separation of keys**|**Table 8–60**<br>**Protection through separation of keys**|**Table 8–60**<br>**Protection through separation of keys**|
|---|---|---|
...
||1<br>Keys must each have a unique identifier containing information on the issu-<br>ing organisation, a unique ID, and a version number.<br>2<br>There should be a way of deleting or blocking keys that have been used up.<br>3<br>New keys are loaded from a key management system into the SAM by the<br>system manager or someone appointed by him; this requires an online con-<br>nection.<br>4<br>Keys must always be loaded under confidential conditions, for which a de-<br>cryption key is required in the SAM.<br>5<br>An asymmetric procedure is used for loading new keys into a SAM, for<br>which a PKI with a CA must be established with which to certify all asym-<br>metric keys.<br>II. General procedure<br>New keys are loaded using a procedure such as the following:<br>1<br>The key issuer (or key management system) sends a public key certified by<br>the CA to the terminal.<br>2<br>The SAM verifies the certificate (e.g. with Verify Certificate) and stores the<br>key issuer’s public key temporarily.<br>3<br>The key issuer encrypts the key that is to be loaded, as well as the other<br>information associated with it (key ID, key version, operating counter, …)<br>using the SAM’s public encrypting key, signs the cryptogram using its own<br>private key, and sends the cryptogram and signature to the SAM.<br>4<br>The SAM checks the signature using the key issuer’s public signature key,<br>and if that is successful it decrypts the cryptogram using its own private de-<br>cryption key, and saves the key and additional information permanently.||
...
|---|---|---|
|Smart Ticket|P1.1, P1.2, P1.3, P1.4|Purchased anonymously.<br>Entitlement issued on specially|
...
|carrier medium|Process numbers|Comments|
|---|---|---|
||P2.3<br>P3.2|produced carrier medium|
|Contact-less se-<br>cure chip card|P1.1, P1.2, P1.3, P1.4<br>P2.4<br>P3.2|Purchased anonymously.<br>Existing personalised customer<br>card. Entitlement loaded onto exist-<br>ing application.|
|Multi-application<br>card|P1.1, P1.2, P1.3, P1.4<br>P2.4<br>P3.2|Purchased anonymously.<br>Existing personalised, multi-<br>application-compatible customer<br>card. Application and entitlement<br>are loaded on.|
|NFC Mobile De-<br>vice|P1.1, P1.2, P1.3, P1.4<br>P2.4<br>P3.2|Purchased anonymously.<br>Application and entitlement are<br>loaded onto existing NFC Mobile<br>Device|
...
|carrier medium|Usage model|Characteristics|
|---|---|---|
|Smart Ticket|Single electronic ticket. Used<br>universally for personalised sin-<br>gle entitlements|Data stored:<br>1 application including per-<br>sonal data, 1 entitlement, seat-<br>ing information, etc<br>Printed information:<br>Name, event information, seat-<br>inginformation|
...
|NFC Mobile De-<br>vice|Non-personalised application,<br>entitlement and seating informa-<br>tion are loaded into a secure<br>memory.|Data stored:<br>Application including personal<br>data, entitlement, seating in-<br>formation, etc. Other applica-<br>tions may be present -> multi-<br>application<br>Information shown on the display:<br>Name, event information, seat-<br>inginformation|
...
|carrier medium|Process numbers|Comments|
|---|---|---|
|Smart Ticket|P1.1, P1.2, P1.3, P1.4<br>P2.1, P2.2, P2.3<br>P3.2|Entitlement issued on specially<br>produced carrier medium|
|Contact-less se-<br>cure chip card|P1.1, P1.2, P1.3, P1.4<br>P2.4<br>P3.2|Existing personalised customer<br>card. Entitlement loaded onto exist-<br>ing application.|
|Multi-application<br>card|P1.1, P1.2, P1.3, P1.4<br>P2.4<br>P3.2|Existing personalised, multi-<br>application-compatible customer<br>card. Application and entitlement<br>are loaded on.|
|NFC Mobile De-<br>vice|P1.1, P1.2, P1.3, P1.4<br>P2.4<br>P3.2|Application and entitlement are<br>loaded onto existing NFC Mobile<br>Device|
...
|carrier medium|Process numbers|Comments|
|---|---|---|
|Contact-less se-<br>cure chip card|P1.1, P1.2, P1.3, P1.4<br>P2.1, P2.2, P2.3, P2.4<br>P3.2|Entitlement issued and loaded onto<br>existing personalised customer<br>card. Entitlement loaded onto exist-<br>ing application.|
|Multi-application<br>card|P1.1, P1.2, P1.3, P1.4<br>P2.4|New issue, or application and enti-<br>tlement are loaded onto existing<br>personalised, multi-application-|
...
|||2|Malfunction affects many customers.|
|||3|Malfunction affects a large proportion of customers<br>System malfunctions (sales system, readers,<br>inspection system, key management system) affect a<br>large number of customers and entitlements.|
|SS3|Intuitive, fault-<br>tolerant|1|A few customers cannot operate it intuitively.|
|||2|Many customers cannot operate it intuitively.|
||operation|3|A large proportion of customers cannot operate it<br>intuitively.|
...
|SS4|Maintaining a<br>high<br>availability<br>level|1|Access throughput and customer behaviour<br>unproblematic.|
|||2|Temporary failures cause operational and security<br>problems.|
|||3|Short-term faults endanger security targets.<br>Complete failures of the access equipment lasting<br>more than 15 minutes can lead to uncontrollable<br>conditions in the case of large crowds. Operative<br>fallback measures usually reduce the level of security.|
|SI1|Protection of<br>personal data<br>(including<br>personal<br>usage data)|1|Customer’s reputation is damaged / data is lost.|
|||2|Customer’s social existence is damaged / data<br>becomes known to third parties.<br>If personal invoicing or payment information stored in<br>the system is stolen or manipulated, there may be<br>considerable commercial and social consequences for<br>the customer.|
|||3|Customer’s physical existence is damaged / data is<br>misused.|
|SI2|Protection of<br>entitlements|1|Predicted product-related loss of sales through<br>counterfeiting, damage or manipulation <1%.|
|||2|Predicted product-related loss of sales through<br>counterfeiting, damage or manipulation <5%.|
|||3|Predicted product-related loss of sales through<br>counterfeiting, damage or manipulation >5%.<br>DoS attacks on the system can lead to a total<br>operational breakdown, thus causing considerable<br>commercial loss.|
|SI3|Protection of<br>logistical data<br>(anonymised<br>usage data)|1|Data becomes known to third parties.|
|||2|Data is lost.<br>The loss of logistical data can also occur through<br>technical defects and can cause operational<br>difficulties.|
|||3|Data is falsified.|
...
|Security target|Security target|Protection<br>demand<br>category|Criteria for allocating to protection demand category|
|---|---|---|---|
||invoicing<br>(personalised<br>)|2|Data is lost.|
|||3|Data is falsified, misused, etc.<br>The possibility of invoicing fraud between the actors<br>cannot be discounted in a system with multiple actors.|
...
|||3|Applications are issued by different application owners<br>and entitlements come from different product owners.<br>Several companies collaborate and do not trust each<br>other in the process.<br>When entitlements are loaded onto multi-application<br>cards or NFC Mobile Devices, it must always be<br>assumed that applications from other actors may be<br>present on the customer medium.|
...
|||2|Protection against fans known to be willing to commit<br>violence.<br>A facility for excluding violently inclined fans should be<br>provided so as to enable the hosting of events such as<br>international football fixtures.|
|||3|Protection against possible violent acts by known<br>potential criminals.|
|||1|Personal data is not used.|
|||2|Personal data is used, but no usage data is collected.|
|SP5|Data<br>minimisation|3|Personal data is used, as is usage and calculation<br>data.<br>It is assumed that personal usage and calculation data<br>is gathered and exchanged with other service<br>providers.|
...
|TS2|Unauthorised<br>scanning of<br>reference data|MS5.3<br>MS6.3<br>MS15.3|1<br>Securing the confidentiality of data<br>when communicating within the system<br>– Secure communication channel<br>2<br>Confidential storage of data – Maintain-<br>ing privacy using multi-tenant access<br>protection.<br>3<br>Separation of applications – Separate<br>storing and processing of data|
...
|Threats to the contact-less<br>interface|Threats to the contact-less<br>interface|Protection<br>demand|Comments|
|---|---|---|---|
|TC1|Lack of<br>compatibility<br>betweenthe|3|A lack of compatibility between interfaces<br>prevents the system from working when<br>loading and using entitlements, checking|
...
|---|---|---|---|
||instructions|||
|TS1|Lack of fallback<br>solution|MS4.3|1<br>Definition of fallback solutions in the<br>event of system interface or system<br>component failure – Implementation<br>according tofallbackconcept|
|TS5|Lack of<br>compatibility<br>between<br>interfaces|MS1.3<br>MS11.3<br>MS12.3|1<br>Introduction of interface tests and ap-<br>proval procedures – Certification<br>2<br>Secure the function of the system to<br>prevent the technical failure of compo-<br>nents and transmission routes –<br>Evaluation of components<br>3<br>Specifications for system concept and<br>requirements for components – Inter-<br>operability tests according to test con-<br>cept, evaluation|
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0117-01.png)
...
- 1 Permanently installed devices For example, the stadiums used for the 2006 FIFA World Cup had permanently installed turnstiles that regulated access to the venues. Inspection units corresponding with Figure 10–3 were integrated into these turnstiles, and connected to the central access system via a LAN. If an entitlement is evaluated successfully, access is granted by unlocking the turnstile and turning it on. 
...
![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0119-01.png)


**----- Start of picture text -----**<br>
OS<br>Processing unit<br>Controller card<br>RFID interface<br>13.56 MHz,<br>proximity interface<br>Data<br>Data flow  Control Security  functions<br>Card Interface<br>ISO/IEC14443,Teil 4<br>Data<br>ISO/IEC 14443<br>Security functions<br>Card/Ticket Interface<br>**----- End of picture text -----**<br>


## **Memory card / ticket** 


![](markdown/tr/TG_03126_2_application_area_Event_Ticketing/TG_03126_2_application_area_Event_Ticketing.pdf-0119-03.png)


**----- Start of picture text -----**<br>
Turnstile<br>Interface<br>host PC to<br>turnstile<br>Processing unit<br>RFID reader module Operator<br>(integrated into turnstile) SAM 1 Operator<br>SAM 2<br>Operator<br>SAM N<br>1-4)<br>SAM 1-N<br>Data buffer<br>RFID interface Data flow control Security functions, Host Interface<br>(ISO/IEC 14443A/B, Part (RS232, USB, etc.)<br>**----- End of picture text -----**<br>
...
|Threats to the sales,<br>inspection and management<br>systems|Threats to the sales,<br>inspection and management<br>systems|Protection<br>demand|Comments|
|---|---|---|---|
...
|Threats to the sales, in-<br>spection and management<br>systems|Threats to the sales, in-<br>spection and management<br>systems|Safeguard|Safeguard|
|---|---|---|---|
...
|TS2|Unauthorised<br>scanning of<br>reference data|MS5.3<br>MS6.3<br>MS15.3|1<br>Securing the confidentiality of data<br>when communicating within the system<br>– Secure communication channel<br>2<br>Confidential storage of data – Introduc-<br>tion of multi-tenant access protection,<br>role model<br>3<br>Separation of applications – Separate<br>storing and processing of data|
...
|TS4|System<br>malfunction|MS12.3<br>MS4.3<br>MS9.3<br>MS10.3<br>MS11.3<br>MS13.3|1<br>Specifications for system concept and<br>requirements for components – Inter-<br>operability tests according to test con-<br>cept, evaluation<br>2<br>Definition of a fallback solution in the<br>event of system interface or system<br>component failure – Implementation<br>according to fallback concept.<br>3<br>Securing system functions against DOS|
...
|Threats to the key<br>management system|Threats to the key<br>management system|Protection<br>demand|Comments|
|---|---|---|---|
...
||Threat|||carrier medium|carrier medium||
|---|---|---|---|---|---|---|
|||Smart<br>Ticket|Secure<br>chip<br>card|Multi-<br>applicati<br>on card|NFC<br>Mobile<br>Device|Comments|
...
|SS3|Intuitive, fault-<br>tolerant<br>operation|1|A few customers cannot operate it intuitively.<br>Only activation is necessary.|
|||2|Many customers cannot operate it intuitively.|
|||3|A large proportion of customers cannot operate it<br>intuitively.|
|SS4|Maintaining a<br>high<br>availability<br>level|1|Access throughput and customer behaviour<br>unproblematic.<br>Category 1 for carrier medium: normal safeguards are<br>sufficient, since even then only a small number of<br>carrier medium malfunctions are to be expected.|
|||2|Temporary failures cause operational and security<br>problems.|
|||3|Short-term faults endanger security targets.<br>Category 3 for access equipment and service desk:<br>total system breakdowns can cause considerable<br>problems.|
|SI1|Protection of<br>personal data<br>(including<br>personal<br>usage data)|1|Not relevant. No personal data.|
|||2||
|||3||
|SI2|Protection of<br>entitlements|1|Predicted product-related loss of sales through<br>counterfeiting, damage or manipulation <1%.<br>From the attacker’s point of view, the expense of<br>falsification must be considerably less than the value<br>of the entitlement (<€20). This can be prevented using<br>simple safeguards.|
|||2|Predicted product-related loss of sales through<br>counterfeiting, damage or manipulation <5%.|
|||3|Predicted product-related loss of sales through<br>counterfeiting, damage or manipulation >5%.|
...
|Security target|Security target|Protection<br>demand<br>category|Criteria for allocating to protection demand category|
|---|---|---|---|
||invoicing<br>(personalised<br>)|2|medium.|
|||3||
|SI5|Protection of<br>applications<br>and<br>entitlements|1|Applications are issued by the same application owner<br>and entitlements by the same product owner.|
|||2|Applications are issued by different application owners<br>and entitlements come from different product owners.<br>The actors trust each other.|
|||3|Applications are issued by different application owners<br>and entitlements come from different product owners.<br>The actors do not trust each other.<br>When loading the entitlement onto multi-application<br>cards or NFC Mobile Devices, it must always be<br>assumed that applications from other actors will be on<br>the customer medium.|
|SP3|Protection<br>against the<br>creation of<br>usage profiles|1|Customer’s reputation may be damaged, but nothing<br>more.|
|||2|Customer’s social existence is damaged.|
|||3|Customer’s physical existence is damaged.|
|SP4|Protection<br>against<br>violent<br>criminals|1|Not relevant.|
|||2||
|||3||
|SP5|Data<br>minimisation|1|Not relevant to the carrier medium.|
|||2||
|||3||
...
|TC1|Lack of compatibility<br>between the inter-<br>faces ofthe carrier|3|3|3|3||
...
**Table 11–2 Threats relevant to the “Non-personalised single entitlement” application scenario** 
...
|TM3|Cloning of<br>medium including<br>entitlement|MM1.1<br>MM2.1|1<br>Hardware and software access protec-<br>tion (read and write access) – Simple<br>access protection<br>2<br>Protection against cloning of carrier<br>medium withentitlement–Simple pro-|
...
The entitlement is activated when the customer enters the event. If the customer leaves the 

closed-off area then that also requires the carrier medium and entitlement. 
...
|||2|Malfunction affects many customers.|
|||3|Malfunction affects a large proportion of customers|
|SS3|Intuitive, fault-<br>tolerant<br>operation|1|A few customers cannot operate it intuitively.<br>Only activation is necessary upon first entry. Re-entry<br>is used by only a small proportion of customers.|
|||2|Many customers cannot operate it intuitively.|
|||3|A large proportion of customers cannot operate it<br>intuitively.|
|SS4|Maintaining a<br>high<br>availability<br>level|1|Access throughput and customer behaviour<br>unproblematic.<br>Category 1 for carrier medium: normal safeguards are<br>sufficient, since even then only a small number of<br>carrier medium malfunctions are to be expected.|
...
|||2|Temporary failures cause operational and security<br>problems.|
|||3|Short-term faults endanger security targets.<br>Category 3 for access equipment and service desk:<br>total system breakdowns can cause considerable<br>problems.|
|SI1|Protection of<br>personal data<br>(including<br>personal<br>usage data)|1|Customer’s reputation is damaged / data is lost.<br>Category 1 for carrier medium: the personal details<br>stored in the carrier medium are not suitable for<br>damaging the customer’s social existence.|
|||2|Customer’s social existence is damaged / data<br>becomes known to third parties.<br>Category 2 for sales system: if the personal calculation<br>or payment data stored in the system can be stolen or<br>manipulated, then this can have considerable<br>commercial and social consequences for the<br>customer.|
|||3|Customer’s physical existence is damaged / data is<br>misused.|
|SI2|Protection of<br>entitlements|1|Predicted product-related loss of sales through<br>counterfeiting, damage or manipulation <1%.<br>From the attacker’s point of view, the expense of<br>falsification must be considerably less than the value<br>of the entitlement (<€150). This can be prevented<br>using simple safeguards.|
|||2|Predicted product-related loss of sales through<br>counterfeiting, damage or manipulation <5%.|
|||3|Predicted product-related loss of sales through<br>counterfeiting, damage or manipulation >5%.|
|SI3|Protection of<br>logistical data<br>(anonymised<br>usage data)|1|Not relevant. No usage data on the carrier medium.|
|||2||
...
|||carrier medium|carrier medium|||Comments|
|---|---|---|---|---|---|---|
|Threat||Smart<br>Ticket|Secure<br>chip<br>card|Multi-|NFC<br>Mobile<br>Device||
|||||applica-|||
|||||tion card|||
...
|Use Case|carrier medium|carrier medium||||
|---|---|---|---|---|---|
...
|Blacklisting|+|+|+|+||
|Key management|+|+|+|+||
|**Table 11–10**|**Use cases relevant to the “Personalised single entitlement” application**<br>**scenario**|||||
...
|TM2|Unauthorised<br>overwriting /ma-|MM1.1|1<br>Hardware and software access protec-<br>tion(read andwrite access)–Simple|
...
|Threat||Safeguard|Safeguard|
|---|---|---|---|
|TS11|Access by known<br>violent criminals|MS17.2|1<br>Prevent access by known violent crimi-<br>nals – Prevent violently inclined fans<br>fromentering|
|**Table 11–11**<br>**Safeguards when utilising the Smart Ticket**||||
...
|TM2|Unauthorised<br>overwriting /<br>manipulation of<br>entitlement|MM1.3<br>MM11a.3<br>MM11b.3|1<br>Hardware and software access protec-<br>tion (read and write access) – Ad-<br>vanced access protection<br>2<br>Loading new entitlements – Securing<br>the entitlement in terms of authenticity<br>and integrity – Complex authentication<br>concept.<br>3<br>Loading new entitlements – Securing<br>the entitlement in terms of confidential-<br>ity – Complex authentication concept.|
|TM3|Cloning of<br>medium including<br>entitlement|MM1.3<br>MM2.3|1<br>Hardware and software access protec-<br>tion (read and write access) – Ad-<br>vanced access protection<br>2<br>Protection against cloning of carrier<br>medium with entitlement – Advanced<br>protection|
|TM4|Emulation of<br>applicationor|MM1.1|1<br>Hardware and software access protec-<br>tion(read andwrite access)|
...
|Threat||Safeguard|Safeguard|
|---|---|---|---|
|TC1|Lack of compati-<br>bility between in-<br>terfaces in carrier|MS1.3<br>MR1.3|1<br>Introduction of interface tests and ap-<br>proval procedures – Certification|
...
|Threat||Safeguard|Safeguard|
|---|---|---|---|
|||MM10b.3<br>MM11a.3<br>MM11b.3|authenticity and integrity of applications<br>– Implementation of a reloading mecha-<br>nism as defined by ISO 7816-13 with SM<br>3<br>Loading new applications – Securing the<br>confidentiality of applications – Imple-<br>mentation of a reloading mechanism as<br>defined by ISO 7816-13 with SM<br>4<br>Loading new entitlements – Securing the<br>authenticity and integrity of entitlements<br>– Complex authentication concept<br>5<br>Loading new entitlements – Securing the<br>confidentiality of entitlements – Complex<br>authentication concept|
|TM10|carrier medium<br>malfunction|MM7.1|1<br>Specification of carrier medium charac-<br>teristics – Manufacturer’s declaration|
|TM11|Tracking by<br>means of unau-<br>thorised scanning<br>of UID|MM8.1|1<br>Introduce proximity technology as de-<br>fined by ISO/IEC14443|
...
|TS10|Sales to known<br>violent criminals|MS17.2<br>MS16.2|1<br>Prevent access by known violent crimi-<br>nals – Prevent violently inclined fans<br>from entering<br>2<br>Identifying the customer when selling<br>and handing over products – Application<br>form, customer cards|
|TS11|Access by known<br>violent criminals|MS17.2|1<br>Prevent access by known violent crimi-<br>nals – Prevent violently inclined fans<br>from entering|
...
|||3|Customer’s physical existence is damaged / data is<br>misused.|
|SI2|Protection of<br>entitlements|1|Predicted product-related loss of sales through<br>counterfeiting, damage or manipulation <1%.|
|||2|Predicted product-related loss of sales through<br>counterfeiting, damage or manipulation <5%.<br>From the point of view of an attacker, the expense of<br>counterfeiting must be well below the value of the<br>entitlement (< €500). This can be prevented using<br>level 2 safeguards.|
...
|---|---|---|---|
|||3|Predicted product-related loss of sales through<br>counterfeiting, damage or manipulation >5%.|
|SI3|Protection of<br>logistical data<br>(anonymised<br>usage data)|1|Not relevant. No logistical data on the carrier medium.|
|||2||
|||3||
|SI4|Reliable<br>invoicing<br>(personalised<br>)|1|Data is temporarily unavailable.|
|||2|Data is lost.<br>It is assumed that the actors in the system trust one<br>another. Reliable calculation data must nevertheless<br>be available.|
...
Recommendation Rec (2002) 1 on guidelines for ticket sales at international football matches (teams and nations), http://www.coe.int//t/dg4/sport/Resources/texts/sprec02.1_en.asp, download from Sept. 15[th] 2008 
