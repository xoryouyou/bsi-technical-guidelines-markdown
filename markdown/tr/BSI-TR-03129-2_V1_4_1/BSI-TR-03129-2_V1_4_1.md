...
|1.|Changelog .................................................................................................................................... 1|
|---|---|
|1.1.|Changelog 1.4.1 ........................................................................................................................ 1|
|1.2.|Changelog 1.4.0 ........................................................................................................................ 1|
|2.|Introduction ................................................................................................................................. 4|
|2.1.|Terminology ............................................................................................................................ 4|
|2.2.|Roles ....................................................................................................................................... 4|
|2.3.|Procedures .............................................................................................................................. 5|
|2.4.|Communication Model ............................................................................................................ 5|
|3.|Protocols for Passive Authentication ............................................................................................. 6|
|3.1.|Implementation as Web Services .............................................................................................. 6|
|3.2.|Distribution of Document Signer Lists / DS Certificates ............................................................. 6|
|3.3.|Passive Authentication for distributed terminals ....................................................................... 7|
|4.|Protocols for Terminal Authentication ........................................................................................ 12|
|4.1.|Implementation as Web Services ............................................................................................ 12|
|4.2.|Terminal Authentication for distributed terminals .................................................................. 12|
|4.3.|Terminal Authentication for DVs that forbid callbacks from CVCAs ......................................... 14|
|4.4.|Terminal Authentication for DVs that request foreign certificates ............................................ 15|
|5.|Protocols for Digital Seals ........................................................................................................... 17|
|5.1.|Implementation as Web Services ............................................................................................ 17|
|5.2.|Distribution of Signer Lists ..................................................................................................... 17|
|5.3.|Digital Seal Verification for distributed terminals .................................................................... 19|
|6.|Digital Seal Formats .................................................................................................................... 24|
|6.1.|VDS ....................................................................................................................................... 24|
|6.2.|VDS-NC ................................................................................................................................. 28|
|6.3.|EUCWT ................................................................................................................................. 37|
|7.|Defect Lists for ePassport Application .......................................................................................... 42|
|7.1.|Defect List Format ................................................................................................................. 42|
|7.2.|Defect List Signer ................................................................................................................... 43|
|7.3.|Defect Categories ................................................................................................................... 43|
|8.|Signed Data Profiles for Signer Lists ............................................................................................ 49|
|8.1.|Document Signer List Format ................................................................................................. 49|
|8.2.|EU Health Seal Signer List Format .......................................................................................... 49|
|8.3.|ICAO Health Seal Signer List Format ...................................................................................... 50|
|8.4.|Sovereign Seal Signer List Format ........................................................................................... 50|
|8.5.|Signer List Signers .................................................................................................................. 50|
|A.|Infrastructures for Terminals ...................................................................................................... 52|
...
|A.1.|Integrated terminal ..................................................................................................................... 53|
|---|---|
|A.2.|Distributed terminal with local control centre ............................................................................. 54|
|A.3.|Distributed terminal with control centre operated by the DV provider .......................................... 55|
...
- `aad` ( `VDS.messageArrivalAttestationDocumentType` ) See [BSI-TR-03137-1]. The structure of this type is given in Table 6.6. 

- `sic` ( `VDS.messageSocialInsuranceCardType` ) See [BSI-TR-03137-1]. The structure of this type is given in Table 6.7. 

- `rp` ( `VDS.messageResidencePermitType` ) See [BSI-TR-03137-1]. The structure of this type is given in Table 6.8. 
...
If neither option uniquely identifies the DS certificate (e.g. due to a defect in the certificate), the hash of the DS certificate SHALL additionally be included. The hash function to be used is indicated in `DefectList` . 

## 7.2. Defect List Signer 
...
## **7.3.1.1. Document Signer Certificate Revoked** 
...
## **7.3.1.2. Document Signer Certificate Malformed** 
...
## **7.3.1.3. Chip Authentication Private Keys Compromised** 
...
## **7.3.1.4. Active Authentication Private Keys Compromised** 
...
## **7.3.1.5. Authentication Protocol Failure** 
...
## **7.3.1.6. Validity Period Incorrect** 
...
## 7.3.2. Application Defects (for the ePassport Application) 
...
## **7.3.2.2. Document Security Object Malformed** 
...
## **7.3.2.3. COM and SOD Discrepancy** 
...
## **7.3.2.4. Wrong Signer Identifier** 
...
## **7.3.2.5. Issuing Country Defect** 
...
## 7.3.3. General Document Defects 
...
## **7.3.3.1. Card Security Object Malformed** 
...
## **7.3.3.2. Chip Security Object Malformed** 
...
## **7.3.3.4. Document Signer Certificate incorrectly encoded or malformed** 
...
## 8.5. Signer List Signers 

A Signer List SHALL be signed by an eligible Signer List Signer. A Signer List Signer certificate SHALL include an OID in the `extendedKeyUsage` extension for every type of Signer List that the Signer List Signer shall be entitled to sign. The OIDs to use are given in Table 8.2. An Signer List Signer certificate MAY include more than one of those OIDs inside its `extendedKeyUsage` extension to allow the Signer List Signer to use one private key to sign different signer list types. 
...
**Table 8.2** extendedKeyUsage of signer lists 

Any system that is processing a Signer List with the intent to directly or indirectly use signer certificates from that Signer List SHALL check whether the Signer List has a valid signature from an eligible Signer List Signer by using a Signer List Signer certificate. If the signature is invalid, the system SHALL NOT use that Signer List. If the signature is not from an eligible Signer List Signer, the system SHALL NOT use that Signer List. 
...
![](markdown/tr/BSI-TR-03129-2_V1_4_1/BSI-TR-03129-2_V1_4_1.pdf-0058-01.png)
...
![](markdown/tr/BSI-TR-03129-2_V1_4_1/BSI-TR-03129-2_V1_4_1.pdf-0059-03.png)
...
![](markdown/tr/BSI-TR-03129-2_V1_4_1/BSI-TR-03129-2_V1_4_1.pdf-0060-01.png)
