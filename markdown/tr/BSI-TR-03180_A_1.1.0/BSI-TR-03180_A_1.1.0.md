...
|---|---|---|---|
|1.1.0|20.10.2024|Federal Office for Information Security|Version: 1.1.0<br>Minor Clarifications<br>References to Baseline<br>Standards<br>Additional recommended<br>biometric requirements|
...
||3.7|REUSE OFEVIDENCES............................................................................................................................................. 15|
|**4**|**REQUIREMENTS AND TEST SPECIFICATIONS ......................................................................................................16**||
||4.1|CRYPTOGRAPHICSUPPORT(FCS) ............................................................................................................................. 16|
||4.2|GENERAL(ALG) ................................................................................................................................................... 19|
...
![](markdown/tr/BSI-TR-03180_A_1.1.0/BSI-TR-03180_A_1.1.0.pdf-0005-05.png)
...
![](markdown/tr/BSI-TR-03180_A_1.1.0/BSI-TR-03180_A_1.1.0.pdf-0007-11.png)
...
This document defines requirements based on a selection of security criteria from ETSI TS 103 732 [1] in conjunction with BSI TR-03180 [2] as well as the currently known state of the Cyber Resilience Act (CRA) that are considered relevant for the area of application (see section 1.2). 
...
- Baseline Requirements: Requirements directly derived from TS 103 732 [1] or another baseline standard. These requirements can be substituted with corresponding baseline standard and the corresponding assessment. The corresponding standard is indicated with “Referenced standard”. 
...
In accordance with the BSI's "Application notes and interpretations of the scheme" (AIS) on the subject of "Requirements for the structure and content of ETR parts for evaluations according to CC" [6], each individual 
...
verdict must be documented in a comprehensible manner. This documentation **SHALL** include at least the following information: 
...
## 4.1.1 FCS_RNG_EXT.1 Random number generation 

## 4.1.1.1 FCS_RNG_EXT.1a (Mandatory) 
...
**Referenced Standard:** ETSI TS 103 732-1 FCS_RNG_EXT.1.1 

## 4.1.1.2 FCS_RNG_EXT.1b (Mandatory) 
...
**Referenced Standard:** TS 103 732-1 FCS_RNG_EXT.1.2 

## 4.1.2 FCS_CKM.1 

## 4.1.2.1 FCS_CKM.1a (Mandatory) 
...
**Referenced Standard:** TS 103 732-1 FCS_CKM.1.1/Asymmetric 

## 4.1.2.2 FCS_CKM.1b (Mandatory) 

**Test property:** The TOE **SHALL** be able to generate cryptographic keys for symmetric encryption in accordance with a specified cryptographic key generation algorithm using a RNG as specified in FCS_RNG_EXT.1 or a specified combination of precursor key material using a derivation function as specified in FCS_COP.1d and specified cryptographic key sizes of at least 128 bit. 

**Test methods: T.1, T.2, T.3** 

**Referenced Standard:** TS 103 732-1 FCS_CKM.1.1/Symmetric 
...
**Referenced Standard:** TS 103 732-1 FCS_COP.1/SigGen 

## 4.1.3.2 FCS_COP.1b (Mandatory) 
...
**Referenced Standard:** TS 103 732-1  FCS_COP.1/KeyEst 

## 4.1.3.3 FCS_COP.1c (Mandatory) 
...
**Referenced Standard:** TS 103 732-1 FCS_COP.1.1/Symmetric 

## 4.1.3.4 FCS_COP.1d (Mandatory) 
...
**Referenced Standard:** TS 103 732-1 FCS_COP.1.1/Derivation 

## 4.1.3.5 FCS_COP.1e (Mandatory) 
...
**Referenced Standard:** TS 103 732-1  FCS_COP.1.1/Hash 

## 4.1.3.6 FCS_COP.1.f (Mandatory) 
...
**Referenced Standard:** TS 103 732-1  FCS_COP.1.1/KeyedHash 
...
## _4.1.4.1_ FCS_CKH_EXT.1.a (Mandatory) 

**Test property:** The TOE **SHALL** support a key hierarchy for data encryption keys to protect data class 000. **Test methods: T.1, T.2, T.3** 

**Referenced Standard:** TS 103 732-1  FCS_CKH_EXT.1.1/Low 

## 4.1.4.2 FCS_CKH_EXT.1b (Mandatory) 

**Test property:** For the key hierarchy according to FCS_CKH_EXT.1.a, The TOE **SHALL** ensure that all keys in the key hierarchy are derived and/or generated according to _according to FCS_CKM.1a, FCS_CKM.1b and/or FCS_COP.1d_ ensuring that the key hierarchy uses the DUK and no user credentials directly or indirectly in the derivation of the data encryption key(s) for data class 000. 

**Test methods: T.1, T.2, T.3** 

**Referenced Standard:** TS 103 732-1 FCS_CKH_EXT.1.2/Low 

## 4.1.4.3 FCS_CKH_EXT.1c (Mandatory) 

**Test property:** For the key hierarchy according to FCS_CKH_EXT.1.a, the TOE **SHALL** ensure that all keys in the key hierarchy according to and all data used in deriving the keys in the hierarchy are protected following acknowledged rules of technology. 

**Test methods: T.1, T.2, T.3** 

**Referenced Standard:** TS 103 732-1 FCS_CKH_EXT.1.3/Low 

## 4.1.4.4 FCS_CKH_EXT.1d (Mandatory) 

**Test property:** The TOE **SHALL** support a key hierarchy for data encryption keys to protect data of class 001 and above. 

**Test methods: T.1, T.2, T.3** 

**Referenced Standard:** TS 103 732-1  FCS_CKH_EXT.1.1/MediumHigh 

## 4.1.4.5 FCS_CKH_EXT.1e (Mandatory) 

**Test property:** For the key hierarchy according to FCS_CKH_EXT.1.d, the TOE **SHALL** ensure that all keys in the key hierarchy are derived and/or generated according to _according to FCS_CKM.1a, FCS_CKM.1b and/or FCS_COP.1d_ ensuring that the key hierarchy uses the DUK and the user credentials directly or indirectly in the derivation of the data encryption key(s) for data of class 001 and above. 

**Test methods: T.1, T.2, T.3** 

**Referenced Standard:** TS 103 732-1 FCS_CKH_EXT.1.2/MediumHigh 

4.1.4.6 FCS_CKH_EXT.1f (Mandatory) 

**Test property:** For the key hierarchy according to FCS_CKH_EXT.1.d, the TOE **SHALL** ensure that all keys in the key hierarchy and all data used in deriving the keys in the hierarchy are protected following acknowledged rules of technology. 

**Test methods: T.1, T.2, T.3** 

**Referenced Standard:** TS 103 732-1 FCS_CKH_EXT.1.3/MediumHigh 
...
## 4.1.5 FCS_CKM.4 Cryptographic key destruction 
...
- _For volatile memory by a single direct overwrite consisting of a random pattern, RNGs or zeroes_ 

- _For non-volatile EEPROM, by a single direct overwrite consisting of a random pattern, using the toe's RNG followed by a read-verify;_ 

- _For non-volatile flash memory, that is not wear-levelled, by a single direct overwrite consisting of zeros followed by a read-verify or a block erase that erases the reference to memory that stores data as well as the data itself;_ 

- _For non-volatile flash memory, that is wear-levelled, by a single direct overwrite consisting of zeros, a block erase_ 

- _For non-volatile memory other than EEPROM and flash, by a single direct overwrite with a random pattern that is changed before each write_ 

**Test methods: T.1, T.2, T.3** 

**Referenced Standard:** TS 103 732-1 FCS_CKM.4.1 
...
## 4.2.1.1 ALG_SPR.1.1a (Recommended, ISL) 
...
## 4.2.1.2 ALG_SPR.1.1b (Recommended, ISL) 
...
## 4.2.2.1 ALG_SPR.1.2a (Mandatory, ISL) 
...
## 4.2.2.2 ALG_SPR.1.2b (Mandatory, ISL) 
...
## 4.2.3.1 ALG_SPR.1.3a (Mandatory, ISL) 
...
## 4.2.4.1 ALG_ERG.1.1a (Recommended, ISL) 
...
## 4.2.5.1 ALG_ERG1.2a (Recommended, ISL) 
...
## 4.2.5.2 ALG_ERG.1.2b (Recommended, ISL) 
...
## 4.2.6.1 ALG_ERG.1.3a (Recommended, ISL) 
...
Existing standards are used for the design of product information (e.g., ISO/IEC Guide 14:2018; CENCENELEC GUIDE 11 [7], CEN-CENELEC GUIDE 6 [8] ). 

## 4.2.7.1 ALG_ERG.1.4a (Recommended, ISL) 
...
## 4.2.8.1 ALG_ERG.1.5a (Optional, OPT) 
...
## 4.2.8.2 ALG_ERG.1.5b (Optional, OPT) 
...
## 4.2.8.3 ALG_ERG.1.5c (Optional, OPT) 

**Test property:** The manufacturer **CAN** design the product information according to the derived criteria (cf. ALG_ERG.1.1b). 
...
## 4.3.1.1 BZS_AUS.1.1a (Mandatory, ISL) 
...
## 4.3.1.2 BZS_AUS.1.1b (Recommended, ISL) 
...
**Referenced Standard:** TS 103 732-5 FPT_INI.1.2 
...
## 4.3.3.1 BZS_SCB.1.2a (Mandatory) 
...
**Referenced Standard:** TS 103 732-5 FPT_INI.1.3 

## 4.3.3.2 BZS_SCB.1.2b (Mandatory) 
...
## 4.3.4.1 BZS_SCB.2.1a (Recommended) 
...
**Referenced Standard:** TS 103 732-1 FPT_RCV.2.2 

## 4.3.4.2 BZS_SCB.2.1b (Recommended) 
...
## 4.3.5.1 BZS_SCB.2.2a (Mandatory) 
...
**Referenced Standard:** TS 103 732-1 FPT_RCV.2.1 

## 4.3.5.2 BZS_SCB.2.2b (Mandatory) 
...
## 4.3.6.1 BZS_GERPIN.1.1a (Mandatory, ISL) 
...
**Referenced Standard:** TS 103 732-1 FDP_ACC.1/UserDataAsset 

## 4.3.6.2 BZS_GERPIN.1.1b (Mandatory, ISL) 
...
## **Referenced Standard:** TS 103 732-1 FIA_UAU.1 

## 4.3.7 BZS_UNLOCK.1.1 
...
## 4.3.8.1 BZS_LOCK.1.2a (Mandatory) 
...
**Referenced Standard:** TS 103 732-1 FIA_UID.1 

## 4.3.8.2 BZS_LOCK.1.2b (Mandatory) 
...
## 4.3.8.3 BZS_LOCK.1.2c (Mandatory) 
...
## 4.3.8.4 BZS_LOCK.1.2d (Mandatory) 
...
## 4.3.8.5 BZS_LOCK.1.2e (Mandatory) 
...
## 4.3.9.1 BZS_MAIN.1.1a (Mandatory) 

**Test property:** User data according to BZS_GERPIN.1.1 **SHALL NOT** be decrypted in the MAIN operating state. 
...
## 4.3.10.1 BZS_MAIN.1.2a (Mandatory, ISL) 
...
## 4.4.1.1 UPD_ALG.1.1a (Mandatory) 
...
**Referenced Standard:** MDSCERT ALC_FLR.3.4D 

## 4.4.1.2 UPD_ALG.1.1b (Mandatory) 
...
## 4.4.2.1 UPD_ALG.1.2a (Mandatory) 
...
## 4.4.2.2 UPD_ALG.1.2b (Recommended, ISL) 
...
## 4.4.3.1 UPD_ALG.1.3a (Mandatory, ISL) 
...
## 4.4.3.2 UPD_ALG.1.3b (Mandatory, ISL) 
...
## 4.4.3.3 UPD_ALG.1.3c (Recommended, ISL) 
...
## 4.4.4.1 UPD_VUL.1.1a (Mandatory) 
...
**Referenced Standard:** ETSI TS 103 732-1 ALC_FLR.3.2C 

## 4.4.4.2 UPD_VUL.1.1b (Mandatory, CRA) 
...
## 4.4.4.3 UPD_VUL.1.1c (Mandatory) 
...
**Referenced Standard:** ETSI TS 103 732 ALC_FLR.3 
...
## 4.4.4.4 UPD_VUL.1.1d (Recommended, ISL) 
...
## 4.4.4.5 UPD_VUL.1.1e (Recommended) 
...
Referenced Standard: ETSI TS 103 732 ALC_CMS.2 
...
## 4.4.5.1 UPD_VUL.1.2a (Mandatory, CRA) 
...
## 4.4.6.1 UPD_VUL.1.3a (Mandatory, CRA) 
...
## 4.4.7.1 UPD_VUL.1.4a (Mandatory) 
...
**Referenced Standard:** ETSI TS 103 732 ALC_FLR.3.6C 
...
## 4.4.8.1 UPD_SCH.1.1a (Mandatory) 
...
## 4.4.8.2 UPD_SCH.1.1b (Mandatory) 
...
## 4.4.8.3 UPD_SCH.1.1c (Mandatory, ISL) 
...
## 4.4.8.4 UPD_SCH.1.1d (Recommended, CRA) 
...
## 4.4.9.1 UPD_SCH.1.2a (Mandatory) 
...
## 4.4.9.2 UPD_SCH.1.2b (Mandatory) 
...
## 4.4.10.1 UPD_SCH.1.3a (Mandatory) 
...
**Referenced Standard:** ETSI TS 103 732-1 FDP_UPF_EXT.1.1 
...
## 4.4.11.1 UPD_SCH.1.4a (Mandatory, ISL) 
...
**Referenced Standard:** ETSI TS 103 732-1 FMT_SMF.1.1 
...
## 4.4.12.1 UPD_SCH.1.5a (Mandatory, ISL) 
...
## 4.4.12.2 UPD_SCH.1.5b (Mandatory, ISL) 
...
## 4.4.12.3 UPD_SCH.1.5c (Mandatory, ISL) 
...
## 4.4.13.1 UPD_UMG.1.1a (Mandatory, ISL) 
...
## 4.4.14.1 UPD_UMG.1.2a (Mandatory) 
...
**Referenced Standard:** ETSI TS 103 732-1 **FDP_ACF.1.2** 
...
## 4.4.15.1 UPD_UMG.2.1a (Mandatory, ISL) 
...
## 4.4.15.2 UPD_UMG.2.1b (Mandatory, ISL) 
...
## 4.4.15.3 UPD_UMG.2.1c (Mandatory, ISL) 
...
## 4.4.16.1 UPD_UMG.2.2a (Mandatory) 
...
## 4.4.16.2 UPD_UMG.2.2b (Mandatory) 
...
**Referenced Standard:** ETSI TS 103 732-1 FMT_SMF.1.1/SSW_Update 

## 4.4.16.3 UPD_UMG.2.2c (Recommended, CRA) 
...
## 4.4.17.1 UPD_UMG.2.3a (Recommended, ISL) 
...
## 4.4.17.2 UPD_UMG.2.3b (Recommended, ISL) 
...
## 4.4.18.3 UPD_UMG.2.4c (Recommended, ISL) 
...
## 4.4.18.4 UPD_UMG.2.4d (Recommended, ISL) 
...
## 4.4.19.1 UPD_AUT1.1a (Mandatory) 
...
## 4.4.20.1 UPD_AUT.1.2a (Mandatory) 
...
## 4.4.21.1 UPD_AUT.1.3a (Mandatory, ISL) 
...
## 4.4.22.1 UPD_AUT.1.4a (Mandatory, ISL) 
...
## 4.5.1.1 INS_ALG.1.1a (Mandatory, ISL) 
...
## 4.5.2.1 INS_ALG.2.1a (Mandatory, ISL) 
...
## 4.5.3.1 INS_ALG.2.2a (Mandatory, ISL) 
...
## 4.5.4.1 INS_ALG.2.3a (Recommended, ISL) 
...
## 4.5.4.2 INS_ALG.2.3b (Recommended, ISL) 
...
## 4.5.4.3 INS_ALG.2.3c (Recommended, ISL) 
...
## 4.5.5.1 INS_AUT.1.1a (Mandatory, ISL) 
...
## 4.5.6.1 INS_AUT.1.2a (Recommended, ISL) 
...
## 4.5.7.1 INS_AUT.1.3a (Mandatory, ISL) 
...
## 4.5.8.1 INS_ROL.1.1a (Mandatory, ISL) 
...
## 4.6.1.1 KRY_KMG.1.1a (Mandatory, ISL) 
...
## 4.6.1.2 KRY_KMG.1.1b (Mandatory, ISL) 
...
## 4.6.1.3 KRY_KMG.1.1c (Mandatory, ISL) 
...
## 4.6.1.4 KRY_KMG.1.1d (Mandatory, ISL) 
...
## 4.7.2.1 USR_AUT.1.2a (Voluntary, OPT) 
...
**Note:** Flaws in the biometric authentication which make the device susceptible to simple impersonation attacks, e.g. a too high false acceptance rate, are regarded as vulnerabilities and have to be fixed in a timely manner according to UPD_SCH.1.1a. 

**Test methods: T.2** 

## 4.7.2.2 USR_AUT.1.2b (Recommended, ISL) 
...
## 4.7.2.3 USR_AUT.1.2c (Recommended, ISL) 
...
## 4.7.3.1 USR_AUT.1.3a (Mandatory, ISL) 
...
## 4.7.4.1 USR_AUT.1.4a (Mandatory, ISL) 
...
## 4.7.4.2 USR_AUT.1.4b (Mandatory, ISL) 
...
## 4.7.5.1 USR_PWL.1.1a (Mandatory, ISL) 
...
## 4.7.5.2 USR_PWL.1.1b (Mandatory, ISL) 
...
## 4.7.5.3 USR_PWL.1.1c (Mandatory, ISL) 
...
## 4.7.6.1 USR_AUF.1.1a (Mandatory, ISL) 
...
## 4.7.6.2 USR_AUF.1.1b (Mandatory, ISL) 
...
## 4.7.6.3 USR_AUF.1.1c (Mandatory, ISL) 
...
## 4.7.6.4 USR_AUF.1.1d (Recommended, ISL) 
...
## 4.7.7.1 USR_AUF.1.2a (Mandatory, ISL) 
...
## 4.7.8.1 USR_AUF.1.3a (Mandatory, ISL) 
...
## 4.7.9.1 USR_MGM.1.1a (Mandatory, ISL) 
...
## 4.7.9.2 USR_MGM.1.1b (Mandatory, ISL) 
...
## 4.7.10.1 USR_MGM.1.2a (Mandatory, ISL) 
...
## 4.7.10.2 USR_MGM.1.2b (Mandatory, ISL) 
...
## 4.8.1.1 DAT_ALG.1.1a (Mandatory, ISL) 
...
## 4.8.2.1 DAT_ALG.1.2a (Mandatory, ISL) 
...
4.8.2.2 DAT_ALG.1.2b (Mandatory, ISL) 
...
## 4.8.2.3 DAT_ALG.1.2c (Mandatory, ISL) 
...
## 4.8.3.1 DAT_SKL.1.1a (Mandatory, ISL) 
...
## 4.8.4.1 DAT_SKL.1.2a (Recommended, ISL) 
...
## 4.8.5.1 DAT_SKL.1.3a (Mandatory, ISL) 
...
## 4.8.5.4 DAT_SKL.1.3d (Mandatory, ISL) 

**Test property:** Data of protection class 999 **SHALL** be stored exclusively in this storage area (see KRY_KMG.1.1b). 

## **Test methods: T.1, T.2, T.3** 

## 4.8.5.5 DAT_SKL.1.3e (Mandatory, ISL) 

**Test property:** Data of protection class 999 (e.g., biometric data) **SHALL** NOT be viewable or editable by third parties during collection, processing and storage in the specially protected area (see KRY_KMG.1.1a). **Test methods: T.1, T.2, T.3** 
...
## 4.8.6.1 DAT_BER.1.1a (Mandatory, ISL) 
...
4.8.7.1 DAT_BER.1.2a (Mandatory, ISL) 
...
## 4.8.8.1 DAT_BER.1.3a (Mandatory, ISL) 
...
## 4.8.8.2 DAT_BER.1.3b (Mandatory, ISL) 
...
## 4.8.8.3 DAT_BER.1.3c (Mandatory, ISL) 
...
## 4.8.9.1 DAT_BER.1.4a (Mandatory, ISL) 
...
## 4.8.10.1 DAT_BER.1.5a (Mandatory, ISL) 
...
## 4.8.11.1 DAT_BER.1.6a (Mandatory, ISL) 
...
## 4.8.12.1 DAT_BER.2.1a (Mandatory, ISL) 
...
## 4.8.13.1 DAT_BER.2.2a (Mandatory, ISL) 
...
## 4.8.14.1 DAT_BER.2.3a (Mandatory, ISL) 
...
## 4.8.15.1 DAT_BER.2.4a (Mandatory, ISL) 
...
## 4.8.15.2 DAT_BER.2.4b (Recommended, ISL) 
...
## 4.8.16.1 DAT_BER.3.1a (Mandatory, ISL) 
...
## 4.8.16.2 DAT_BER.3.1b (Recommended, ISL) 
...
## 4.8.16.3 DAT_BER.3.1c (Recommended, ISL) 
...
## 4.8.17.1 DAT_BER.3.2a (Mandatory, ISL) 
...
## 4.8.18.1 DAT_BER.3.3a (Voluntary, OPT) 
...
## 4.8.19.1 DAT_KRY.1.1a (Recommended, ISL) 
...
## 4.8.20.1 DAT_KRY.2.1a (Mandatory, ISL) 
...
## 4.8.21.1 DAT_KRY.2.2a (Mandatory, ISL) 
...
## 4.8.22.1 DAT_KRY.2.3a (Mandatory, ISL) 
...
## 4.8.24.1 DAT_DEL.1.1a (Mandatory, ISL) 
...
## 4.8.24.2 DAT_DEL.1.1b (Mandatory, ISL) 
...
## 4.8.25.1 DAT_TRK.1.1a (Mandatory, ISL) 
...
## 4.8.26.1 DAT_TRK.1.2a (Mandatory, ISL) 
...
## 4.8.27.1 DAT_TRK.1.3a (Recommended, ISL) 
...
## 4.8.28.1 DAT_TRK.1.4a (Mandatory, ISL) 
...
## 4.8.30.1 DAT_TRK.1.6a (Voluntary, OPT) 
...
## 4.8.31.1 DAT_TRK.1.7a (Mandatory, ISL) 
...
## 4.8.31.2 DAT_TRK.1.7b (Mandatory, ISL) 
...
## 4.8.31.3 DAT_TRK.1.7c (Recommended, ISL) 
...
## 4.8.32.1 DAT_SEN.1.1a (Mandatory, ISL) 
...
## 4.8.33.1 DAT_SEN.1.2a (Mandatory, ISL) 
...
## 4.8.34.1 DAT_SEN.2.1a (Mandatory, ISL) 
...
## 4.8.35.1 DAT_SEN.2.2a (Mandatory, ISL) 
...
## 4.8.36.1 DAT_SEN.2.3a (Mandatory, ISL) 
...
## 4.8.37.1 DAT_SEN.3.1a (Mandatory, ISL) 
...
## 4.8.37.2 DAT_SEN.3.1b (Mandatory, ISL) 
...
## 4.8.37.3 DAT_SEN.3.1c (Recommended, ISL) 
...
## 4.9.1.1 DUE_ALG.1.1a (Mandatory, ISL) 
...
## 4.9.2.1 DUE_ALG.1.2a (Mandatory, ISL) 
...
## 4.9.3.1 DUE_ALG.1.3a (Mandatory, ISL) 
...
## 4.9.3.2 DUE_ALG.1.3b (Recommended, ISL) 
...
## 4.9.4.1 DUE_ALG.1.4a (Mandatory, ISL) 
...
## 4.9.5.1 DUE_INT.1.1a (Recommended, ISL) 

**Test property:** The DUT **SHOULD** be able to deactivate the microphone. 

## **Test methods: T.2** 

## 4.9.5.2 DUE_INT.1.1b (Mandatory, ISL) 
...
## 4.9.6.3 DUE_INT.2.1c (Mandatory, ISL) 
...
## 4.9.6.4 DUE_INT.2.1d (Recommended, ISL) 

**Test property:** The Bluetooth interface **SHOULD** be deactivated by default. **Test methods: T.2** 
...
## 4.9.7.1 DUE_INT.3.1a (Recommended, ISL) 

**Test property:** The DUT **SHOULD** be able to deactivate the NFC interface. 

## **Test methods: T.2** 

## 4.9.7.2 DUE_INT.3.1b (Mandatory, ISL) 
...
## 4.9.7.3 DUE_INT.3.1c (Mandatory, ISL) 
...
## 4.9.7.4 DUE_INT.3.1d (Recommended, ISL) 
...
## 4.9.8.1 DUE_INT.4.1a (Mandatory, ISL) 

**Test property:** The DUT **SHALL** be able to deactivate the WLAN interface. 

## **Test methods: T.2** 

## 4.9.8.2 DUE_INT.4.1b (Mandatory, ISL) 
...
## 4.9.8.3 DUE_INT.4.1c (Mandatory, ISL) 
...
## 4.9.9.3 DUE_INT.5.1c (Mandatory, ISL) 
...
## 4.9.10.1 DUE_INT.6.1a (Mandatory, ISL) 
...
## 4.9.10.2 DUE_INT.6.1b (Mandatory, ISL) 
...
## 4.9.11.1 DUE_INT.7.1a (Mandatory, ISL) 
...
## 4.9.12.1 DUE_TPC.1.1a (Mandatory, ISL) 
...
## 4.9.13.1 DUE_TPC.2.1a (Mandatory, ISL) 
...
## 4.9.13.2 DUE_TPC.2.1b (Mandatory, ISL) 
...
## 4.10.1.1 INT_ALG.1.1a (Mandatory, ISL) 
...
## 4.10.2.1 INT_TPD.1.1a (Mandatory, ISL) 
...
## 4.10.2.2 INT_TPD.1.1b (Mandatory, ISL) 
...
## 4.10.2.3 INT_TPD.1.1c (Mandatory, ISL) 
...
## 4.10.3.1 INT_TPD.1.2a (Mandatory, ISL) 
...
## 4.10.3.2 INT_TPD.1.2b (Mandatory, ISL) 
...
## 4.10.3.3 INT_TPD.1.2c (Mandatory, ISL) 
...
## 4.10.4.1 INT_TPD.1.3a (Mandatory, ISL) 
...
## 4.10.4.2 INT_TPD.1.3b (Mandatory, ISL) 
...
## 4.10.4.3 INT_TPD.1.3c (Mandatory, ISL) 
...
## 4.10.5.1 INT_TPD.1.4a (Mandatory, ISL) 
...
## 4.10.5.2 INT_TPD.1.4b (Mandatory, ISL) 
...
## 4.10.5.3 INT_TPD.1.4c (Mandatory, ISL) 
...
## 4.10.7.1 INT_TPD.2.1a (Mandatory, ISL) 
...
## 4.10.8.1 INT_TPD.2.2a (Mandatory, ISL) 
...
## 4.10.8.2 INT_TPD.2.2b (Recommended, ISL) 

**Test property:** An active Bluetooth connection **SHOULD** be additionally displayed in the status bar. 
...
## 4.10.9.1 INT_TPD.2.3a (Mandatory, ISL) 
...
## 4.10.10.1 INT_TPD.2.4a (Mandatory, ISL) 
...
## 4.10.11.1 INT_TPD.2.5a (Mandatory, ISL) 
...
## 4.10.12.1 INT_TPD.2.6a (Mandatory, ISL) 
...
## 4.10.13.1 INT_TPD.2.7a (Mandatory, ISL) 
...
## 4.10.14.1 INT_TPD.2.8a (Mandatory, ISL) 
...
## 4.10.15.1 INT_TPD.2.9a (Mandatory, ISL) 
...
## 4.10.16.1 INT_TPD.2.10a (Mandatory, ISL) 
...
## 4.10.16.2 INT_TPD.2.10b (Recommended, ISL) 
...
## 4.10.17.1 INT_TPD.3.1a (Recommended, ISL) 
...
## 4.10.18.1 INT_TPD.3.2a (Mandatory, ISL) 
...
## 4.10.19.1 INT_TPD.3.3a (Mandatory, ISL) 

**Test property:** The NFC interface **SHALL** be implemented in accordance with ISO/IEC 14443 A or B [13]. 
...
## 4.10.20.1 INT_TPD.3.4a (Mandatory, ISL) 
...
## 4.10.21.1 INT_TPD.4.1a (Mandatory, ISL) 
...
## 4.10.22.1 INT_TPD.4.2a (Mandatory, ISL) 
...
## 4.10.23.1 INT_TPD.4.3a (Mandatory, ISL) 

**Test property:** The DUT **SHALL** support at least IEEE 802.11-2020 [14]. IEEE 802.1X [15] **SHALL** only be supported with EAP-TLS [16] (in compliance with TPC_TLS.1.2). 

## **Test methods: T.1, T.3** 

## 4.10.23.2 INT_TPD.4.3b (Mandatory, ISL) 
...
## 4.10.23.3 INT_TPD.4.3c (Mandatory, ISL) 
...
## 4.10.23.4 INT_TPD.4.3d (Mandatory, ISL) 
...
## 4.10.23.5 INT_TPD.4.3e (Mandatory, ISL) 
...
## 4.10.24.1 INT_TPD.4.4a (Mandatory, ISL) 
...
## 4.10.25.1 INT_GSM.1.1a (Mandatory, ISL) 
...
## 4.10.26.1 INT_GSM.1.2a (Mandatory, ISL) 
...
## 4.10.27.1 INT_GSM.1.3a (Mandatory, ISL) 
...
## 4.10.28.1 INT_KAB.1.1a (Mandatory, ISL) 
...
## 4.11.1.1 SEN_MIK.1.1a (Mandatory, ISL) 
...
## 4.11.2.1 SEN_MIK.1.2a (Mandatory, ISL) 
...
## 4.11.2.2 SEN_MIK.1.2b (Mandatory, ISL) 
...
## 4.11.3.1 SEN_KAM.1.1a (Mandatory, ISL) 
...
## 4.11.4.1 SEN_KAM.1.2a (Mandatory, ISL) 
...
## 4.11.4.2 SEN_KAM.1.2b (Mandatory, ISL) 
...
## 4.11.5.1 SEN_LOC.1.1a (Mandatory, ISL) 
...
## 4.11.6.1 SEN_LOC.1.2a (Mandatory, ISL) 
