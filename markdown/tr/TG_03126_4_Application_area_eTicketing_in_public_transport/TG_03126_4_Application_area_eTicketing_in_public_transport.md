...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0001-00.png)
...
|1|Description of the application area "trade logistics"|13|
|---|---|---|
|1.1|Introduction|13|
|1.2|Delineation of this Guideline|14|
...
|2.1.3|Analysis of selected logistics modules|16|
...
|2.2.2|EPC/RFID application for textiles and clothing|23|
|2.2.3|EPC/RFID use for durable electronic goods|24|
|2.3|Technological interaction – The GS1 System|24|
|2.3.1|Orientation of the GS1 system|24|
|2.3.2|The components of the GS1 system|26|
...
|4.1.1|Product-specific use of transponders at the POS|42|
|4.1.2|Preventing product counterfeiting|42|
|4.2|Economy|43|
|4.3|Security|43|
...
|8.2.1.1<br>Safety|8.2.1.1<br>Safety|74|
|---|---|---|
...
|8.3.2|Threats to the transponder|84|
...
|8.4.6|Examples of non-standardised safeguards for systems compliant with||
||EPCglobal|117|
|8.4.6.1<br>Examples of diversification and of safeguards for passwords||117|
|8.4.6.2<br>Example of how data is encrypted in the transponder's extended|||
||memory area|117|
...
|10.1.1|Determining the protection demand for the logistics infrastructure|123|
...
|10.1.2<br>Interfaces in the system as a whole|126|
|---|---|
...
|11.2.4.1<br>Residual risks arising from "unauthorised deactivation of the||
|transponder"|157|
...
|11.3.4.1<br>Residual risks arising from "unauthorised deactivation of the|||
||transponder"|165|
...
|||tests and approval procedures|92|
|Table|8–22|Protection of the system as a whole through preventing||
|||eavesdropping|92|
|Table|8–23|Protection of the system as a whole through assuring reliable||
|||transmission|93|
|Table|8–24|Protection of the system as a whole through definition of fallback||
|||solutions|93|
|Table|8–25|Protection of the system as a whole through securing the||
|||confidentiality of data|94|
|Table|8–26|Protection of the system as a whole through confidential storage of||
|||data|94|
|Table|8–27|Protection of the system as a whole through securing the data||
|||integrity when transmitting data|95|
|Table|8–28|Protection of the system as a whole through securing data integrity||
|||when storing data|95|
|Table|8–29|Protection of the system as a whole through securing the system’s||
|||functions against DoS attacks|96|
...
|---|---|---|---|
|||the system against incorrect operation|96|
|Table|8–31|Protection of the system as a whole through securing the function of||
|||the system to prevent technical failures|97|
|Table|8–32|Protection of the system as a whole through specification of the||
|||system and the components|97|
|Table|8–33|Protection of the system as a whole through ergonomic user||
|||instructions|98|
|Table|8–34|Protection of the system as a whole through support|98|
|Table|8–35|Protection of the system as a whole through EPC usage against||
|||product counterfeiting|99|
...
|Table|8–46|Protection by preventing the assignment of movement profile to||
|||people|105|
...
|Table|8–57|Protection through securing the authenticity and integrity when||
|||loading keys|115|
...
|Table|8–60|Protection of personal data by separation of personal data and||
|||logistical data|117|
...
|Table|11–1|Protection demand in the "Fast-moving consumer goods" application||
|||scenario|146|
|Table|11–2|Threats relevant to the "Fast-moving consumer goods" application||
|||scenario|148|
|Table|11–3|Use cases relevant to the "Fast-moving consumer goods" application||
|||scenario|149|
|Table|11–4|Safeguards for the "Fast-moving consumer goods" application||
|||scenario|150|
...
|Table|11–7|<br>Use cases relevant to the "consumer electronics" application scenario|155|
...
|Table|11–15|Remaining risks by tracking for the “brand-name clothing” application||
|||scenario|167|
...
|Figure|2–4|Changes and effects in the “receipt of goods” and “warehousing”||
|||logistics modules in comparison with process variation 1|18|
|Figure|2–5|Changes and effects in the “preparation of shipment” logistical||
|||module in comparison with process variation 1|19|
|Figure|2–6|Changes and effects in the “goods despatch” logistical module in||
|||comparison with process variation 1|20|
|Figure|2–7|Usage scenarios at the POS (source: GS1 Germany)|22|
|Figure|2–8|The GS1 identification system: an overview|27|
|Figure|2–9|Three examples of how the EAN is employed in different||
|||technological settings|27|
...
|Figure|2–14|The GS1 standard portfolio for electronic data interchange –||
|||mediators between data processing systems|32|
|Figure|2–15|Smooth business processes using EANCOM®|32|
|Figure|2–16|Paradigm-change from outside- to self-management of logistical||
|||processes|33|
...
|Figure|5–2|Example of application scenarios and relevant use cases for||
|||eTicketing in public transport|46|
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0013-05.png)


**Figure 1–1 Forecast of the use of data carrier technology [GS1-1]3** 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0014-05.png)
...
## **2.1 The logistics process chain up to the retail outlet[4]** 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-10.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-11.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-12.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-13.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-14.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-15.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-16.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-17.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-18.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-19.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-20.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-21.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-22.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-23.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-24.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-25.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-26.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-27.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-28.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-29.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-30.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-31.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-32.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-33.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-34.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-35.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-36.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0015-37.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0016-07.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0016-08.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0016-09.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0016-10.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0016-11.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0016-12.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0017-09.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0018-18.png)


**Figure 2–4** 

**Changes and effects in the “receipt of goods” and “warehousing” logistics modules in comparison with process variation 1** 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0019-04.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0020-02.png)


**----- Start of picture text -----**<br>
ChangesVeränderungen AusprägungVersion<br>and efund Effekteects Process eProzessvariante 2sion 2 Prozessvariante 4c  version<br>getaggteTagged tertiary packagingTertiärverpackungen Tagged getaggte  Tertiär-rtiary andund<br>secondary packagingSekundärverpackungen<br>Logistics moduleLogistikmodul<br>Goods deWarenausgangp tch<br>- Zeitliche Vorteile Zeitliche Vorteile  - As wel  as identifying the logistical unitZusätz l ich zur Identifikation der<br>( Erfassung irecording o n  Bewegung)the move) all of the secondary packageslogistischen Einheit ist die Erfassung<br>- No visual ckein Sichtk onta kc t  notwendigrequired can be identified as well<br>= no significant process changes = keine signifikanten Prozessveränderungen<br>= signifi kc ant e Prozessauswirkungen process changes<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-01.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-02.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-03.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-04.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-05.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-06.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-07.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-08.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-09.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-10.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-11.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-12.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-13.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-14.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-15.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-16.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-17.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-18.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-19.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-20.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-21.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-22.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-23.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-24.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-25.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-26.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-27.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-28.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-29.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-30.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-31.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-32.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-33.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-34.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-35.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-36.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-37.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-38.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-39.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-40.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-41.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-42.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-43.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-44.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-45.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-46.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-47.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-48.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-49.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-50.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-51.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-52.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-53.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-54.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-55.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-56.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-57.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-58.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-59.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-60.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-61.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-62.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-63.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0022-64.png)
...
- In the sales area 
   ...
   - The speed benefits of RFID when registering and handling goods mean that the goods can reach retail outlets more quickly, thereby increasing their freshness and availability. Trust in the quality of goods also plays a very important role. Information terminals coupled with the EPCglobal Network can provide consumers with full documentation of a product’s origins. In the case of temperature-controlled logistics, the combination of 
...
- 4 Non-Significance Globally unique EAN identification can only be guaranteed if the standard numbers are handled as a whole. For example, product characteristics or features should not be en- 
...
coded in the number itself, but rather the EAN number should be used as an access key to obtain that information from a file or another data source. 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0027-01.png)


**----- Start of picture text -----**<br>
Coding scheme for<br>ILN: GS1 basic number [*)] Location reference<br>EAN: GS1 basic number [*)] Item reference Serial number [**)]<br>NVE: GS1 basic number [*)] Serial number<br>GRAI: GS1 basic number [*)] Packaging type Serial number [***)]<br>GIAI: GS1 basic number [*)] Serial number<br>*) Counterpart in EPC is the EPC manager<br>**) Serialised directly in the EPC form<br>***) Optional<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0027-08.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0027-09.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0027-10.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0027-11.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0027-12.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0027-13.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0027-14.png)
...
Standardized EPC-Transponder data 


![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0028-03.png)


**----- Start of picture text -----**<br>
Header Filter value GS1 Coding scheme<br>EPC or EPC Identification<br>e.g. SGTIN, SGLN, SSCC<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0028-09.png)


**Figure 2–11 GS1 key identification provides access to additional information** 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0030-07.png)


**Figure 2–12 Storage areas in a second generation EPC transponder** 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-08.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-09.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-10.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-11.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-12.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-13.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-14.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-15.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-16.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-17.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-18.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-19.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-20.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-21.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0031-22.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0032-02.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0032-03.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0032-04.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0032-05.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0032-06.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0032-07.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0032-08.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0032-09.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0032-10.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0032-13.png)


**----- Start of picture text -----**<br>
3. Transportorder Transport<br>(IFTMIN)<br>6. Arrival report<br>5. Transportstatus (FTMAN)<br>(OFTSTA)<br>Industr yie 1. Price list / catalogue (PRICAT)1. Preisliste/ Katalog (PRICAT) RetailHandel<br>2. Order (ORDERS)2. Bestellung (ORDERS)<br>4. Despatch advice (DESADV)4. Lieferavis (DESADV)<br>7. Goods received (RECADV)7. Wareneingang (RECADV)<br>8. Invoice (INVOIC)8. Rechnung (INVOIC)<br>Bank<br>10.  Credit note 9. Payment order<br>(CREMUL) (PAYMUL)<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0033-02.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0033-03.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0033-04.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0033-05.png)
...
- It provides clear information all along the entire value-added chain. Without the Network, information transparency is only partially achieved between “neighbour- 

- ing” interfaces. 

- It provides standardised interfaces at _all_ data transition points, which means from the transponder to the reader, from the reader to the middleware, from the middleware to the internal application, and from the internal application to the cross-company application. 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0034-01.png)


**----- Start of picture text -----**<br>
EPCglobal core serviceEPCglobal Kerndien s te<br>(including object (u. a. Objekt name  servicenservice,<br>EPCIS discovery)EPCIS- Ermittlung)<br>Interfaces = EPCglobal standardsSchnittstellen = EPCglobal- Standard s<br>Company UnternehmenCompany<br>EPCISEPCIS<br>EPCISEPCIS data requestDatenabfrage EPCISEPCIS<br>Data exchangeDatenaustausch<br>EANCOM, GS1 XML, WebEDIEANCOM, GS1 XML, WebEDI<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0035-01.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0039-01.png)


**----- Start of picture text -----**<br>
Employee<br>Logistics<br>Logistics<br>service provide<br>service provider<br>**----- End of picture text -----**<br>



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0039-02.png)
...
This document will deal with the requirements of security separately, from section 8 onwards. 
...
It is not only security aspects that are relevant to the definition of measures and to proposed systems. All of the requirements described in section 4 must be taken into account. 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0045-01.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0046-04.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0046-07.png)
...
|Definition of application scenarios|Definition of examples for application sce-<br>narios. These examples coverthe entire|
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0049-01.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0049-04.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0050-03.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0051-01.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0051-02.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0051-03.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0051-04.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0051-05.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0051-06.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0052-01.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0052-02.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0052-03.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0052-04.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0052-07.png)


**----- Start of picture text -----**<br>
P3.1 P3.2 P3.3<br>Attach to product Attach to packaging Attach to goods  Actors<br>carrier<br>Attach transponder to  Attach label with transponder and EPC Issuer<br>object<br>End<br>Figure 6–4  Process P3, "Attaching the transponder to an object"<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0053-02.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0054-01.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0054-02.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0054-03.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0054-04.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0054-05.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0054-06.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0054-07.png)
...
The process of preparing shipment takes place after the logistical process of receiving goods and before that of despatching goods. Figure 6–7 defines shipment preparation as part of the goods despatch process. 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0055-01.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0055-02.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0055-03.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0055-04.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0055-05.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0056-01.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0056-02.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0056-03.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0056-04.png)
...
In terms of its process, cross-docking involves the same stages as the shipment preparation process described in Figure 6–7. We differentiate between single and dual (multiple) stage cross-docking. 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0057-06.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0057-07.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0058-02.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0058-03.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0059-01.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0059-02.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0059-03.png)


**Figure 6–11 Processes P10.1 "Guarantee" and P10.2 "Maintenance"** 

An example of the maintenance and guarantee business process is depicted in Figure 6–11. Following the payment procedure, the transponder is programmed with guarantee and maintenance information. This enables to consumer to return the goods at a later date and claim guarantee or maintenance services. If a guarantee claim is made, then the information in the transponder has to be changed accordingly. This, of course, is only possible if the transponder was not deactivated after payment. 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0060-02.png)
...
An example of this business process is depicted in Figure 6–12. Firstly the EPC in the transponder is read and the product’s authenticity verified. The returns information is then retrieved either from the EPC database or from the transponder’s data memory. The returns process can then be initiated, and a bonus paid where applicable. 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0061-07.png)


**----- Start of picture text -----**<br>
Manufacturer's<br>Criteria Process Chip Key management Inlet manufacturer<br>background systems<br>Archive wafer<br>Manufacture wafer and batch<br>number<br>Generate UID Numerical range<br>of manufacturer<br>Electrical testing of chip Test program<br>Archive test<br>Chip test successful? results for each<br>Criterion: chip<br>Test program completed successfully? Y ? NO Defective chip marked, end of process<br>E<br>S<br>Chip installed<br>Load UID onto chip Chip-specific UID saved<br>Optional: provide key data Generic keys<br>Optional: load key data Key set<br>UID, list of faulty<br>parts, batch<br>Send chip information to transponder  numbers, etc.<br>manufacturer:<br>· UID of functional chips<br>· Key data (optional)  Customer-specific<br>· List of faulty chips keys (optional)<br>Chip<br>Deliver chip<br>products<br>END<br>**----- End of picture text -----**<br>
...
It can also include the transponder manufacturer individualising the transponder and setting the kill command. The transponder manufacturer then acts as the issuer, or on behalf of the issuer. This case is described in sections 7.4 and 7.5. 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0062-09.png)


**----- Start of picture text -----**<br>
Criteria Process Inlet Background systems / system as a whole Key management manufacturerTransponder<br>Select inlet type<br>Receive chips and data from chip  Type, UID, list of<br>supplier  faulty chip parts<br>Key<br>Sort out and destroy faulty chips List of faulty chips<br>Manufacture inlet Antenna type,<br>material, etc.<br>Generate<br>Options:· Load temporary test EPC  temporary EPC<br>· Customer-specific keys Generate new<br>customer-<br>specific keys<br>Test Test program<br>Archive test<br>Inlet test successful? results for each<br>Criterion: inlet<br>Test program completed successfully? Y ? NO Defective inlet marked, end of process<br>E UID, test EPC, list<br>S of faulty parts,<br>Send inlet information to transponder  batch numbers,<br>manufacturer: etc.<br>· UID of functional inlets<br>· Temporary EPC (optional)  Customer-specific<br>· Key data (optional)  keys (optional)<br>· List of faulty inlays<br>Deliver inlet Inlets<br>END<br>Figure 7–2  Use Case "Manufacturing the inlay"<br>**----- End of picture text -----**<br>


Manufacturing the inlay begins by choosing the type of inlay suited to the application. Different applications (such as a packaging box or clothing label) require different antenna configu- 
...
rations in order to achieve the best possible reading rates. The basis material for an inlay is usually a plastic (e.g. PET) onto which the antenna is applied either by etching a copper layer, printing with silver ink, or stamping (aluminium or copper). This basis material is usually supplied in roles. When the inlay is being manufactured, the chip is applied to the antenna contacts. Alternatively, the chip can be supplied on a carrier substrate together with copper contacts (strap format). The strap with the contacts is then stuck to the antenna in a roll-to-roll process, or mechanically connected (crimping). Once assembled, the inlay is tested, during which an RFID reader is used to verify the transponder’s response. Dysfunctional inlays are marked so that they can be separated out in subsequent steps. During this stage of processing, the transponders are usually loaded with a temporary test EPC in order to enable testing. The finished inlays are supplied to the transponder manufacturer in roll form. Because of the different process conditions, inlay production (requires clean-room conditions) and transponder production are usually done in different production facilities. 

## **7.2.2 Manufacturing the transponder** 


![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0063-03.png)


**----- Start of picture text -----**<br>
Use case "Manufacture and delivery of the transponder"<br>Criteria Process Transponder Background systems /  Key management Issuer<br>system as a whole<br>Select transponder type<br>Receive inlets and data from inlet  Type, UID, list of<br>supplier  faulty parts<br>Key<br>Sort out and destroy faulty inlets List of faulty parts<br>Manufacture transponders  Material, size, version, etc.<br>Generate<br>Options: temporary EPC Generate new<br>Load temporary test EPC  customer-<br>Customer-specific keys Transponder  specific keys<br>initialised<br>Test Test program<br>Archive test<br>Transponder test successful? results for each<br>Criterion: transponder<br>Test program completed successfully? Y ? NO Defective transponder marked or sorted out, end of process<br>E<br>S  Transponder<br>tested<br>UID, test EPC, list<br>Send inlet information to transponder  of faulty parts,<br>manufacturer: batch numbers,<br>UID of functional transponders etc.<br>Temporary EPC (optional)<br>Key data (optional)  Customer-specific<br>List of faulty transponders keys (optional)<br>Deliver transponders Transponder<br>END<br>**----- End of picture text -----**<br>
...
The “load EPC” use case describes the individualisation of the transponder using a unique EPC. Individualising can be performed by various entities in the system. The variation used by the transponder manufacturer is described in section 7.2.2. Normally speaking, a transponder is individualised when it is attached to the product or a package. The issuer is responsible for doing this. However, it may be that a transponder manufacturer or packing manufacturer acts on behalf of the issuer. 

Figure 7–4 shows the use case of loading an EPC into a transponder. Loading an EPC is obligatory under EPCglobal regulations. 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0065-01.png)


**----- Start of picture text -----**<br>
Use case "Individualising a transponder by loading an EPC"<br>Criteria Process Transponder Internal background  Key management Logistics background<br>systems system<br>Receive products and product data from  Type, UID list, list<br>transponder supplier  of faulty parts<br>Sort out and destroy faulty transponders List of faulty parts<br>Issuer's EPC<br>Generate unique EPC<br>Manager<br>Read UID (optional) UID<br>Load EPC<br>EPC set and  EPC, UID of<br>Set write-protection on EPC protected transponder<br>Test Test program<br>Archive test<br>Transponder test successful? results for each<br>Criterion: transponder<br>Test program completed successfully? Y ? NO Defective transponder marked or sorted out, end of process<br>E<br>S  Transponder<br>tested<br>Send transponder information to issuer: List of UIDs, EPC,<br>EPC, UID (optional) of functional  list of faulty parts,<br>transponders  batch numbers,<br>List of faulty transponders etc.<br>Deliver transponders<br>END<br>**----- End of picture text -----**<br>


**Figure 7–4 Use Case "Individualising the transponder"** 

In the following, optional steps, the kill password is set (see section 7.5), and any other data required is written to the programmable memory area of the transponder. 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0066-02.png)


**----- Start of picture text -----**<br>
Use case "Setting the kill password"<br>Criteria Process Transponder Internal background  Key management Logistics background<br>systems system<br>Receive products loaded with EPCs,  Type, UID list, list<br>and product data  of faulty parts<br>Sort out and destroy faulty transponders List of faulty parts<br>Retrieve EPC and UID (UID optional) EPC, UID<br>Generate kill password in key<br>Kill passwords<br>management system<br>Set kill password in transponder Kill password<br>Kill password set<br>Kill password<br>Set "permanent lock" protection for kill  protected against<br>password retrieval and<br>overwriting<br>Test Test program<br>Criteria: Archive test<br>Transponder test successful? results for each<br>Kill password  transponder<br>stored correctly?<br>Access only possible with  ? NO Defective transponders marked or<br>access password?  Y sorted out, end of process<br>Passwords cannot  E<br>be overwritten? S  Transponder<br>tested<br>Send transponder information to issuer: List of UIDs, EPC,<br>EPC, UID (optional) of functional<br>list of faulty parts,<br>transponders  batch numbers,<br>List of faulty transponders  etc.<br>Passwords via key management<br>Deliver transponders<br>END<br>**----- End of picture text -----**<br>
...
The use cases covering the generation, storage and transmission of passwords and keys are described in section 7.10. 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0068-01.png)


**----- Start of picture text -----**<br>
Use case "Reading the EPC stored in transponder"<br>Criteria Process Transponder RFID reading system Key management Logistics background<br>system<br>RFID reading system sends inventory<br>command Inventory command<br>Transponder sends random handle  Random handle<br>(secures communication)<br>Request other UID<br>Anti-collision using UID for the  parts<br>identification of an individual  Parts of UID<br>transponder<br>Select identified transponder for data  Select a<br>retrieval transponder<br>RFID reader system queries EPC EPC?<br>Transponder sends EPC EPC<br>Save the retrieved EPC in the<br>Save EPC<br>background system<br>Check retrieved EPC List of valid EPCs<br>EPC valid?<br>Criteria: Y ? NO Invalid transponder marked, end of process<br>E<br>Access to  S<br>additional data   Transponder valid<br>memory only<br>possible with<br>access password Send access password Access password<br>Check access password<br>Y ? NO Invalid access password, end of process<br>E<br>S<br>RFID reader system queries data  Data memory<br>memory content?<br>Data memory<br>Transponder sends data memory content<br>Data memory content processed further  Content of data<br>in the background system memory<br>END<br>**----- End of picture text -----**<br>


**Figure 7–6 Use case "Reading the EPC data stored in transponder"** 

Figure 7–6 shows an example of how the information stored in the transponder is read. All communication, such as reading the EPC, is performed in compliance with the EPCglobal Class 1 Generation 2 specification. 
...
The transponder is normally deactivated in a special place (such as the point of sale) at the request of the consumer, once payment has been made. Deactivation is done using a reader as shown in Figure 7–7. 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0069-04.png)


**----- Start of picture text -----**<br>
Use case "Activating the kill command"<br>Criteria Process Transponder Internal background  Key management Logistics background<br>systems system<br>Bring transponder or product into the<br>reader's range for deactivation<br>Select transponder<br>Retrieve EPC and UID (UID optional) EPC, UID<br>Specific<br>Request specific kill password  parameters (e.g.<br>EPC, UID)<br>Read specific kill password<br>Kill password<br>Send kill password, trigger kill command Chip deactivated<br>Test Test program<br>Archive test<br>Deactivation successful? results for each<br>Criteria: transponder<br>No response from  NO<br>deactivated  ? Repeat deactivation<br>transponder? Y<br>E<br>S<br> Deactivation<br>confirmed<br>UID, EPC of<br>Transmit EPC, UID (optional) of  deactivated<br>deactivated transponders<br>transponders<br>END<br>**----- End of picture text -----**<br>
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0070-02.png)


**----- Start of picture text -----**<br>
Use case "Example of authenticity check using EPC transponder"<br>Criteria Process Transponder Internal background  Key management Logistics background<br>systems system<br>Bring transponder or product into the<br>reader's range for deactivation<br>Select transponder<br>Retrieve EPC and UID (UID optional) EPC, UID<br>Logistical data for<br>read EPC<br>Request logistical data for EPC<br>Logistical data for<br>read EPC<br>Evaluate logistical data Evaluation criteria<br>Criteria:<br>EPC known in  NO<br>background system  Y ? Counterfeit. End of process.<br>for issuer and product  E<br>type S<br>Archive test<br>Plausibility check of logistical data results for each<br>Criteria: transponder<br>Logistical data  NO<br>complete and  ? Repeat process using UID<br>clear? Y<br>E<br>S<br> Authenticity<br>confirmed<br>UID, EPC of<br>Transmit EPC, UID (optional) of  checked<br>checked transponders<br>transponders<br>END<br>**----- End of picture text -----**<br>
...
Figure 7–9 shows an example of a use case for the key management used in individualising transponders. 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0071-01.png)
...
Within the areas of use relating to trade logistics, certain _higher level_ security targets specific to the application area can be recognised, based on the generic security targets mentioned earlier: 
...
The lower level security targets listed in section 0 can be derived from the assessments of the entities’ security targets contained in the following sections. 
...
|||R := retailer|I := information secu-<br>rity||
|||I := issuer|P := privacy||
...
**Table 8–9 Issuer specific security targets for information security** 
...
|Security objective|Security objective|Consumer<br>objective|Retailer ob-<br>jective|Issuer ob-<br>jective|
|---|---|---|---|---|
...
Three protection demand categories are formed on the basis of the security targets described in section 0. Category 1 represents the lowest protection demand, category 3 the highest. 
...
|Security objective|Security objective|Protection<br>demand<br>category|Criteria for allocating to protection demand cate-<br>gories|
|---|---|---|---|
...
|field number|1|2|3|
|---|---|---|---|
|Content|T|C := contact-less interface according<br>ISO/IEC18000-6C|1, ... , n|
...
|||S := Background systems<br>1<br>IT systems of the trade logistic which<br>ensure the flow of logistic data be-<br>tween all entities according to the re-<br>quirements of the specific application.<br>To this belongs implementation of<br>functionality according EPCIS, man-<br>agement of terminals and locations,<br>functions to correct read errors and<br>supply of information to detect product<br>counterfeits.<br>2<br>IT systems of the retailer, which does<br>not process and store personal data.||
|||V := Customer data systems of the retailer<br>The customer data systems of the retailer<br>are the only components in the system,<br>which process and store in some cases<br>personal data. Therefore special threats<br>appear which shall be compensated by<br>special countermeasures.<br>In the special implementation these are<br>e.g. CRM systems (e.g. with loyalty cards),<br>systems for controlling and delivery of in-<br>voices, check of creditworthiness, etc.||
...
|TT13|Incorrectly gen-<br>erated UID|SI3, SI4|A wrongly allocated UID can threaten the in-<br>tegrity of the logistical data, and in particular<br>threatenany protectionagainst transponder|
...
|1|Interface test<br>•<br>Apply existing test regulations for contactless interfaces as defined by<br>ISO/IEC18000-6C.<br>•<br>Draw up and apply specific test regulations for the application-specific func-<br>tions of the interfaces between transponders and readers.<br>•<br>Draw up and apply specific test regulations for the protocols and applica-<br>tion-specific functions of the interfaces between the rest of the system com-<br>ponents.||
|2|Component approval<br>See above, additional component approval (transponders, readers, key man-<br>agement).||
...
|---|---|---|
|MS1|Introduction of interface tests and approval<br>procedures|TS5, TC1, TV3|
|3|Certification<br>See above, additional certification by an independent institute, for transponders,<br>readers and, where necessary, other components.||



## **Table 8–21 Protection of the system as a whole through introduction of interface tests and approval procedures** 
...
|General|This safeguard applies to every implementation of a contactless interface that<br>exists between the transponder and the readers, such as the ones installed in<br>warehouses, checkout terminals and kill terminals. The current EPCglobal<br>specifications do not provide a means of preventing eavesdropping by means of<br>cryptographic safeguards, since these mechanisms have not yet been specified<br>for transponders in the field of trade logistics. For this reason the safeguards<br>must be infrastructural, personnel-related or organisational, such as:<br>•<br>forbidding the use of RFID readers on the business premises in the opera-<br>tor's terms and conditions of business;<br>•<br>checking business premises for readers installed without permission;<br>•<br>fitting suitable shielding around the reader–transponder communication<br>area, where this is structurally possible (both architecturally and from a<br>functional point of view).||
|1|Data is sent unencrypted between the terminal and EPCglobal transponder.<br>Infrastructural, personnel-related and organisational measures prevent the op-<br>eration of enemy systems within a range of five metres of the reader.||
|2|Data is sent unencrypted between the terminal and EPCglobal transponder.<br>Infrastructural, personnel-related and organisational measures prevent the op-<br>eration of enemy systems within a range of twenty metres of the reader.||
|3|Data is sent unencrypted between the terminal and EPCglobal transponder.<br>Infrastructural, personnel-related and organisational measures prevent the op-<br>eration of enemy systems within a range of fifty metres of the reader.||
...
||Code and name of safeguard|Threats addressed|
|---|---|---|
|MS3|Assuring reliable transmission between termi-<br>nal and transponder|TC2, TC3, TC4|
|1|Long-term testing and organisational safeguards<br>•<br>Perform a reality-based, long-term test before assuming working operation.<br>•<br>The location is regularly checked for readers and jammers installed without||
...
|---|---|---|
|MS3|Assuring reliable transmission between termi-<br>nal and transponder|TC2, TC3, TC4|
||permission.<br>•<br>Employees and visitors are not permitted to carry devices that could be<br>used for DoS attacks. Customers are not permitted to use devices that<br>could be used for DoS attacks.||
|2|Surveying<br>In addition to the safeguards from MS3.1, the location is surveyed with an eye to<br>jamming, before operation is assumed.||
|3|||
|3+|Use of field detectors<br>In addition to the safeguards from MS3.2, field detectors are used to detect<br>temporary jamming devices and DoS attacks.||



## **Table 8–23 Protection of the system as a whole through assuring reliable transmission** 
...
|1|Definition of suitable operating processes, offline capability and backup<br>•<br>System components must in principle (at least temporarily) be able to func-<br>tion autonomously without a backend system or if system interfaces fail.<br>•<br>Data must be backed up regularly in order to exclude the possibility of a to-<br>tal loss.<br>•<br>The replacement of defective components must be regulated.<br>•<br>All components and interfaces must have fallback processes that employ<br>operative safeguards to rectify or moderate the operative problems that can<br>arise following the failure of a component.<br>•<br>Fallback solutions must be specified in the contractual arrangements be-<br>tween customers, service operators and suppliers, and their consequences<br>taken into account.||
|2|||
...
**Table 8–24 Protection of the system as a whole through definition of fallback solutions** 
...
## **Table 8–25 Protection of the system as a whole through securing the confidentiality of data** 

||Code and name of safeguard|Threats addressed|
|---|---|---|
|MS6|Confidential storage of data|TS2, TS3, TS6, TS7, TS8,<br>TV4, TV7, TV8, TV9|
|1|Introduction of multi-tenant access protection:<br>•<br>Only a certain, legitimised group of people can access stored data (per-<br>sonal data, sales data, usage data, invoicing data, blacklists, approval lists,<br>etc.).<br>•<br>Data is stored in an environment protected against unauthorised access. If<br>access protection cannot be guaranteed, then the data should be stored on<br>an encrypted data carrier (hard drive encryption tools are used).<br>Alternatively, other equally effective encryption mechanisms can be used. The<br>algorithm strength must be at least that of the 3DES algorithm.<br>The type and strength of the mechanism should be adapted to future develop-<br>ments in accordance with[ALGK_BSI].||
|2|||
|3|Introduction of multi-tenant access protection with a defined role model.<br>See 1–2, furthermore:<br>•<br>A client concept in the form of a role model is to be established.||
...
## **Table 8–27 Protection of the system as a whole through securing the data integrity when transmitting data** 

|MS8|Code and name of safeguard|Threats addressed|
|---|---|---|
||Securing data integrity when storing data|TS3, TS7, TV7, TV9|
|1|Data is stored in a secure environment with access protection as defined in<br>MS6.<br>Checksums:<br>•<br>A checksum is used to protect against technically related integrity failures<br>(CRC, hamming codes, ...); this can also be provided by the operating sys-<br>tem involved.||
|2|||
|3|||
...
|2|Extended structural, technical and organisational safeguards:<br>•<br>Additional organisational safeguards, such as the introduction of a role<br>model withanaccompanying entitlement concept. More thorough mechani-||
...
||Securing the system’s functions against DoS<br>attacks at the interfaces|TS4, TV2|
||cal protection.||
|3|Security concept<br>See 1, furthermore:<br>•<br>Implement structural and technical safeguards in accordance with a security<br>concept.<br>Technical safeguards: technical safeguarding of access control.||



|**Table 8–29**<br>**Protection of the system as a whole through securing the system’s**<br>**functions against DoS attacks**|**Table 8–29**<br>**Protection of the system as a whole through securing the system’s**<br>**functions against DoS attacks**|**Table 8–29**<br>**Protection of the system as a whole through securing the system’s**<br>**functions against DoS attacks**|
|---|---|---|
...
|1|Tests, personnel and user instructions:<br>•<br>Define the requirements for user instructions; check the components using<br>these requirements; empirical tests; employ knowledgeable staff.||
|2|||
|3|||



|**Table 8–30**<br>**Protection of the system as a whole through securing the function of**<br>**the system against incorrect operation**|**Table 8–30**<br>**Protection of the system as a whole through securing the function of**<br>**the system against incorrect operation**|**Table 8–30**<br>**Protection of the system as a whole through securing the function of**<br>**the system against incorrect operation**|
|---|---|---|
|MS11|Code and name of safeguard|Threats addressed|
||Secure the function of the system to prevent<br>the technical failure of components and<br>transmission routes|TS4, TS5, TV2, TV3|
...
|3|Evaluation of components:<br>See 2, furthermore:<br>•<br>The relevant system components (at least the readers and carrier media)<br>are tested by independent testing laboratories.<br>•<br>An independent institute certifies the relevant system components.<br>•<br>An approval process is established for the system components.||
...
||Code and name of safeguard|Threats addressed|
|---|---|---|
|MS12|Specifications for system concept and re-<br>quirements for components|TS5, TV3|
...
**Table 8–33 Protection of the system as a whole through ergonomic user instructions** 
...
**Protection of the system as a whole through support** 
...
||Code and name of safeguard|Threats addressed|
|---|---|---|
|MS15|Using the EPC to secure against counterfeit<br>products|TS9|
|General|In the EPCglobal model, preventing product counterfeiting is one of RFID's fun-<br>damental use cases. The unique EPC can be used to this end. It should be<br>noted that the EPC can be applied freely to any commercially available trans-<br>ponder by any user – and that also means any attacker. See also [CFP_GS1].<br>Additional safeguards must be added in order to assure security against coun-<br>terfeiting when the protection demand is higher.||
|1|Using the chip's EPC<br>The authenticity of any transponder can be checked using its unique EPC. This<br>requires the following preconditions:<br>•<br>The EPC must be generated in accordance with the EPCglobal regulations<br>for every product that needs protecting.<br>•<br>The EPC is not generated consecutively, but instead randomly from a large<br>numerical range. This prevents counterfeiters from guessing valid EPCs.<br>•<br>The product's logistical data is made available by the backend system at<br>every stage in the supply chain.<br>The authenticity of the product is checked by checking the authenticity of the<br>EPC.<br>•<br>Check whether the product's EPC exists in the logistical data.<br>•<br>Check whether the EPC exists in a meaningful way in all the major stages<br>of the supply chain.<br>If both conditions are fulfilled, then the EPC is considered authentic.||
|2|||
|3|Additional use of UID:<br>The following safeguards should be applied in addition to those of MS15.1, 2:<br>•<br>Check the authenticity of the UID in the same way that the EPC is checked<br>in MS15.1, 2.<br>•<br>The UID is generated and implemented as described in MT2.||
...
||Code and name of safeguard|Threats addressed|
|---|---|---|
|MT1|Hardware and software access protection for<br>the EPC (write access)|TT2, TT3|
|1|Write protection for EPC<br>•<br>Once written to the specified memory area, the EPC is protected irreversibly<br>against overwriting. There is no read-protection.||
|2|||
|3|||
...
|1|Use of the chip's UID to prevent cloning of transponders<br>A unique UID belonging to the chip is used to prevent the transponder from be-<br>ing cloned. The EPC is not sufficient for this purpose, since it can be applied<br>freely to any commercially available transponder by any user – and that also<br>means any attacker.<br>•<br>The chip manufacturer generates the UID in accordance with [ISO18000-6].<br>•<br>The UID is loaded by the chip manufacturer during the wafer test. This is<br>done in a secure, certified environment in accordance with Common Crite-<br>ria.<br>•<br>Once written to the specified memory area, the UID is protected irreversibly<br>against overwriting.<br>•<br>Introduce a zero-balance procedure when manufacturing and delivering the<br>chip.<br>•<br>Rejects are destroyed or marked.<br>•<br>The valid UID of the original transponder must be available in addition to the<br>EPC in order to allow cloned transponders to be found.||
|2|Protection against cloning of transponder:<br>The following safeguards should be applied in addition to those of MT2.1:<br>•<br>Introduce a zero-balance procedure when manufacturing and delivering the<br>transponder.<br>•<br>Rejects are destroyed<br>•<br>The list of UIDs of non-rejects is delivered to the issuer together with<br>the delivery of chips.<br>•<br>Use simple visual security features on the transponder.||
|3|Advanced protection against cloning of transponder:<br>The following safeguards should be applied in addition to those of MT2.2:<br>•<br>Use simple visual security features on the transponder (e.g. holograms).||
...
|General|<br>The functions of a transponder and an entitlement can theoretically be emulated<br>by programmable devices (e.g. PDAs) that use contactless interfaces.<br>Emulation requires that the full function of the transponder, including the UID,<br>can be copied.<br>It is impossible to emulate a simple memory chip using programmable contact-<br>less chips, since chips whose UIDs can be programmed after manufacture are<br>not currently available on the market.<br>EPCglobal specifications do not yet include cryptographic emulation protection<br>for transponders. Non-standard safeguards could be applied to a limited extent.||
|1|Simple emulation protection using UID<br>•<br>Implementation of safeguards from MT2.1||
|2|||
|3|Advanced emulation protection<br>•<br>Use the access-protected, optional memory area in available EPC trans-<br>ponders to implement simple cryptographic safeguards (encryption using<br>derived keys based on the UID, application of electronic signatures, etc.).||



|**Table 8–38**<br>**Protection of the transponder against emulation**|**Table 8–38**<br>**Protection of the transponder against emulation**|**Table 8–38**<br>**Protection of the transponder against emulation**|
|---|---|---|
...
||Code and name of safeguard|Threats addressed|
|---|---|---|
|MT5|Protection against unauthorised attachment of<br>a transponder|TT6|
|General|<br>The unauthorised attachment of a transponder in conjunction with the removal<br>or deactivation of the original transponder can represent a threat.||
...
|**Table 8–40**<br>**Protection of the transponder against unauthorised attachment**|**Table 8–40**<br>**Protection of the transponder against unauthorised attachment**|**Table 8–40**<br>**Protection of the transponder against unauthorised attachment**|
|---|---|---|
||Code and name of safeguard|Threats addressed|
|MT6|Protection against the unauthorised deactiva-<br>tion of a transponder|TT7|
|General|<br>According to the latest specifications, EPC chips are protected against the unau-<br>thorised activation of the kill command by 32-bit passwords. These passwords<br>are transmitted in unprotected form between terminal and transponder. Ad-<br>vanced safeguards are only possible using proprietary solutions. For this rea-<br>son, EPCglobal reference implementation for all protection demand categories<br>can only currently be done using the safeguard below.||
|1|Password protection for the kill command:<br>•<br>Implementing password protection in accordance with EPCglobal.<br>•<br>Diversification of the kill password.<br>•<br>Apply key management safeguards MK1, MK3, MK4, MK5, MK6, MK7,<br>MK8, MK9 in the appropriate protection demand categories.<br>•<br>Infrastructural, personnel-related and organisational safeguards such as:<br>•<br>forbidding the use of RFID readers on the business premises in the op-<br>erator's terms and conditions of business;<br>•<br>checking business premises for readers installed without permission.||
|2|||
|3|||



**Protection of the transponder against unauthorised deactivation** 
...
||Code and name of safeguard|Threats addressed|
|---|---|---|
|MT7|Protection against DoS attacks on the trans-<br>ponder|TT8, TT11|
|General|<br>DoS attacks can take various forms:<br>•<br>Mechanical destruction of the antenna or chip.<br>•<br>Electrical destruction by means of strong RF fields.<br>•<br>Disruption of communication between transponder and reader.<br>•<br>Disruption of backend systems, key management, etc.||
...
|**Table 8–42**<br>**Protection of the transponder against DoS attacks**|||
|MT8|Code and name of safeguard|Threats addressed|
||Specifications defining transponder character-<br>istics|TT8, TT9|
|General|The characteristics of the transponder in relation to the application scenarios<br>and operating processes that are to be supported must be specified and guaran-<br>teed. This applies in particular to:<br>•<br>Performance<br>•<br>Durability under mechanical wear<br>•<br>Protection against DoS attacks||
|1|Manufacturer’s declaration<br>The manufacturer guarantees that the specifications are adhered to.||
|2|Tests and declaration of conformity:<br>•<br>Testing regulations are drawn up and tests performed.<br>•<br>Establish an approval procedure.||
...
||Code and name of safeguard|Threats addressed|
|---|---|---|
|MT8|Specifications defining transponder character-<br>istics|TT8, TT9|
|3|Interoperability tests according to test concept, evaluation:<br>•<br>Draw up testing regulations.<br>•<br>Establish an approval procedure.<br>•<br>Transponder evaluated by independent test laboratories.<br>•<br>Certification of components by an independent institution.||
...
|General|<br>In the event of a malfunction, electronic safeguards in the transponder cannot<br>take effect in an emergency, since the retrieval of the chip data can no longer be<br>guaranteed.||
...
|General|According to current specifications, EPC chips can include a command (the kill<br>command) which irreversibly deactivates the chip. For this reason, the safe-<br>guard below is currently stipulated by EPCglobal in reference implementations<br>for all protection demand categories. Other proprietary methods are conceiv-<br>able, these being similarly suitable for preventing the generation of movement<br>profiles. These,however,havenot yet beenspecified byEPCglobalandimple-||
...
|1|Preventing retrieval of data from the transponder<br>•<br>Deactivate the transponder using the kill command when the tagged prod-<br>uct is sold, or use a similarly secure technical method.||
|2|||
|3|||
|**Table 8–45**<br>**Protection by preventing of movement profile generation**|||
...
|2|Certification:<br>•<br>Implementation of safeguards from MT11.1. The implementation of these<br>safeguards is also checked and certified by an independent authority.||
|3|Preventing the generation of movement profiles<br>•<br>Sufficient protective safeguards cannot be suggested for protection demand<br>category 3. In such cases MT10.3 should be used to prevent the generation<br>of movement profiles.||
...
|1|Interface test<br>•<br>Apply existing test regulations for contactless interfaces in terminals as de-<br>fined by ISO/IEC18000-6 Rev1.2.<br>•<br>Draw up and apply specific test regulations for the application-specific func-<br>tions ofthereader interface, e.g.those oftheEuropean EPC Competence||
...
||Center (EECC).||
|2|Component approval<br>See above, additional component approval (transponders, readers, key man-<br>agement).||
|3|Certification<br>See above, additional certification of transponders and readers by an independ-<br>ent institution.||
...
|1|Keys generated according to specification<br>•<br>Use a suitable key generator as defined in [GSHB].||
...
|2|Evaluation by a testing laboratory<br>•<br>Use a suitable key generator as defined in [GSHB].<br>•<br>All keys are to be generated in a secure environment, stored under crypto-<br>graphic protection, and – apart from defined exceptions involving special<br>additional protective measures – loaded onto the transponder in a secure<br>environment.<br>•<br>Specific keys are to be generated with defined attributes in accordance with<br>the specifications.<br>•<br>Support the diversification of keys for the application with carrier media, and<br>the information stored there (specification, implementation, testing and pro-<br>vision of specific algorithms).<br>•<br>Import the keys to specific SAMs:<br>•<br>SAMs are based on secure chip hardware in accordance with CC<br>EAL5+.<br>•<br>Data cannot be retrieved from SAMs.<br>•<br>Authentication is required to activate a SAM.<br>The quality of the key generator should be confirmed by an independent testing<br>laboratory.||
|3|Evaluate and certify in accordance with CC or a process of the same standard<br>•<br>Use a suitable key generator as defined in [GSHB].<br>•<br>All keys are to be generated in a secure environment, stored under crypto-<br>graphic protection, and loaded onto the transponder in a secure environ-<br>ment.<br>•<br>Specific keys are to be generated with defined attributes in accordance with<br>the specifications.<br>•<br>Support the diversification of keys for the application with carrier media, and<br>the information stored there (specification, implementation, testing and pro-<br>vision of specific algorithms).<br>•<br>Import the keys to specific SAMs:<br>•<br>SAMs are based on secure chip hardware in accordance with CC<br>EAL5+.<br>•<br>Data cannot be retrieved from SAMs.<br>•<br>Authentication is required to activate a SAM.||
...
|**Table**||**8–50**<br>**Protection through secure generation and import of keys**|||
|||Code and name of safeguard||Threats addressed|
|MK2||Introduction of key management for symmetric<br>and asymmetric keys with sufficient key length|<br>|All TKs|
...
Key management concept and implementation 
   ...
   - The purpose of the key and the entity to which it belongs is uniquely identified. 
...
- • The key length used is chosen and specified separately for each function. 

- 1 [ALGK_BSI] should generally be applied. • Keys in readers should always be stored in encapsulated security modules (SAMs). This applies especially to terminals with offline capability. Keys in backend systems should also preferably be stored in security modules such as SAMs. 
   ...
   - • The key management system is designed by the system manager. The entities involved apply a key management concept. This includes nominating people responsible for key management who ensure that it is performed correctly, and who keep abreast of the latest cryptographic developments so as to be able to counteract threats to the system as a whole in good time. 
...
|3|Secure, flexible key management concept<br>In level 3 the following may be useful in addition to the points defined in 1 and 2:<br>•<br>A complex asymmetric key management process is used, with a root CA,<br>multiple sub-CAs and certified authentication and encryption keys.<br>•<br>The lengths of the asymmetric keys should generally accord with<br>[ALGK_BSI] (preferential) and [TR_ECARD].<br>The type and strength of the mechanism used for reloading should be adapted<br>to future developments in accordance with [ALGK_BSI].||
...
|---|---|---|
|MK3|Access protection for cryptographic keys (read<br>and write access)|TK2, TK3|
||•<br>Keys and passwords on the carrier media are protected against retrieval<br>and manipulation attacks.<br>•<br>Once stored in a SAM or other secure memory for keys in system compo-<br>nents, a key becomes irrevocably irretrievable using software.<br>•<br>New keys are loaded into SAMs in accordance with MK8.<br>Access protection is certified by test reports from independent testing laborato-<br>ries. Hardware is certified in accordance with CC EAL5+ for carrier media, keys<br>and SAMs.||



|**Table 8–52**<br>**Protection through access protection for cryptographic keys**|**Table 8–52**<br>**Protection through access protection for cryptographic keys**|**Table 8–52**<br>**Protection through access protection for cryptographic keys**|
|---|---|---|
...
|1|Manufacturer’s declarations<br>•<br>Guarantee safety in accordance with specifications, by means of manufac-<br>turer’s internal quality assurance.||
|2|Testing in accordance with test specifications:<br>•<br>Draw up test specifications for each security component.<br>•<br>Technical checking of components in accordance with the relevant test<br>specifications.<br>•<br>Specification and execution of integration tests in test and actual environ-<br>ments.||
|3|Evaluation:<br>See 2, furthermore:<br>•<br>Security components are tested by independent test laboratories.<br>•<br>An independent institute certifies the relevant security components.<br>•<br>An approval process is established for the security components.||
|**Table 8–53**<br>**Protection through securing the function of security components**|||
...
|2|•<br>Keys must in principle (at least temporarily) be available autonomously<br>without a backend system or if system interfaces fail.<br>•<br>System-wide keys must be stored in at least two spatially separate places<br>(original and backup), and in secure environments.7<br>•<br>It must be ensured that the backup copy fulfils the same security require-<br>ments as the original.<br>•<br>The replacement of defective key components must be regulated.||
|3|Implementation according to fallback concept and backup of keys in the Trust<br>Centre<br>See 1, furthermore:<br>•<br>A system concept must be drawn up which explicitly defines the availability<br>and fallback solutions together with availability periods, as well as agree-<br>ments between the entities.<br>•<br>Critical components must have an uninterruptible power supply (UPS) and<br>other security mechanisms (such as a RAID), so that the failure of sub-<br>components does not impair the availability of the system as a whole.<br>•<br>A sufficient number of replacement system components must be kept avail-<br>able (in cold or warm standby) so as to ensure the required level of avail-<br>ability.<br>•<br>The Trust Centre must back up the system-wide keys.||
...
|1|Compromise of diversified keys:<br>The transponder concerned is withdrawn or deactivated. No other safeguards<br>required.<br>Compromise of non-diversified keys:<br>If the keys or security modules are altogether compromised and an emergency<br>version of the keys is not available, then the keys in the security modules and in<br>new transponders must be replaced immediately with new keys. The data in the<br>system cannot be considered trustworthy until all the keys have been replaced.<br>Particularly if there is a danger of product counterfeiting, fallback solutions must<br>be implemented which would reveal activities such as the unauthorised deacti-<br>vation of transponders:||
|2|||
|3|||
...
||Code and name of safeguard|Threats addressed|
|---|---|---|
|MK6|Definition of action in the event of keys being<br>compromised|TK5, general procedure|
...
|**Table 8–55**<br>**Protection through definition of actions when keys are compromised**|**Table 8–55**<br>**Protection through definition of actions when keys are compromised**|**Table 8–55**<br>**Protection through definition of actions when keys are compromised**|
|---|---|---|
|MK7|Code and name of safeguard|Threats addressed|
||Client-specific separation of keys|TK2, TK3|
|1|Separate storage and handling of keys<br>•<br>Keys originating from different key generators in all of the components of<br>the system must be separated from one another in order to prevent mal-<br>functions and the misuse of key material.||
|2|||
|3|||
|**Table 8–56**<br>**Protection through client-specific separation of keys**|||
...
- and integrity of entitlements 4 Keys must always be loaded under confidential conditions, for which a decryption key is required in the SAM. 
...
- 4 The SAM checks the signature using the key issuer’s public signature key. If that is successful it decrypts the cryptogram using its own private decryption key and saves the key and additional information permanently. 
...
General safeguards that address threats to the customer data system are described in section 0. The following additional safeguards are stipulated which encourage in particular the secure and legally compliant handling of personal data. 

||Code and name of safeguard|Threats addressed|
|---|---|---|
|MV1|Identifying the customer when selling and<br>handing over products|TV10|
...
|2|Application form when setting up a customer account and issuing a customer<br>card:<br>•<br>The customer identifies himself in writing and signs to confirm his identity.<br>The product retailer checks the information using conventional means:||
...
|3|Identity document check when setting up a customer account and issuing a cus-<br>tomer card:<br>•<br>Secure photo ID is presented.<br>•<br>The identity data is taken into the system from a secure electronic identity<br>card (eID).||



|**Table 8–58**<br>**Protection of personal data by identification of customers**|**Table 8–58**<br>**Protection of personal data by identification of customers**|**Table 8–58**<br>**Protection of personal data by identification of customers**|
|---|---|---|
...
|1|Satisfying legal requirements:<br>•<br>When the processes and system within the overall system are being de-<br>fined, the principle of data minimisation is applied in accordance with the le-<br>gal foundations. This includes, in particular, the definition of deadlines for<br>deleting data that is no longer required.||
|2|||
|3|Special safeguards<br>The following safeguards are applied in addition to those specified in MV2.2:<br>•<br>Precise, purpose-related definition of the data content, the acquisition and<br>storage of data, and access and usage rights using the role model of the<br>overall system.<br>•<br>The customer is informed about the purpose-related acquisition, storage<br>and use of personal data.||
...
|2|||
|3|Special safeguards<br>The following safeguards are applied in addition to those specified in MV3.2:<br>•<br>The customer is informed about the content of the logistical data used, the||
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-01.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-02.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-03.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-04.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-05.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-06.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-07.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-08.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-09.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-10.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-11.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-12.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-13.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-14.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-15.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-16.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-17.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-18.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-19.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-20.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-21.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-22.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-23.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-24.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-25.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-26.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0118-27.png)
...
We will now examine the processes described in sections 6 and 7 to provide examples of how particular products can be implemented. 
...
Additional services such as product information and cross-selling are to be provided in the retail outlet using RFID technology (see section 2.2). 
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0122-04.png)
...
![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0123-01.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0123-02.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0123-03.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0123-04.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0123-05.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0123-06.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0123-07.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0123-08.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0123-09.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0123-10.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0123-11.png)



![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0123-12.png)


## **Figure 10–2 System view of the logistical supply chain** 


![](markdown/tr/TG_03126_4_Application_area_eTicketing_in_public_transport/TG_03126_4_Application_area_eTicketing_in_public_transport.pdf-0123-14.png)


**Figure 10–3 Data exchange between entities in the logistical supply chain** 
...
- 1 The systems described in section 10.1 should support all of the proposed application scenarios simultaneously. This includes, in particular, supporting safeguards against counterfeiting. 
...
On the basis of the criteria described in section 8.2.5, the logistics infrastructure can be assigned to the following protection demand categories: 

|Security objective|Security objective|Protec-<br>tion de-<br>mand<br>category|Criteria for allocating to protection demand categories|
|---|---|---|---|
...
|SS2|Fallback solu-<br>tion in the<br>event of mal-<br>function|1|Malfunction affects only a few transponders.|
|||2|Malfunction affects many transponders.|
|||3|Malfunction affects most or all transponders.|
...
|||2|Medium risk of DoS attacks / DoS attacks cause limited<br>damage amounting to < 1% of goods value.|
...
|SP3|Protection<br>it th|1|Customer’s reputation is damaged.|
||agans e<br>creation of<br>movement<br>profiles|2|Customer’s social existence is damaged.|
|||3|Customer’s physical existence is damaged.|
...
The system shown in section 10.1 is reliant on interaction between all the system components. In order to facilitate the business processes described in section 6, the technical interfaces and operative interaction between the components have to be specified. 
...
|Threats to the contactless<br>interface|Threats to the contactless<br>interface|Protection<br>demand|Comments|
|---|---|---|---|
...
|TS4|System malfunction|3|Malfunctions in the interfaces between the sys-<br>tems can be caused in a variety of scenarios<br>by technical faults, incorrect operation or DoS<br>attacks:<br>1. Fault in interfaces<br>2. Lack of availability of interfaces<br>3. Fault in power supply<br>4. Interruption in network connection<br>5. Physical destruction|
...
Based on the relevant threats in the preceding section, this section defines general execution proposals and safeguards for the system as a whole and the system components. These safeguards are described in detail in section 0. 
...
|Threats to the contactless<br>interface in the reader|Threats to the contactless<br>interface in the reader|Protection<br>demand|Comments|
|---|---|---|---|
|TC1|Lack of compatibil-<br>ity between the in-<br>terfaces of the<br>transponder and<br>reader|3|A lack of compatibility between interfaces pre-<br>vents the system from working when reading,<br>writing data, and deactivating. The result is<br>similar to a successful DoS attack on the entire<br>system. The logistical infrastructure could not<br>be guaranteed to function.|
|TC2|Eavesdropping|3|Unauthorised listening-in to communication<br>between a transponder and a reader can be<br>used for purposes such as attacking product<br>codes, passwords and authentication data.|
...
|TR3|Reader malfunction|3|Reader malfunctions can be caused in a range<br>of scenarios by technical faults, incorrect op-<br>eration, or DoS attacks:<br>1<br>Fault in contactless interface<br>2<br>Fault in reference information (keys, black-|
...
Based on the relevant threats in the preceding section, this section defines general execution proposals and safeguards for the reader and its applications. These safeguards are described in detail in section 0. 

|Threat||Safeguards|Safeguard|Safeguard|
|---|---|---|---|---|
|TC1|Lack of compati-<br>bility between the<br>interfaces of the<br>transponder and<br>reader|MS1.3<br>MR1.3|1|Introduction of interface tests and ap-<br>proval procedures – certification|
|TC2|Eavesdropping|MS2.3<br>MS3.3|1<br>2|Preventing eavesdropping on data ex-<br>change between transponder and<br>reader – advanced safeguards<br>Assuring reliable data transmission be-<br>tween terminal and transponder – sur-<br>veying|
|TC3|DoS attack on the<br>RF interface|MS3.1|1|Assuring reliable data transmission be-<br>tween terminal and transponder –long-<br>term testing and organisational safe-|
...
|---|---|---|---|---|
|||||guards|
|TC4|Outside influence<br>over other exist-<br>ing applications|MS3.3|1|Assuring reliable data transmission be-<br>tween terminal and transponder – sur-<br>veying|
|TR1|Unauthorised<br>manipulation of<br>reference infor-<br>mation|MR2.3|1|Protection of reference information<br>against retrieval, data errors and ma-<br>nipulation – advanced protection|
|TR2|Unauthorised<br>scanning of refer-<br>ence information|MR2.3|1|Protection of reference information<br>against retrieval, data errors and ma-<br>nipulation – advanced protection|
|TR3|Reader malfunc-<br>tion|MR3.3|1|Protection of the reader against mal-<br>function – evaluation|
|TR4|Lack of user in-<br>structions|MS13.2|1|Ergonomic user instructions|
|TS1|Lack of fallback<br>solution|MS4.3|1|Definition of fallback solutions in the<br>event of system interface or system<br>component failure – implementation ac-<br>cording tofallbackconcept|
|TS5|Lack of compati-<br>bility between the<br>interfaces|MS1.3<br>MS11.3<br>MS12.3|1<br>2<br>3|Introduction of interface tests and ap-<br>proval procedures – certification<br>Secure the function of the system to<br>prevent the technical failure of compo-<br>nents and transmission routes –<br>evaluation of components<br>Specifications for system concept and<br>requirements for components – evalua-<br>tion|
...
The following threats relevant to the backend systems can be deduced from the security targets used to determine the protection demand in section 10.1.1. 
...
|Threats to backend systems|Threats to backend systems|Protection<br>demand|Comments|
|---|---|---|---|
...
Based on the relevant threats in the preceding section, this section defines general execution proposals and safeguards. These safeguards are described in detail in section 0. 

|Threat||Safeguards|Safeguard|
|---|---|---|---|
|TS1|Lack of fallback<br>solution|MS4.3|1<br>Definition of fallback solutions in the<br>event of system interface or system<br>component failure – implementation ac-<br>cording tofallbackconcept|
...
|TS5|Lack of compati-<br>bility between the<br>interfaces|MS1.3<br>MS11.3<br>MS12.3|1<br>Introduction of interface tests and ap-<br>proval procedures – certification<br>2<br>Secure the function of the system to<br>prevent the technical failure of compo-<br>nents and transmission routes –<br>evaluationofcomponents|
...
|Threats to customer data<br>systems|Threats to customer data<br>systems|Protection<br>demand|Comments|
|---|---|---|---|
...
|TV2|System malfunction|3|Customer data system malfunctions can be<br>caused in a variety of scenarios by technical<br>faults, incorrect operation or DoS attacks:<br>1<br>Fault in local and central systems<br>2<br>Lack of availability of local and central sys-<br>tems<br>3<br>Fault in data storage<br>4<br>Fault in power supply<br>5<br>Interruption of the link to the central sys-<br>tem<br>6<br>Physical destruction|
...
|Threat||Safeguards|Safeguard|
|---|---|---|---|
|TV1|Lack of fallback<br>solution|MS4.3|1<br>Definition of fallback solutions in the<br>event of system interface or system<br>component failure – implementation ac-<br>cording tofallbackconcept|
...
Initialiser SAMs are required to initialise transponders and load protected information (e.g. authentication data, setting passwords). 
...
The initialisation of transponders follows the use case described in section 7. There are different ways of facilitating this: 
...
The choice of protection demand category is dependent on the application scenario, so it will be dealt with in section 11. 

## **10.2.3 Threats to the transponder** 

The following table lists threats to the transponder. The allocation of protection categories is highly dependent on the product being supported, and therefore on the application scenario concerned, so it will be dealt with in section 11. 
...
The allocation of safeguards is dependent on the application scenario, so it will be dealt with in section 11. 
...
The "Fast-moving consumer goods" application scenario is defined in section 9.1. A package containing eight rolls of toilet paper is fitted with a transponder and passes through the processes and use cases described in sections 6 and 7 in a complete system compliant with EPCglobal specifications. 
...
|Security objective|Security objective|Protection<br>demand<br>category|Criteria for allocating to protection demand categories|
|---|---|---|---|
|SS1|Technical<br>compatibility|1|All system components are from the same supplier.<br>The supplier ensures that they are compatible.|
|||2|The system has to function with components from a<br>small number of defined suppliers. The system man-<br>ager or an SI ensure compatibility.|
...
|---|---|---|---|
|||3|Open system that has to function with components<br>from any company in the market.|
|SS2|Fallback solu-<br>ti i th|1|Malfunction affects only a few transponders.|
||on n e<br>event of mal-<br>function|2|Malfunction affects many transponders.|
|||3|Malfunction affects most or all transponders.|
|SS3|Intuitive, fault-<br>tolerant op-<br>eration|1|A few consumers cannot operate it intuitively.|
|||2|Many consumers cannot operate it intuitively.|
|||3|A large proportion of consumers cannot operate it in-<br>tuitively.|
|SI1|Protection of<br>personal data<br>in the cus-<br>tomer data<br>system|1|Only relevant for customer data systems. Will be han-<br>dled in chapter 10.1.5|
|||2||
|||3||
|SI2|Protection of<br>object code|1|No risk of product counterfeiting, manipulation, DoS,<br>etc.|
|||2|Product counterfeiting, manipulation, DoS, etc. causes<br>limited damage amounting to < 1% of goods value.|
...
|SP1|Protection of<br>personal data|1|Only relevant for customer data systems. Will be han-<br>dled in chapter 10.1.5|
|||2||
|||3||
|SP2|Data minimi-<br>sation|1|Only relevant for customer data systems. Will be han-<br>dled in chapter 10.1.5|
|||2||
|||3||
...
|Threat||Trans-|Comments|
|---|---|---|---|
|||ponder<br>protection||
|||demand||
...
**Table 11–3 Use cases relevant to the "Fast-moving consumer goods" application scenario** 
...
In the following table, safeguards are assigned to the threats in Table 11–1. These safeguards are intended to compensate for those threats. These safeguards are described in section 0. 
...
|TT3|Cloning of trans-<br>ponder|MT1.2<br>MT2.2|1<br>Hardware and software access protec-<br>tion for the EPC (write access) – write<br>protection for EPC<br>2<br>Protection against cloning of trans-<br>ponder – simple emulation protection<br>using UID|
|TT4|Emulation of<br>transponder|MT3.2|1<br>Hardware and software access protec-<br>tion for the EPC (write access) – write<br>protection for EPC<br>2<br>Protection against emulation – simple<br>emulation protection using UID|
...
The "consumer electronics" application scenario is defined in section 9.2. A high-value, flatscreen TV is fitted with a transponder and passes through the processes and use cases described in sections 6 and 7 in a complete system compliant with EPCglobal specifications. 
...
- 3 Additional services such as product information and cross-selling are to be provided in the retail outlet using RFID technology (see section 2.2). 
...
In the following table, safeguards are assigned to the threats in Table 11–5. These safeguards are intended to compensate for those threats. These safeguards are described in section 0. 
...
|TT13|Incorrectly gener-<br>ated UID|MT2.3|1<br>Protection against cloning of trans-<br>ponder – advanced protection of the<br>transponderagainst cloning|
...
In this application scenario, risks still exist after applying the safeguards mentioned in Table 11–13 to compensate for threats TT7 and TT10. These are described in the following. 
...
The "brand-name clothing" application scenario is defined in section 9.3. A high-value men's suit made by a brand-name manufacturer is fitted with a transponder and passes through the processes and use cases described in sections 6 and 7 in a complete system compliant with EPCglobal specifications. 
...
|Security objective|Security objective|Protec-<br>tion de-<br>mand<br>category|Criteria for allocating to protection demand catego-<br>ries|
|---|---|---|---|
|SS1|Technical<br>compatibility|1|All system components are from the same supplier.<br>The supplier ensures that they are compatible.|
...
|||2|Product counterfeiting, DoS, etc. causes limited<br>damage amounting to < 1% of goods value.|
|||3|Product counterfeiting, DoS, etc. causes massive<br>damage (danger to people, large losses of sales<br>and image, and so on).|
|SI4|Protection of<br>logistical<br>data|1|Low dependency on logistical data|
|||2|Incorrect or missing logistical data causes limited<br>damage amounting to < 1% of goods value.|
...
|Threat||Trans-<br>ponder|Comments|
|---|---|---|---|
|||<br>protec-<br>ti d||
|||on e-<br>mand||
...
In the following table, safeguards are assigned to the threats in Table 11–10. These safeguards are intended to compensate for those threats. These safeguards are described in section 0. 
...
|TT2|Unauthorised<br>writing /manipu-|MT1.3|1<br>Hardware and software access protec-<br>tion fortheEPC (write access)– write|
...
|---|---|---|---|
|TT13|Incorrectly gener-<br>ated UID|MT2.3|1<br>Protection against cloning of trans-<br>ponder – advanced protection of the<br>transponderagainst cloning|
|**Table 11–13**<br>**Safeguards for the "brand-name clothing" application scenario**||||
...
|Entities that could be<br>affected|Security objectives<br>which could be affected|Assessment|
|---|---|---|
|Customer|Privacy|The allocation of movement profiles to<br>people using information from outside<br>the system would involve, in each<br>separate instance, considerable tech-<br>nical effort and manpower. If the re-<br>quired safeguards are applied, then<br>scenarios involving automated alloca-<br>tion are not conceivable. Whatever<br>the case, such an activity would vio-<br>late existing privacy laws.<br>The possibility of isolated attacks<br>cannot be excluded, but they are<br>unlikely because of the difficulty and<br>expense involved, and because of the<br>legal deterrents. Widespread use for<br>purposes such as commercial gain is<br>not to be expected. This is illustrated<br>by the example of a retailer: the<br>lengths to which the retailer would<br>have to go would greatly exceed any<br>benefits that could be gained by rec-<br>ognising customers. In addition, there<br>are more effective and simpler ways<br>of achieving the same thing; well-<br>trained staff can judge a new cus-<br>tomer's potential interest as he or she<br>enters the shop, by observing simple<br>attributes such as clothing, age and<br>appearance.|
...
International Organization for Standardization: ISO 18000-6:2004 Information technology - Radio frequency identification for item management - Part 6: Parameters for air interface communications at 860 MHz to 960 MHz, http://www.iso.org/iso/iso_catalogue.htm, download from Sept. 15[th] 2008 

## [CFP_GS1] 

- Fälschungssicherheit mit EPC (German only), http://www.gs1 germany.de/content/e39/e466/ e468/datei/epc_rfid/mip_faelschungssicherheit.pdf 

## [EPCIS] 

EPC Informationsservice (EPCIS) und Umsetzung im EPCShowcase (German only), - http://www.gs1 germany.de/content/standards/epc_rfid/epc_informationsservices/ epc_showcase/index_ger.html, download from Sept. 15[th] 2008 
...
- GS1 Standards – Ein Lösungsportfolio weist in die Zukunft (German only), http://www.gs1 germany.de/internet/content/e39/e466/e468/datei/ean/loesungsportfolio.pdf, download from Sept. 15[th] 2008 

## [GS1-2] 

GS1 Germany: AutoID-Kompendium Version 7.0 (German only), - http://shop.gs1 germany.de/cgi/shop. 

cgi?ID=0000000000003D0000000000000000005300000000000000000000000000, download from Sept. 15[th] 2008 

## [GS1-3] 

GS1 Germany: Prozessveränderungen durch EPC/RFID in der Supply Chain (Zentrallager- belieferung) (German only), http://www.gs1 germany.de/internet/content/produkte/ epcglobal/downloads_service/downloads/index_ger.html, download from Sept. 15[th] 2008 
...
- GS1 Germany & IBM Deutschland: RFID-Kalkulator (German only), http://www.gs1 germany.de/internet/content/e6/e156/e160/index_ger.html, download from Sept. 15[th] 2008 
...
CRM Customer relationship management DESADV Despatch advice DoS Denial of Service, attack on the availability of a service or function. EPC Electronic Product Code RFID Radio frequency identification TID A transponder's unique identifier (Transponder Identifier), identical to the UID. UID Unique Identifier (of a chip) 
