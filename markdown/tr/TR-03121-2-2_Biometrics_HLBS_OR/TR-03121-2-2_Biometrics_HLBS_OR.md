...
|3.3.|Namespaces ............................................................................................................................. 5|
|3.4.|XML Schema and Web Service Definition ................................................................................. 5|
|3.5.|Interoperability ........................................................................................................................ 5|
|4.|Interface Overview ....................................................................................................................... 6|
|4.1.|High-Level Biometric Services .................................................................................................. 6|
|4.2.|Error Handling ........................................................................................................................ 6|
|5.|High Level Biometric Services API ................................................................................................ 7|
|5.1.|Namespaces ............................................................................................................................. 7|
|5.2.|Data Types .............................................................................................................................. 7|
|5.3.|Fault Types ............................................................................................................................ 23|
|5.4.|Operations ............................................................................................................................. 27|
|5.5.|Service-Device Description Schema ........................................................................................ 36|
|6.|Example (Non-Normative) .......................................................................................................... 62|
|6.1.|Service-Device Description ..................................................................................................... 62|
|7.|Client-Server Connection Scenarios ............................................................................................ 64|
|7.1.|Connection via TCP/IP .......................................................................................................... 64|
|7.2.|Connection via USB ............................................................................................................... 65|
|8.|Service Definitions ...................................................................................................................... 67|
|8.1.|Service Definition Facial Image Acquisition System ................................................................. 67|
|8.2.|Service Definition Basic Facial Image Acquisition System ........................................................ 74|
|8.3.|Service Definition Fingerprint Acquisition .............................................................................. 80|
|8.4.|Service Definition Rolled Fingerprint Acquisition .................................................................... 85|
|8.5.|Service Definition for Self-Service System ............................................................................... 89|
...
|2.1.|Client-Side Process ....................................................................................................................... 3|
|---|---|
|7.1.|HLBS Architecture ...................................................................................................................... 64|
|7.2.|Architecture via TCP/IP .............................................................................................................. 65|
|7.3.|Architecture via USB .................................................................................................................. 66|
...
Volume High Level Biometric Services 
...
Architecture for Biometric Applications 
...
![](markdown/tr/TR-03121-2-2_Biometrics_HLBS_OR/TR-03121-2-2_Biometrics_HLBS_OR.pdf-0007-01.png)


**----- Start of picture text -----**<br>
Start End<br>Acquire service- No Release<br>device  service-device<br>combination combination<br>Configure  Start service  Fetch one feedback  Update user  Yes Fetch results<br>service execution interface<br>element<br>Finished?<br>Signal user<br>command to<br>server<br>Button pressed<br>**----- End of picture text -----**<br>
...
High Level Biometric Services API 
...
Represents the impression type as specified in [BIB_ISO_FINGER] (e.g. finger or palm). Derived from `xsd:un signedInt` . 
...
|**Element Name**|**Description**|
|---|---|
|`fingerImpression`|`hlbs:Iso19794FingerImpression`<br>Represents an impression type according to [BIB_ISO_FINGER]|
...
```
<elementname="biometricCodeListValue"type="hlbs:BiometricCodeList"minOccurs="1"maxOccurs="1"
nillable="true"/>
```

```
<elementname="imageValue"type="hlbs:Image"minOccurs="1"maxOccurs="1"nillable="true"/>
<elementname="dataFormatValue"type="hlbs:DataFormat"minOccurs="1"maxOccurs="1"
nillable="true"/>
```

```
<elementname="binaryValue"type="hlbs:Binary"minOccurs="1"maxOccurs="1"nillable="true"/>
<elementname="stringListValue"type="hlbs:StringList"minOccurs="1"maxOccurs="1"
nillable="true"/>
```
...
|**Element Name**<br>|**Description**|
|---|---|
|`Properties?`<br>|`hlbs:type.device.properties`<br>Specific properties of the device (if available).|
...
```
<xs:complexTypename="type.information.devices.device">
```
...
```
<xs:elementname="Version"minOccurs="0"maxOccurs="1"type="xs:string" />
<xs:elementname="FirmwareVersion"minOccurs="0"maxOccurs="1"type="xs:string" />
<xs:elementname="DeviceID"minOccurs="0"maxOccurs="1"type="xs:string" />
...
```
<xs:elementname="Properties"minOccurs="0"maxOccurs="1"type="hlbs:type.device.properties" />
</xs:sequence>
</xs:complexType>
```
...
|---|---|
|`default`<br><br> <br>|`xs:integer`<br>Default value of this configuration entry which is used if the value is not overriden by the appli<br>cation.|
|`min?`<br><br>|`xs:integer`<br>Minimal allowed value for this configuration value. If omitted, there is no lower limit..|
|`max?`<br><br>|`xs:integer`<br>Maximal allowed value for this configuration value. If omitted, there is no upper limit.|
...
|**Attribute Name**|**Description**|
|---|---|
|`default`|`xs:string`<br>Default value of this configuration entry which is used if the value is not overriden by the app<br>lication.|
...
Client-Server Connection Scenarios 
...
![](markdown/tr/TR-03121-2-2_Biometrics_HLBS_OR/TR-03121-2-2_Biometrics_HLBS_OR.pdf-0068-03.png)
...
![](markdown/tr/TR-03121-2-2_Biometrics_HLBS_OR/TR-03121-2-2_Biometrics_HLBS_OR.pdf-0069-01.png)
...
![](markdown/tr/TR-03121-2-2_Biometrics_HLBS_OR/TR-03121-2-2_Biometrics_HLBS_OR.pdf-0070-01.png)
...
|`Version`|Version of BSI TR-03121 of<br>the implemented service.|`xsd:`<br>`string`|_e.g. 5.3_|
...
|`Increment`<br>`Vertical`<br>`Position`|C|Stepwise increment the ver<br>tical position of the came<br>ra's field of view by the defi<br>ned value in cm, maximum to<br>the highest position. In case a<br>multi camera solution is used,<br>it SHALL NOT be possible to<br>set the camera's field of view<br>to a position where a merge<br>image of two or more came<br>ras is created. This command<br>SHALL only be available in<br>manual mode.|Step<br>`xsd:int`|_Arbitrary Value_|
...
## **8.3. Service Definition Fingerprint Acquisition** 

This service definition specifies requirements for a system acquiring fingerprints. 

## **8.3.1. ServiceInformation** 

When the `getAllServices` operation is requested at least the `hlbs:ServiceInformation` shown in Ta ble 8.11 SHALL be returned. Further parameters are vendor specific and SHALL be set as well. 
...
Within the `hlbs:Feedback` the `feedbackElements*` of Table 8.14 as `hlbs:KeyValue` SHALL be returned. Furthermore the `userCommands*` SHALL contain the `hlbs:UserCommandInfo` for each implemented `hlbs:U serCommand` . The possible `feedbackElements*` of Table 8.14 SHALL also be part of the `serviceDescriptionXML` that is returned with the `getServiceDescription` . 
...
|**Parameter ID**|**Parameter ID**|**Description**|**Description**|**Type**|**Type**|**Possible Values**|
|---|---|---|---|---|---|---|
|`FingerAcquisition`||Contains the full XML root element`Finge`<br>`rAcquisition`(see TR-03121 XML,`bioty`<br>`pes4v7.xsd`for volumes BCL and IMA or`bio`<br>`types5v1.xsd`for volumes GID and ARE),<br>which logs the entire acquisition process, infor<br>mation about quality, PAD and uniqueness as<br>well as the finally accepted fingerprint(s) as re<br>cord(s). The data format, compression and file<br>size of the record SHALL comply with the con<br>figured`ApplicationProfile`.||`xsd:`<br>`string`||See TR-03121 XML<br>Schema|
|**Table 8.15**Fingerprint Acquisition Result Elements<br>**8.4. Service Definition Rolled Fingerprint Acquisition**<br>This service definition specifies requirements for a system acquiring rolled fingerprints.<br>**8.4.1. ServiceInformation**<br>When the<br>`getAllServices`operation is requested at least the<br>`hlbs:ServiceInformation`shown in<br>Ta<br>ble 8.16 SHALL be returned. Further parameters are vendor specific and SHALL be set as well.|||||||
|**Parameter ID**|**Description**||**Type**||**Value**||
|`Id`|Unique UUID of the service.||`xsd:`<br>`string`||`186266e5-3760-4d0c-b7ec-`<br>`b866024e6b61`||
...
|---|---|---|---|
|`Purpose`|The purpose of the fingerprint image<br>acquisition.|`hlbs:`<br>`ServiceType`|`enrolment`,`identification`,<br>`verification`|
|`ApplicationProfile`|Relevant Application Profile to be<br>used for the acquisition process and<br>its results.|`hlbs:`<br>`Application`<br>`Profile`|_Choice of the implemented Ap_<br>_plication Profiles (e.g._ `ARE_`<br>`ArrivalAttestation`<br>`Document`_)_|
...
Within the `hlbs:Feedback` the `feedbackElements*` of Table 8.14 as `hlbs:KeyValue` SHALL be returned. Furthermore the `userCommands*` SHALL contain the `hlbs:UserCommandInfo` for each implemented `hlbs:U` 
...
`serCommand` . The possible `feedbackElements*` of Table 8.19 SHALL also be part of the `serviceDescriptionXML` that is returned with the `getServiceDescription` . 
...
## **8.5. Service Definition for Self-Service System** 
...
When the `signalUserCommand` operation is executed the user commands shown in Table 8.23 SHALL be supported by the service. In case a user command is not allowed at a certain point of time during the execution of the service the user SHALL be informed via the `getServiceFeedback` operation. The user commands of Table 8.23 SHALL also be present within the `serviceDescriptionXML` that is returned with the `getService Description` operation. 
...
Within the `hlbs:Feedback` the `feedbackElements*` of Table 8.24 as `hlbs:KeyValue` SHALL be returned. Furthermore the `userCommands*` SHALL contain the `hlbs:UserCommandInfo` for each implemented `hlbs:U serCommand` . The possible `feedbackElements*` of Table 8.24 SHALL also be part of the `serviceDescriptionXML` that is returned with the `getServiceDescription` . 
...
|`TimeoutMs`|M|Maximum time in ms<br>after which the acqui<br>sition process will ab<br>ort, in case no facial<br>images have been ac<br>quired.|`xsd:int`|_Arbitrary value_<br>(default:`0`)|
