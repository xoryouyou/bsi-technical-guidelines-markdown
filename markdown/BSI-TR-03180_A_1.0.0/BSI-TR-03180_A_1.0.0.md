...
## <span id="page-10-2"></span>3.2 Test results
...
## 4.2.6.1 BZS\_GERPIN.1.1a (Mandatory)
...
## 4.2.9.1 BZS\_LOCK.1.2a (Mandatory)
...
**Test property:** The data partition **SHALL NOT** be mounted or the encrypted user data according to BZS\_GERPIN.1.1 **SHALL NOT** be decrypted
...
## 4.3.4.2 UPD\_VUL.1.1b (Mandatory)
...
## 4.3.12.3 UPD\_SCH.1.5c (Mandatory)
...
## 4.3.15.2 UPD\_UMG.2.1b (Mandatory)
...
#### 4.3.17.1 UPD\_UMG.2.3a (Mandatory)
...
#### 4.3.22.1 UPD\_AUT.1.4a (Mandatory)
...
### 4.6.2.1 USR\_AUT.1.2a (Voluntary)
...
## 4.7.3.1 DAT\_SKL.1.1a (Mandatory)
...
#### 4.7.24.1 DAT\_DEL.1.1a (Mandatory)
...
## 4.7.31.1 DAT\_TRK.1.7a (Mandatory)
...
#### 4.7.34.1 DAT\_SEN.2.1a (Mandatory)
...
## <span id="page-53-0"></span>4.8 Data transmission (DUE)
...
## 4.8.11.1 DUE\_INT.7.1a (Mandatory)
...
#### 4.9.3.3 INT\_TPD.1.2c (Mandatory)
...
#### 4.9.5.1 INT\_TPD.1.4a (Mandatory)
...
## 4.9.5.2 INT\_TPD.1.4b (Mandatory)
...
4.9.5.3 INT\_TPD.1.4c (Mandatory)
...
## 4.9.7.1 INT\_TPD.2.1a (Mandatory)
...
## 4.9.8.1 INT\_TPD.2.2a (Mandatory)
...
## 4.9.8.2 INT\_TPD.2.2b (Recommended)
...
### 4.9.9.1 INT\_TPD.2.3a (Mandatory)
...
### 4.9.10.1 INT\_TPD.2.4a (Mandatory)
...
#### 4.9.11.1 INT\_TPD.2.5a (Mandatory)
...
## 4.9.12.1 INT\_TPD.2.6a (Mandatory)
...
## 4.9.13.1 INT\_TPD.2.7a (Mandatory)
...
#### 4.9.14.1 INT\_TPD.2.8a (Mandatory)
...
## 4.9.15.1 INT\_TPD.2.9a (Mandatory)
...
## 4.9.16.1 INT\_TPD.2.10a (Mandatory)
...
## 4.9.16.2 INT\_TPD.2.10b (Recommended)
...
### 4.9.17.1 INT\_TPD.3.1a (Recommended)
...
#### 4.9.18.1 INT\_TPD.3.2a (Mandatory)
...
#### 4.9.19.1 INT\_TPD.3.3a (Mandatory)
...
## 4.9.20.1 INT\_TPD.3.4a (Mandatory)
...
### 4.9.21.1 INT\_TPD.4.1a (Mandatory)
...
### 4.9.22.1 INT\_TPD.4.2a (Mandatory)
...
#### 4.9.23.1 INT\_TPD.4.3a (Mandatory)

**Test property:** The DUT **SHALL** support at least IEEE 802.11-2020 [10]. IEEE 802.1X [11] **SHALL** only be supported with EAP-TLS [12] (in compliance with TPC\_TLS.1.2).

**Test methods: T.1, T.3**

#### 4.9.23.2 INT\_TPD.4.3b (Mandatory)
...
#### 4.9.23.3 INT\_TPD.4.3c (Mandatory)
...
#### 4.9.23.4 INT\_TPD.4.3d (Mandatory)

**Test property:** The DUT **SHALL** support at least IEEE 802.11i.

#### **Test methods: T.1, T.3**

### 4.9.23.5 INT\_TPD.4.3e (Mandatory)
...
### 4.9.24.1 INT\_TPD.4.4a (Mandatory)
...
#### 4.9.25.1 INT\_GSM.1.1a (Mandatory)
...
#### 4.9.26.1 INT\_GSM.1.2a (Mandatory)
...
#### 4.9.27.1 INT\_GSM.1.3a (Mandatory)
...
## 4.9.28.1 INT\_KAB.1.1a (Mandatory)
...
### 4.10.2.1 SEN\_MIK.1.2a (Mandatory)
...
#### 4.10.2.2 SEN\_MIK.1.2b (Mandatory)
...
#### 4.10.3.1 SEN\_KAM.1.1a (Mandatory)
...
## 4.10.4.1 SEN\_KAM.1.2a (Mandatory)
...
## 4.10.4.2 SEN\_KAM.1.2b (Mandatory)
...
### 4.10.5.1 SEN\_LOC.1.1a (Mandatory)
...
## <span id="page-70-0"></span>6 Glossary
...
## <span id="page-73-0"></span>7 References
